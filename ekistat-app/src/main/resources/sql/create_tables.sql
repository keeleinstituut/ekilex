...
create index ww_search_filtered_count_destin_langs_gin_idx on ww_search_filtered_count using gin (destin_langs);
create index ww_search_filtered_count_dataset_codes_idx on ww_search_filtered_count(dataset_codes);
create index ww_search_filtered_count_dataset_codes_gin_idx on ww_search_filtered_count using gin (dataset_codes);
