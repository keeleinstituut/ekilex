...
public class LexRelMapping extends TableImpl<LexRelMappingRecord> {
    ...
    private static final long serialVersionUID = 2145188333;
     ...
     */
    public final TableField<LexRelMappingRecord, String> CODE1 = createField("code1", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.lex_rel_mapping.code2</code>.
     */
    public final TableField<LexRelMappingRecord, String> CODE2 = createField("code2", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.LEX_REL_MAPPING_CODE1_CODE2_KEY, Indexes.LEX_REL_MAPPING_CODE1_IDX, Indexes.LEX_REL_MAPPING_CODE2_IDX);
    }
    ...
    public LexRelType lexRelMapping_LexRelMappingCode1Fkey() {
        return new LexRelType(this, Keys.LEX_REL_MAPPING__LEX_REL_MAPPING_CODE1_FKEY);
    }

    public LexRelType lexRelMapping_LexRelMappingCode2Fkey() {
