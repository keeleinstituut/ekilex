...
public class MeaningLastActivityLogRecord extends UpdatableRecordImpl<MeaningLastActivityLogRecord> implements Record3<Long, Long, Long> {

    private static final long serialVersionUID = -1679678759;
    ...
    @Override
    public MeaningLastActivityLogRecord values(Long value1, Long value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public MeaningLastActivityLogRecord(Long id, Long meaningId, Long activityLogId) {
        super(MeaningLastActivityLog.MEANING_LAST_ACTIVITY_LOG);
