...
public class ActivityLog extends TableImpl<ActivityLogRecord> {
    ...
    private static final long serialVersionUID = 45232637;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ACTIVITY_ENTITY_NAME_IDX, Indexes.ACTIVITY_FUNCT_NAME_IDX, Indexes.ACTIVITY_LOG_EVENT_BY_IDX, Indexes.ACTIVITY_LOG_EVENT_ON_IDX, Indexes.ACTIVITY_LOG_OWNER_IDX);
    }
