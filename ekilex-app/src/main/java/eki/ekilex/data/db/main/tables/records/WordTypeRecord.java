...
public class WordTypeRecord extends UpdatableRecordImpl<WordTypeRecord> implements Record2<String, Long> {
    ...
    @Override
    public WordTypeRecord value2(Long value) {
        setOrderBy(value);
        return this;
    }

    @Override
    public WordTypeRecord values(String value1, Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public WordTypeRecord(String code, Long orderBy) {
        super(WordType.WORD_TYPE);
