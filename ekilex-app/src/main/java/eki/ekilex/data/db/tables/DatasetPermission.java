...
public class DatasetPermission extends TableImpl<DatasetPermissionRecord> {
    ...
    private static final long serialVersionUID = -381552249;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.DATASET_PERM_DATASET_CODE_IDX, Indexes.DATASET_PERM_DATASET_FULL_CMPLX_IDX, Indexes.DATASET_PERM_USER_ID_IDX, Indexes.DATASET_PERMISSION_DATASET_CODE_USER_ID_AUTH_OPERATION_AUTH_KEY, Indexes.DATASET_PERMISSION_PKEY);
    }
