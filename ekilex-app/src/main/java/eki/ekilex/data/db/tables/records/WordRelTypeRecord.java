...
public class WordRelTypeRecord extends UpdatableRecordImpl<WordRelTypeRecord> implements Record3<String, String[], Long> {
    ...
    private static final long serialVersionUID = 357484557;
     ...
     */
    @Override
    public WordRelTypeRecord value3(Long value) {
        setOrderBy(value);
        return this;
    }
     ...
     */
    @Override
    public WordRelTypeRecord values(String value1, String[] value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
