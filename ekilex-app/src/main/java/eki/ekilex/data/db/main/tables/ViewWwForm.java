...
import eki.ekilex.data.db.main.tables.records.ViewWwFormRecord;
...
public class ViewWwForm extends TableImpl<ViewWwFormRecord> {
    ...
    /**
     * The column <code>public.view_ww_form.word_value</code>.
     */
    public final TableField<ViewWwFormRecord, String> WORD_VALUE = createField(DSL.name("word_value"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<ViewWwFormRecord, String> VOCAL_FORM = createField(DSL.name("vocal_form"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.view_ww_form.morph_comment</code>.
     */
    public final TableField<ViewWwFormRecord, String> MORPH_COMMENT = createField(DSL.name("morph_comment"), SQLDataType.CLOB, this, "");
