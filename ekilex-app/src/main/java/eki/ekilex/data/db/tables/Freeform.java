...
public class Freeform extends TableImpl<FreeformRecord> {
    ...
    private static final long serialVersionUID = 1427450326;
     ...
     */
    public final TableField<FreeformRecord, String> COMPLEXITY = createField("complexity", org.jooq.impl.SQLDataType.VARCHAR(100), this, "");
     ...
     */
    public final TableField<FreeformRecord, Boolean> IS_PUBLIC = createField("is_public", org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(org.jooq.impl.DSL.field("true", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FREEFORM_COMPLEXITY_IDX, Indexes.FREEFORM_LANG_IDX, Indexes.FREEFORM_PARENT_ID_IDX, Indexes.FREEFORM_PKEY, Indexes.FREEFORM_TYPE_IDX, Indexes.FREEFORM_VALUE_TEXT_IDX);
    }
