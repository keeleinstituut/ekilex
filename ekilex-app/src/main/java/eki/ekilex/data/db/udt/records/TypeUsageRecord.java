...
public class TypeUsageRecord extends UDTRecordImpl<TypeUsageRecord> implements Record7<String, String, String, String, String[], String[], String[]> {

    private static final long serialVersionUID = -1060427084;
     ...
     */
    @Override
    public TypeUsageRecord values(String value1, String value2, String value3, String value4, String[] value5, String[] value6, String[] value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TypeUsageRecord(String usage, String usagePrese, String usageLang, String usageTypeCode, String[] usageTranslations, String[] usageDefinitions, String[] usageAuthors) {
        super(TypeUsage.TYPE_USAGE);
        ...
        set(2, usageLang);
        set(3, usageTypeCode);
        set(4, usageTranslations);
        set(5, usageDefinitions);
        set(6, usageAuthors);
    }
}
