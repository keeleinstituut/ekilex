...
public class LexemeLifecycleLog extends TableImpl<LexemeLifecycleLogRecord> {
    ...
    private static final long serialVersionUID = 1427964458;
     ...
     */
    public final TableField<LexemeLifecycleLogRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('lexeme_lifecycle_log_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.lexeme_lifecycle_log.lexeme_id</code>.
     */
    public final TableField<LexemeLifecycleLogRecord, Long> LEXEME_ID = createField(DSL.name("lexeme_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.lexeme_lifecycle_log.lifecycle_log_id</code>.
     */
    public final TableField<LexemeLifecycleLogRecord, Long> LIFECYCLE_LOG_ID = createField(DSL.name("lifecycle_log_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.LEXEME_LIFECYCLE_LOG_LEXEME_ID_IDX, Indexes.LEXEME_LIFECYCLE_LOG_LOG_ID_IDX);
    }
