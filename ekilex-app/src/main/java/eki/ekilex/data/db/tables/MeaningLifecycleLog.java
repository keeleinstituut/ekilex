...
public class MeaningLifecycleLog extends TableImpl<MeaningLifecycleLogRecord> {
    ...
    private static final long serialVersionUID = 355677202;
     ...
     */
    public final TableField<MeaningLifecycleLogRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('meaning_lifecycle_log_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.meaning_lifecycle_log.meaning_id</code>.
     */
    public final TableField<MeaningLifecycleLogRecord, Long> MEANING_ID = createField(DSL.name("meaning_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.meaning_lifecycle_log.lifecycle_log_id</code>.
     */
    public final TableField<MeaningLifecycleLogRecord, Long> LIFECYCLE_LOG_ID = createField(DSL.name("lifecycle_log_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MEANING_LIFECYCLE_LOG_LOG_ID_IDX, Indexes.MEANING_LIFECYCLE_LOG_MEANING_ID_IDX);
    }
