...
public class Indexes {
    ...
    public static final Index LAYER_STATE_LEXEME_ID_IDX = Indexes0.LAYER_STATE_LEXEME_ID_IDX;
    ...
    public static final Index LEX_REL_MAPPING_CODE1_CODE2_KEY = Indexes0.LEX_REL_MAPPING_CODE1_CODE2_KEY;
    ...
    public static final Index LEXEME_PROCESS_LOG_LEXEME_ID_IDX = Indexes0.LEXEME_PROCESS_LOG_LEXEME_ID_IDX;
    public static final Index LEXEME_PROCESS_LOG_LOG_ID_IDX = Indexes0.LEXEME_PROCESS_LOG_LOG_ID_IDX;
    public static final Index LEXEME_PROCESS_LOG_PKEY = Indexes0.LEXEME_PROCESS_LOG_PKEY;
    public static final Index LEXEME_REGION_LEXEME_ID_IDX = Indexes0.LEXEME_REGION_LEXEME_ID_IDX;
    public static final Index LEXEME_REGION_LEXEME_ID_REGION_CODE_KEY = Indexes0.LEXEME_REGION_LEXEME_ID_REGION_CODE_KEY;
    public static final Index LEXEME_REGION_PKEY = Indexes0.LEXEME_REGION_PKEY;
    ...
    public static final Index MEANING_DOMAIN_MEANING_ID_IDX = Indexes0.MEANING_DOMAIN_MEANING_ID_IDX;
    ...
    public static final Index MEANING_PROCESS_LOG_LOG_ID_IDX = Indexes0.MEANING_PROCESS_LOG_LOG_ID_IDX;
    public static final Index MEANING_PROCESS_LOG_MEANING_ID_IDX = Indexes0.MEANING_PROCESS_LOG_MEANING_ID_IDX;
    public static final Index MEANING_PROCESS_LOG_PKEY = Indexes0.MEANING_PROCESS_LOG_PKEY;
    public static final Index MEANING_REL_MAPPING_CODE1_CODE2_KEY = Indexes0.MEANING_REL_MAPPING_CODE1_CODE2_KEY;
    ...
    public static final Index MEANING_SEMANTIC_TYPE_MEANING_ID_SEMANTIC_TYPE_CODE_KEY = Indexes0.MEANING_SEMANTIC_TYPE_MEANING_ID_SEMANTIC_TYPE_CODE_KEY;
    public static final Index MEANING_SEMANTIC_TYPE_PKEY = Indexes0.MEANING_SEMANTIC_TYPE_PKEY;
    ...
    public static final Index PROCESS_LOG_PKEY = Indexes0.PROCESS_LOG_PKEY;
    public static final Index PROCESS_LOG_SOURCE_LINK_PKEY = Indexes0.PROCESS_LOG_SOURCE_LINK_PKEY;
    public static final Index PROCESS_LOG_SOURCE_LINK_PROCESS_LOG_ID_IDX = Indexes0.PROCESS_LOG_SOURCE_LINK_PROCESS_LOG_ID_IDX;
    public static final Index PROCESS_LOG_SOURCE_LINK_SOURCE_ID_IDX = Indexes0.PROCESS_LOG_SOURCE_LINK_SOURCE_ID_IDX;
    ...
    public static final Index SEMANTIC_TYPE_PKEY = Indexes0.SEMANTIC_TYPE_PKEY;
    public static final Index SEMANTIC_TYPE_LABEL_CODE_LANG_TYPE_KEY = Indexes0.SEMANTIC_TYPE_LABEL_CODE_LANG_TYPE_KEY;
    ...
    public static final Index SOURCE_LIFECYCLE_LOG_PKEY = Indexes0.SOURCE_LIFECYCLE_LOG_PKEY;
    public static final Index SOURCE_LIFECYCLE_LOG_SOURCE_ID_IDX = Indexes0.SOURCE_LIFECYCLE_LOG_SOURCE_ID_IDX;
    public static final Index TEMP_DS_IMPORT_PK_MAP_IMPORT_CODE_IDX = Indexes0.TEMP_DS_IMPORT_PK_MAP_IMPORT_CODE_IDX;
    public static final Index TEMP_DS_IMPORT_PK_MAP_PKEY = Indexes0.TEMP_DS_IMPORT_PK_MAP_PKEY;
    ...
    public static final Index TEMP_DS_IMPORT_QUEUE_PKEY = Indexes0.TEMP_DS_IMPORT_QUEUE_PKEY;
    ...
    public static final Index WORD_ETYMOLOGY_RELATION_PKEY = Indexes0.WORD_ETYMOLOGY_RELATION_PKEY;
    public static final Index WORD_ETYMOLOGY_RELATION_WORD_ETYM_ID_RELATED_WORD_ID_KEY = Indexes0.WORD_ETYMOLOGY_RELATION_WORD_ETYM_ID_RELATED_WORD_ID_KEY;
    ...
    public static final Index WORD_PROCESS_LOG_LOG_ID_IDX = Indexes0.WORD_PROCESS_LOG_LOG_ID_IDX;
    public static final Index WORD_PROCESS_LOG_PKEY = Indexes0.WORD_PROCESS_LOG_PKEY;
    public static final Index WORD_PROCESS_LOG_WORD_ID_IDX = Indexes0.WORD_PROCESS_LOG_WORD_ID_IDX;
    public static final Index WORD_REL_MAPPING_CODE1_CODE2_KEY = Indexes0.WORD_REL_MAPPING_CODE1_CODE2_KEY;
    ...
    public static final Index WORD_RELATION_PARAM_WORD_RELATION_ID_NAME_KEY = Indexes0.WORD_RELATION_PARAM_WORD_RELATION_ID_NAME_KEY;
    ...
    private static class Indexes0 {
        ...
        public static Index LAYER_STATE_LEXEME_ID_IDX = Internal.createIndex("layer_state_lexeme_id_idx", LayerState.LAYER_STATE, new OrderField[] { LayerState.LAYER_STATE.LEXEME_ID }, false);
        ...
        public static Index LEX_REL_MAPPING_CODE1_CODE2_KEY = Internal.createIndex("lex_rel_mapping_code1_code2_key", LexRelMapping.LEX_REL_MAPPING, new OrderField[] { LexRelMapping.LEX_REL_MAPPING.CODE1, LexRelMapping.LEX_REL_MAPPING.CODE2 }, true);
        ...
        public static Index LEXEME_PROCESS_LOG_LEXEME_ID_IDX = Internal.createIndex("lexeme_process_log_lexeme_id_idx", LexemeProcessLog.LEXEME_PROCESS_LOG, new OrderField[] { LexemeProcessLog.LEXEME_PROCESS_LOG.LEXEME_ID }, false);
        public static Index LEXEME_PROCESS_LOG_LOG_ID_IDX = Internal.createIndex("lexeme_process_log_log_id_idx", LexemeProcessLog.LEXEME_PROCESS_LOG, new OrderField[] { LexemeProcessLog.LEXEME_PROCESS_LOG.PROCESS_LOG_ID }, false);
        public static Index LEXEME_PROCESS_LOG_PKEY = Internal.createIndex("lexeme_process_log_pkey", LexemeProcessLog.LEXEME_PROCESS_LOG, new OrderField[] { LexemeProcessLog.LEXEME_PROCESS_LOG.ID }, true);
        ...
        public static Index LEXEME_REGION_LEXEME_ID_REGION_CODE_KEY = Internal.createIndex("lexeme_region_lexeme_id_region_code_key", LexemeRegion.LEXEME_REGION, new OrderField[] { LexemeRegion.LEXEME_REGION.LEXEME_ID, LexemeRegion.LEXEME_REGION.REGION_CODE }, true);
        public static Index LEXEME_REGION_PKEY = Internal.createIndex("lexeme_region_pkey", LexemeRegion.LEXEME_REGION, new OrderField[] { LexemeRegion.LEXEME_REGION.ID }, true);
        ...
        public static Index MEANING_DOMAIN_MEANING_ID_IDX = Internal.createIndex("meaning_domain_meaning_id_idx", MeaningDomain.MEANING_DOMAIN, new OrderField[] { MeaningDomain.MEANING_DOMAIN.MEANING_ID }, false);
        ...
        public static Index MEANING_PROCESS_LOG_LOG_ID_IDX = Internal.createIndex("meaning_process_log_log_id_idx", MeaningProcessLog.MEANING_PROCESS_LOG, new OrderField[] { MeaningProcessLog.MEANING_PROCESS_LOG.PROCESS_LOG_ID }, false);
        public static Index MEANING_PROCESS_LOG_MEANING_ID_IDX = Internal.createIndex("meaning_process_log_meaning_id_idx", MeaningProcessLog.MEANING_PROCESS_LOG, new OrderField[] { MeaningProcessLog.MEANING_PROCESS_LOG.MEANING_ID }, false);
        public static Index MEANING_PROCESS_LOG_PKEY = Internal.createIndex("meaning_process_log_pkey", MeaningProcessLog.MEANING_PROCESS_LOG, new OrderField[] { MeaningProcessLog.MEANING_PROCESS_LOG.ID }, true);
        public static Index MEANING_REL_MAPPING_CODE1_CODE2_KEY = Internal.createIndex("meaning_rel_mapping_code1_code2_key", MeaningRelMapping.MEANING_REL_MAPPING, new OrderField[] { MeaningRelMapping.MEANING_REL_MAPPING.CODE1, MeaningRelMapping.MEANING_REL_MAPPING.CODE2 }, true);
        ...
        public static Index MEANING_SEMANTIC_TYPE_MEANING_ID_SEMANTIC_TYPE_CODE_KEY = Internal.createIndex("meaning_semantic_type_meaning_id_semantic_type_code_key", MeaningSemanticType.MEANING_SEMANTIC_TYPE, new OrderField[] { MeaningSemanticType.MEANING_SEMANTIC_TYPE.MEANING_ID, MeaningSemanticType.MEANING_SEMANTIC_TYPE.SEMANTIC_TYPE_CODE }, true);
        public static Index MEANING_SEMANTIC_TYPE_PKEY = Internal.createIndex("meaning_semantic_type_pkey", MeaningSemanticType.MEANING_SEMANTIC_TYPE, new OrderField[] { MeaningSemanticType.MEANING_SEMANTIC_TYPE.ID }, true);
        ...
        public static Index PROCESS_LOG_PKEY = Internal.createIndex("process_log_pkey", ProcessLog.PROCESS_LOG, new OrderField[] { ProcessLog.PROCESS_LOG.ID }, true);
        public static Index PROCESS_LOG_SOURCE_LINK_PKEY = Internal.createIndex("process_log_source_link_pkey", ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, new OrderField[] { ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.ID }, true);
        public static Index PROCESS_LOG_SOURCE_LINK_PROCESS_LOG_ID_IDX = Internal.createIndex("process_log_source_link_process_log_id_idx", ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, new OrderField[] { ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.PROCESS_LOG_ID }, false);
        public static Index PROCESS_LOG_SOURCE_LINK_SOURCE_ID_IDX = Internal.createIndex("process_log_source_link_source_id_idx", ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, new OrderField[] { ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.SOURCE_ID }, false);
        ...
        public static Index REGION_PKEY = Internal.createIndex("region_pkey", Region.REGION, new OrderField[] { Region.REGION.CODE }, true);
        ...
        public static Index SEMANTIC_TYPE_PKEY = Internal.createIndex("semantic_type_pkey", SemanticType.SEMANTIC_TYPE, new OrderField[] { SemanticType.SEMANTIC_TYPE.CODE }, true);
        public static Index SEMANTIC_TYPE_LABEL_CODE_LANG_TYPE_KEY = Internal.createIndex("semantic_type_label_code_lang_type_key", SemanticTypeLabel.SEMANTIC_TYPE_LABEL, new OrderField[] { SemanticTypeLabel.SEMANTIC_TYPE_LABEL.CODE, SemanticTypeLabel.SEMANTIC_TYPE_LABEL.LANG, SemanticTypeLabel.SEMANTIC_TYPE_LABEL.TYPE }, true);
        ...
        public static Index SOURCE_LIFECYCLE_LOG_PKEY = Internal.createIndex("source_lifecycle_log_pkey", SourceLifecycleLog.SOURCE_LIFECYCLE_LOG, new OrderField[] { SourceLifecycleLog.SOURCE_LIFECYCLE_LOG.ID }, true);
        public static Index SOURCE_LIFECYCLE_LOG_SOURCE_ID_IDX = Internal.createIndex("source_lifecycle_log_source_id_idx", SourceLifecycleLog.SOURCE_LIFECYCLE_LOG, new OrderField[] { SourceLifecycleLog.SOURCE_LIFECYCLE_LOG.SOURCE_ID }, false);
        ...
        public static Index TEMP_DS_IMPORT_PK_MAP_PKEY = Internal.createIndex("temp_ds_import_pk_map_pkey", TempDsImportPkMap.TEMP_DS_IMPORT_PK_MAP, new OrderField[] { TempDsImportPkMap.TEMP_DS_IMPORT_PK_MAP.ID }, true);
        ...
        public static Index TEMP_DS_IMPORT_QUEUE_PKEY = Internal.createIndex("temp_ds_import_queue_pkey", TempDsImportQueue.TEMP_DS_IMPORT_QUEUE, new OrderField[] { TempDsImportQueue.TEMP_DS_IMPORT_QUEUE.ID }, true);
        ...
        public static Index WORD_ETYMOLOGY_RELATION_PKEY = Internal.createIndex("word_etymology_relation_pkey", WordEtymologyRelation.WORD_ETYMOLOGY_RELATION, new OrderField[] { WordEtymologyRelation.WORD_ETYMOLOGY_RELATION.ID }, true);
        public static Index WORD_ETYMOLOGY_RELATION_WORD_ETYM_ID_RELATED_WORD_ID_KEY = Internal.createIndex("word_etymology_relation_word_etym_id_related_word_id_key", WordEtymologyRelation.WORD_ETYMOLOGY_RELATION, new OrderField[] { WordEtymologyRelation.WORD_ETYMOLOGY_RELATION.WORD_ETYM_ID, WordEtymologyRelation.WORD_ETYMOLOGY_RELATION.RELATED_WORD_ID }, true);
        ...
        public static Index WORD_PROCESS_LOG_LOG_ID_IDX = Internal.createIndex("word_process_log_log_id_idx", WordProcessLog.WORD_PROCESS_LOG, new OrderField[] { WordProcessLog.WORD_PROCESS_LOG.PROCESS_LOG_ID }, false);
        public static Index WORD_PROCESS_LOG_PKEY = Internal.createIndex("word_process_log_pkey", WordProcessLog.WORD_PROCESS_LOG, new OrderField[] { WordProcessLog.WORD_PROCESS_LOG.ID }, true);
        public static Index WORD_PROCESS_LOG_WORD_ID_IDX = Internal.createIndex("word_process_log_word_id_idx", WordProcessLog.WORD_PROCESS_LOG, new OrderField[] { WordProcessLog.WORD_PROCESS_LOG.WORD_ID }, false);
        public static Index WORD_REL_MAPPING_CODE1_CODE2_KEY = Internal.createIndex("word_rel_mapping_code1_code2_key", WordRelMapping.WORD_REL_MAPPING, new OrderField[] { WordRelMapping.WORD_REL_MAPPING.CODE1, WordRelMapping.WORD_REL_MAPPING.CODE2 }, true);
        ...
        public static Index WORD_RELATION_PARAM_WORD_RELATION_ID_NAME_KEY = Internal.createIndex("word_relation_param_word_relation_id_name_key", WordRelationParam.WORD_RELATION_PARAM, new OrderField[] { WordRelationParam.WORD_RELATION_PARAM.WORD_RELATION_ID, WordRelationParam.WORD_RELATION_PARAM.NAME }, true);
