...
public class WordTypeLabel extends TableImpl<WordTypeLabelRecord> {
    ...
    private static final long serialVersionUID = -311999804;
     ...
     */
    public final TableField<WordTypeLabelRecord, String> CODE = createField(DSL.name("code"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.word_type_label.value</code>.
     */
    public final TableField<WordTypeLabelRecord, String> VALUE = createField(DSL.name("value"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.word_type_label.lang</code>.
     */
    public final TableField<WordTypeLabelRecord, String> LANG = createField(DSL.name("lang"), org.jooq.impl.SQLDataType.CHAR(3).nullable(false), this, "");

    /**
     * The column <code>public.word_type_label.type</code>.
     */
    public final TableField<WordTypeLabelRecord, String> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");
