...
public class FeedbackLogCommentRecord extends UpdatableRecordImpl<FeedbackLogCommentRecord> implements Record5<Long, Long, String, String, Timestamp> {
    ...
    private static final long serialVersionUID = -755383880;
     ...
     */
    @Override
    public FeedbackLogCommentRecord value5(Timestamp value) {
        setCreatedOn(value);
        return this;
    }
     ...
     */
    @Override
    public FeedbackLogCommentRecord values(Long value1, Long value2, String value3, String value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
