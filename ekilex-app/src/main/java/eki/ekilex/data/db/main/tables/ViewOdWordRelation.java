...
public class ViewOdWordRelation extends TableImpl<ViewOdWordRelationRecord> {
    ...
    /**
     * The column <code>public.view_od_word_relation.related_words</code>.
     */
    public final TableField<ViewOdWordRelationRecord, JSON> RELATED_WORDS = createField(DSL.name("related_words"), SQLDataType.JSON, this, "");
