...
public class Government extends TableImpl<GovernmentRecord> {
    ...
    /**
     * The column <code>public.government.complexity</code>.
     */
    public final TableField<GovernmentRecord, String> COMPLEXITY = createField(DSL.name("complexity"), SQLDataType.VARCHAR(100).nullable(false), this, "");
