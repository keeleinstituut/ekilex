...
public class LifecycleLog extends TableImpl<LifecycleLogRecord> {
    ...
    private static final long serialVersionUID = 2104519582;
     ...
     */
    public final TableField<LifecycleLogRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('lifecycle_log_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.lifecycle_log.entity_id</code>.
     */
    public final TableField<LifecycleLogRecord, Long> ENTITY_ID = createField(DSL.name("entity_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.lifecycle_log.entity_name</code>.
     */
    public final TableField<LifecycleLogRecord, String> ENTITY_NAME = createField(DSL.name("entity_name"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.lifecycle_log.entity_prop</code>.
     */
    public final TableField<LifecycleLogRecord, String> ENTITY_PROP = createField(DSL.name("entity_prop"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.lifecycle_log.event_type</code>.
     */
    public final TableField<LifecycleLogRecord, String> EVENT_TYPE = createField(DSL.name("event_type"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.lifecycle_log.event_by</code>.
     */
    public final TableField<LifecycleLogRecord, String> EVENT_BY = createField(DSL.name("event_by"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.lifecycle_log.event_on</code>.
     */
    public final TableField<LifecycleLogRecord, Timestamp> EVENT_ON = createField(DSL.name("event_on"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("statement_timestamp()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>public.lifecycle_log.recent</code>.
     */
    public final TableField<LifecycleLogRecord, String> RECENT = createField(DSL.name("recent"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.lifecycle_log.entry</code>.
     */
    public final TableField<LifecycleLogRecord, String> ENTRY = createField(DSL.name("entry"), org.jooq.impl.SQLDataType.CLOB, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.LIFECYCLE_LOG_EVENT_BY_IDX, Indexes.LIFECYCLE_LOG_EVENT_ON_ID_IDX);
    }
