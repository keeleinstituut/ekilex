...
public class WordEtymologyRecord extends UpdatableRecordImpl<WordEtymologyRecord> implements Record7<Long, Long, Long, String, String[], Boolean, Boolean> {

    private static final long serialVersionUID = -1503243567;
     ...
     */
    @Override
    public WordEtymologyRecord values(Long value1, Long value2, Long value3, String value4, String[] value5, Boolean value6, Boolean value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WordEtymologyRecord(Long id, Long word1Id, Long word2Id, String etymologyTypeCode, String[] comments, Boolean isQuestionable, Boolean isCompound) {
        super(WordEtymology.WORD_ETYMOLOGY);
