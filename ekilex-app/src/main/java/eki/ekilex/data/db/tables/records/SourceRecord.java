...
public class SourceRecord extends UpdatableRecordImpl<SourceRecord> implements Record6<Long, String, String, String, String, Boolean> {
    ...
    /**
     * Setter for <code>public.source.description</code>.
     */
    ...
    /**
     * Getter for <code>public.source.description</code>.
     */
    ...
    @Override
    public SourceRecord values(Long value1, String value2, String value3, String value4, String value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SourceRecord(Long id, String type, String name, String description, String comment, Boolean isPublic) {
        super(Source.SOURCE);
