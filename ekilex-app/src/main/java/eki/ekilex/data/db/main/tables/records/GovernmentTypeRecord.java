...
public class GovernmentTypeRecord extends UpdatableRecordImpl<GovernmentTypeRecord> implements Record2<String, Long> {
    ...
    @Override
    public GovernmentTypeRecord value2(Long value) {
        setOrderBy(value);
        return this;
    }

    @Override
    public GovernmentTypeRecord values(String value1, Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public GovernmentTypeRecord(String code, Long orderBy) {
        super(GovernmentType.GOVERNMENT_TYPE);
