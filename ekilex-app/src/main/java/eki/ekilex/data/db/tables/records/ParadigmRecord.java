...
public class ParadigmRecord extends UpdatableRecordImpl<ParadigmRecord> implements Record6<Long, Long, String, String, String, Boolean> {
    ...
    private static final long serialVersionUID = -658163742;
     ...
     */
    @Override
    public ParadigmRecord values(Long value1, Long value2, String value3, String value4, String value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
