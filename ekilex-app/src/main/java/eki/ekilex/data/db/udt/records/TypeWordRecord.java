...
public class TypeWordRecord extends UDTRecordImpl<TypeWordRecord> implements Record4<Long, Long, String, String> {

    private static final long serialVersionUID = -2004346009;
     ...
     */
    @Override
    public TypeWordRecord values(Long value1, Long value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TypeWordRecord(Long lexemeId, Long meaningId, String value, String lang) {
        super(TypeWord.TYPE_WORD);
