...
public class ViewWwWordRecord extends TableRecordImpl<ViewWwWordRecord> {
    ...
    /**
     * Setter for <code>public.view_ww_word.word_os_recommendation</code>.
     */
    ...
    /**
     * Getter for <code>public.view_ww_word.word_os_recommendation</code>.
     */
     ...
     */
    public ViewWwWordRecord(Long wordId, String value, String valuePrese, String valueAsWord, String lang, String langFilt, Long langOrderBy, Integer homonymNr, String displayMorphCode, String genderCode, String aspectCode, String vocalForm, String morphComment, Integer regYear, LocalDateTime manualEventOn, LocalDateTime lastActivityEventOn, String[] wordTypeCodes, JSON meaningWords, JSON definitions, JSON wordOsRecommendation, BigDecimal freqValue, Long freqRank, Boolean formsExist, Long minDsOrderBy, Long wordTypeOrderBy, TypeLangDatasetPublishingRecord[] langDsPubs) {
        super(ViewWwWord.VIEW_WW_WORD);
