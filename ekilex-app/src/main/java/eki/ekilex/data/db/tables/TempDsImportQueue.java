...
public class TempDsImportQueue extends TableImpl<TempDsImportQueueRecord> {
    ...
    private static final long serialVersionUID = -2045342863;
     ...
     */
    public final TableField<TempDsImportQueueRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('temp_ds_import_queue_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.temp_ds_import_queue.import_code</code>.
     */
    public final TableField<TempDsImportQueueRecord, String> IMPORT_CODE = createField("import_code", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.temp_ds_import_queue.created_on</code>.
     */
    public final TableField<TempDsImportQueueRecord, Timestamp> CREATED_ON = createField("created_on", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("statement_timestamp()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>public.temp_ds_import_queue.table_name</code>.
     */
    public final TableField<TempDsImportQueueRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.temp_ds_import_queue.content</code>.
     */
    public final TableField<TempDsImportQueueRecord, String> CONTENT = createField("content", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TEMP_DS_IMPORT_QUEUE_IMPORT_CODE_IDX, Indexes.TEMP_DS_IMPORT_QUEUE_PKEY, Indexes.TEMP_DS_IMPORT_QUEUE_TABLE_NAME_IDX);
    }
