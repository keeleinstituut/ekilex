...
public class EkiUserProfileRecord extends UpdatableRecordImpl<EkiUserProfileRecord> implements Record3<Long, Long, Long> {

    private static final long serialVersionUID = 406585327;
     ...
     */
    @Override
    public EkiUserProfileRecord values(Long value1, Long value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public EkiUserProfileRecord(Long id, Long userId, Long recentDatasetPermissionId) {
        super(EkiUserProfile.EKI_USER_PROFILE);
