...
public class EkiUserProfileRecord extends UpdatableRecordImpl<EkiUserProfileRecord> implements Record7<Long, Long, Long, String[], String[], String[], String> {

    private static final long serialVersionUID = -324991327;
    ...
    /**
     * Setter for <code>public.eki_user_profile.terms_ver</code>.
     */
    ...
    /**
     * Getter for <code>public.eki_user_profile.terms_ver</code>.
     */
    ...
    public Field<String> field7() {
        return EkiUserProfile.EKI_USER_PROFILE.TERMS_VER;
    }
     ...
     */
    @Override
    public EkiUserProfileRecord values(Long value1, Long value2, Long value3, String[] value4, String[] value5, String[] value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EkiUserProfileRecord(Long id, Long userId, Long recentDatasetPermissionId, String[] preferredDatasets, String[] preferredBilingCandidateLangs, String[] preferredBilingLexMeaningWordLangs, String termsVer) {
        super(EkiUserProfile.EKI_USER_PROFILE);
