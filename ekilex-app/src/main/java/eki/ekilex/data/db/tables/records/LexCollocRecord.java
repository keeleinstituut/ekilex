...
public class LexCollocRecord extends UpdatableRecordImpl<LexCollocRecord> implements Record5<Long, Long, Long, Long, Long> {

    private static final long serialVersionUID = -1056989510;
     ...
     */
    @Override
    public LexCollocRecord value5(Long value) {
        setOrderBy(value);
        return this;
    }
     ...
     */
    @Override
    public LexCollocRecord values(Long value1, Long value2, Long value3, Long value4, Long value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LexCollocRecord(Long id, Long lexemeId, Long relGroupId, Long collocationId, Long orderBy) {
        super(LexColloc.LEX_COLLOC);
