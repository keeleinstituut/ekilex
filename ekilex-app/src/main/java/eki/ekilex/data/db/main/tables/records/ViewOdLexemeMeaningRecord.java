...
public class ViewOdLexemeMeaningRecord extends TableRecordImpl<ViewOdLexemeMeaningRecord> implements Record2<Long, JSON> {
    ...
    /**
     * Setter for <code>public.view_od_lexeme_meaning.lexeme_meanings</code>.
     */
    ...
    /**
     * Getter for <code>public.view_od_lexeme_meaning.lexeme_meanings</code>.
     */
    ...
    public Field<JSON> field2() {
        return ViewOdLexemeMeaning.VIEW_OD_LEXEME_MEANING.LEXEME_MEANINGS;
    }
    ...
    @Override
    public ViewOdLexemeMeaningRecord value2(JSON value) {
        setLexemeMeanings(value);
        return this;
    }

    @Override
    public ViewOdLexemeMeaningRecord values(Long value1, JSON value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public ViewOdLexemeMeaningRecord(Long wordId, JSON lexemeMeanings) {
        super(ViewOdLexemeMeaning.VIEW_OD_LEXEME_MEANING);
