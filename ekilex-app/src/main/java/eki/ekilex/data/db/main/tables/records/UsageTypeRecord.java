...
public class UsageTypeRecord extends UpdatableRecordImpl<UsageTypeRecord> implements Record2<String, Long> {
    ...
    @Override
    public UsageTypeRecord value2(Long value) {
        setOrderBy(value);
        return this;
    }

    @Override
    public UsageTypeRecord values(String value1, Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public UsageTypeRecord(String code, Long orderBy) {
        super(UsageType.USAGE_TYPE);
