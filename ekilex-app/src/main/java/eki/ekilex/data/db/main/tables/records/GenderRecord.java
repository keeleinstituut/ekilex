...
public class GenderRecord extends UpdatableRecordImpl<GenderRecord> implements Record2<String, Long> {
    ...
    @Override
    public GenderRecord value2(Long value) {
        setOrderBy(value);
        return this;
    }

    @Override
    public GenderRecord values(String value1, Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public GenderRecord(String code, Long orderBy) {
        super(Gender.GENDER);
