...
public class TempDsImportPkMapRecord extends UpdatableRecordImpl<TempDsImportPkMapRecord> implements Record6<Long, String, LocalDateTime, String, Long, Long> {
    ...
    @Override
    public Row6<Long, String, LocalDateTime, String, Long, Long> valuesRow() {
    ...
    @Override
    public TempDsImportPkMapRecord value3(LocalDateTime value) {
        setCreatedOn(value);
        return this;
    }
    ...
    @Override
    public TempDsImportPkMapRecord values(Long value1, String value2, LocalDateTime value3, String value4, Long value5, Long value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TempDsImportPkMapRecord(Long id, String importCode, LocalDateTime createdOn, String tableName, Long sourcePk, Long targetPk) {
        super(TempDsImportPkMap.TEMP_DS_IMPORT_PK_MAP);
