...
public class ViewWwLexeme extends TableImpl<ViewWwLexemeRecord> {
    ...
    private static final long serialVersionUID = -482353678;
     ...
     */
    public final TableField<ViewWwLexemeRecord, TypeFreeformRecord[]> OD_LEXEME_RECOMMENDATIONS = createField(DSL.name("od_lexeme_recommendations"), eki.ekilex.data.db.udt.TypeFreeform.TYPE_FREEFORM.getDataType().getArrayDataType(), this, "");
