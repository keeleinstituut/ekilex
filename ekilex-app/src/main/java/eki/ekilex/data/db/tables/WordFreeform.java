...
public class WordFreeform extends TableImpl<WordFreeformRecord> {
    ...
    private static final long serialVersionUID = 1330601694;
     ...
     */
    public final TableField<WordFreeformRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('word_freeform_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.word_freeform.word_id</code>.
     */
    public final TableField<WordFreeformRecord, Long> WORD_ID = createField("word_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.word_freeform.freeform_id</code>.
     */
    public final TableField<WordFreeformRecord, Long> FREEFORM_ID = createField("freeform_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.word_freeform.order_by</code>.
     */
    public final TableField<WordFreeformRecord, Long> ORDER_BY = createField("order_by", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('word_freeform_order_by_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.WORD_FREEFORM_FREEFORM_ID_IDX, Indexes.WORD_FREEFORM_PKEY, Indexes.WORD_FREEFORM_WORD_ID_FREEFORM_ID_KEY, Indexes.WORD_FREEFORM_WORD_ID_IDX);
    }
