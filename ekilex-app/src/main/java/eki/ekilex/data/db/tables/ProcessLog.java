...
public class ProcessLog extends TableImpl<ProcessLogRecord> {
    ...
    private static final long serialVersionUID = 513389485;
     ...
     */
    public final TableField<ProcessLogRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('process_log_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.process_log.event_by</code>.
     */
    public final TableField<ProcessLogRecord, String> EVENT_BY = createField(DSL.name("event_by"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.process_log.event_on</code>.
     */
    public final TableField<ProcessLogRecord, Timestamp> EVENT_ON = createField(DSL.name("event_on"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("statement_timestamp()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>public.process_log.comment</code>.
     */
    public final TableField<ProcessLogRecord, String> COMMENT = createField(DSL.name("comment"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.process_log.comment_prese</code>.
     */
    public final TableField<ProcessLogRecord, String> COMMENT_PRESE = createField(DSL.name("comment_prese"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.process_log.process_state_code</code>.
     */
    public final TableField<ProcessLogRecord, String> PROCESS_STATE_CODE = createField(DSL.name("process_state_code"), org.jooq.impl.SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>public.process_log.dataset_code</code>.
     */
    public final TableField<ProcessLogRecord, String> DATASET_CODE = createField(DSL.name("dataset_code"), org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>public.process_log.layer_name</code>.
     */
    public final TableField<ProcessLogRecord, String> LAYER_NAME = createField(DSL.name("layer_name"), org.jooq.impl.SQLDataType.VARCHAR(100), this, "");
