...
public class ViewWwMeaningRecord extends TableRecordImpl<ViewWwMeaningRecord> implements Record11<Long, LocalDateTime, LocalDateTime, JSON, JSON, JSON, String[], String[], String[], JSON, JSON> {
    ...
    @Override
    public ViewWwMeaningRecord values(Long value1, LocalDateTime value2, LocalDateTime value3, JSON value4, JSON value5, JSON value6, String[] value7, String[] value8, String[] value9, JSON value10, JSON value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ViewWwMeaningRecord(Long meaningId, LocalDateTime manualEventOn, LocalDateTime lastApproveOrEditEventOn, JSON domainCodes, JSON meaningImages, JSON mediaFiles, String[] systematicPolysemyPatterns, String[] semanticTypes, String[] learnerComments, JSON notes, JSON definitions) {
        super(ViewWwMeaning.VIEW_WW_MEANING);
