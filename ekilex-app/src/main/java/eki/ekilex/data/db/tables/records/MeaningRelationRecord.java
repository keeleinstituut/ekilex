...
public class MeaningRelationRecord extends UpdatableRecordImpl<MeaningRelationRecord> implements Record4<Long, Long, Long, String> {

    private static final long serialVersionUID = 1990263708;
     ...
     */
    @Override
    public MeaningRelationRecord values(Long value1, Long value2, Long value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MeaningRelationRecord(Long id, Long meaning1Id, Long meaning2Id, String meaningRelTypeCode) {
        super(MeaningRelation.MEANING_RELATION);
