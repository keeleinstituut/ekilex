...
public class Definition extends TableImpl<DefinitionRecord> {
    ...
    private static final long serialVersionUID = 28228604;
     ...
     */
    public final TableField<DefinitionRecord, Boolean> IS_PUBLIC = createField("is_public", org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(org.jooq.impl.DSL.field("true", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.DEFINITION_COMPLEXITY_IDX, Indexes.DEFINITION_LANG_IDX, Indexes.DEFINITION_MEANING_ID_IDX, Indexes.DEFINITION_PKEY);
    }
