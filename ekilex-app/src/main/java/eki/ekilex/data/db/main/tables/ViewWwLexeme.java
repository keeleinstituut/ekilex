...
public class ViewWwLexeme extends TableImpl<ViewWwLexemeRecord> {
    ...
    /**
     * The column <code>public.view_ww_lexeme.is_ww_od</code>.
     */
    public final TableField<ViewWwLexemeRecord, Boolean> IS_WW_OD = createField(DSL.name("is_ww_od"), SQLDataType.BOOLEAN, this, "");
