...
public class MeaningDomain extends TableImpl<MeaningDomainRecord> {
    ...
    private static final long serialVersionUID = 1811181390;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MEANING_DOMAIN_MEANING_ID_DOMAIN_CODE_DOMAIN_ORIGIN_KEY, Indexes.MEANING_DOMAIN_MEANING_ID_IDX, Indexes.MEANING_DOMAIN_PKEY);
    }
