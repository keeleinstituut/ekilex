...
public class MeaningNr extends TableImpl<MeaningNrRecord> {
    ...
    private static final long serialVersionUID = 1804632113;
     ...
     */
    public final TableField<MeaningNrRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('meaning_nr_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.meaning_nr.meaning_id</code>.
     */
    public final TableField<MeaningNrRecord, Long> MEANING_ID = createField("meaning_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.meaning_nr.mnr</code>.
     */
    public final TableField<MeaningNrRecord, String> MNR = createField("mnr", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.meaning_nr.dataset_code</code>.
     */
    public final TableField<MeaningNrRecord, String> DATASET_CODE = createField("dataset_code", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MEANING_NR_DATASET_CODE_IDX, Indexes.MEANING_NR_MEANING_ID_IDX, Indexes.MEANING_NR_MEANING_ID_MNR_DATASET_CODE_KEY, Indexes.MEANING_NR_MNR_IDX, Indexes.MEANING_NR_PKEY);
    }
