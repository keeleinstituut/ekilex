...
public class FreeformTypeRecord extends UpdatableRecordImpl<FreeformTypeRecord> implements Record2<String, Long> {
    ...
    @Override
    public FreeformTypeRecord value2(Long value) {
        setOrderBy(value);
        return this;
    }

    @Override
    public FreeformTypeRecord values(String value1, Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public FreeformTypeRecord(String code, Long orderBy) {
        super(FreeformType.FREEFORM_TYPE);
