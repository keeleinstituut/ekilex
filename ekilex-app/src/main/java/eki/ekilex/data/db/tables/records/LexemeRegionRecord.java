...
public class LexemeRegionRecord extends UpdatableRecordImpl<LexemeRegionRecord> implements Record3<Long, Long, String> {

    private static final long serialVersionUID = -320292429;
     ...
     */
    @Override
    public LexemeRegionRecord values(Long value1, Long value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public LexemeRegionRecord(Long id, Long lexemeId, String regionCode) {
        super(LexemeRegion.LEXEME_REGION);
