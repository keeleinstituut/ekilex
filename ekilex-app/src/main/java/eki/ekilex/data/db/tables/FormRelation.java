...
public class FormRelation extends TableImpl<FormRelationRecord> {
    ...
    private static final long serialVersionUID = 171279723;
    ...
    public <O extends Record> FormRelation(Table<O> child, ForeignKey<O, FormRelationRecord> key) {
        super(child, key, FORM_RELATION);
    }
    ...
    public Form formRelation_FormRelationForm1IdFkey() {
        return new Form(this, Keys.FORM_RELATION__FORM_RELATION_FORM1_ID_FKEY);
    }

    public Form formRelation_FormRelationForm2IdFkey() {
        return new Form(this, Keys.FORM_RELATION__FORM_RELATION_FORM2_ID_FKEY);
    }

    public FormRelType formRelType() {
        return new FormRelType(this, Keys.FORM_RELATION__FORM_RELATION_FORM_REL_TYPE_CODE_FKEY);
    }
