...
public class ValueState extends TableImpl<ValueStateRecord> {
    ...
    private static final long serialVersionUID = -992613201;
     ...
     */
    public final TableField<ValueStateRecord, String[]> DATASETS = createField("datasets", org.jooq.impl.SQLDataType.VARCHAR(10).getArrayDataType(), this, "");
