...
public class MorphRecord extends UpdatableRecordImpl<MorphRecord> implements Record2<String, Long> {
    ...
    @Override
    public MorphRecord value2(Long value) {
        setOrderBy(value);
        return this;
    }

    @Override
    public MorphRecord values(String value1, Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public MorphRecord(String code, Long orderBy) {
        super(Morph.MORPH);
