...
public class WordTypeRecord extends UpdatableRecordImpl<WordTypeRecord> implements Record2<String, String[]> {

    private static final long serialVersionUID = -1877768824;
     ...
     */
    @Override
    public WordTypeRecord values(String value1, String[] value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public WordTypeRecord(String code, String[] datasets) {
        super(WordType.WORD_TYPE);
