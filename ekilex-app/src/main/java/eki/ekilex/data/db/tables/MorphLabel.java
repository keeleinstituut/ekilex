...
public class MorphLabel extends TableImpl<MorphLabelRecord> {
    ...
    private static final long serialVersionUID = -1412676083;
     ...
     */
    public final TableField<MorphLabelRecord, String> CODE = createField("code", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");
     ...
     */
    public final TableField<MorphLabelRecord, String> LANG = createField("lang", org.jooq.impl.SQLDataType.CHAR(3).nullable(false), this, "");

    /**
     * The column <code>public.morph_label.type</code>.
     */
    public final TableField<MorphLabelRecord, String> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MORPH_LABEL_CODE_LANG_TYPE_KEY);
    }
