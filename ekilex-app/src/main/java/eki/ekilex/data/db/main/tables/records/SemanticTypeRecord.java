...
public class SemanticTypeRecord extends UpdatableRecordImpl<SemanticTypeRecord> implements Record2<String, Long> {
    ...
    @Override
    public SemanticTypeRecord value2(Long value) {
        setOrderBy(value);
        return this;
    }

    @Override
    public SemanticTypeRecord values(String value1, Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public SemanticTypeRecord(String code, Long orderBy) {
        super(SemanticType.SEMANTIC_TYPE);
