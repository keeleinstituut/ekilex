...
public class LexemeFreeformRecord extends UpdatableRecordImpl<LexemeFreeformRecord> implements Record4<Long, Long, Long, String> {

    private static final long serialVersionUID = 461406708;
    ...
    /**
     * Setter for <code>public.lexeme_freeform.process_state_code</code>.
     */
    ...
    /**
     * Getter for <code>public.lexeme_freeform.process_state_code</code>.
     */
    ...
    public Field<String> field4() {
        return LexemeFreeform.LEXEME_FREEFORM.PROCESS_STATE_CODE;
    }
     ...
     */
    @Override
    public LexemeFreeformRecord value4(String value) {
     ...
     */
    @Override
    public LexemeFreeformRecord values(Long value1, Long value2, Long value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LexemeFreeformRecord(Long id, Long lexemeId, Long freeformId, String processStateCode) {
        super(LexemeFreeform.LEXEME_FREEFORM);
