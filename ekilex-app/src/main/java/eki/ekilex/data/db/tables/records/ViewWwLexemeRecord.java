...
public class ViewWwLexemeRecord extends TableRecordImpl<ViewWwLexemeRecord> implements Record19<Long, Long, Long, String, String, Integer, Integer, String, Long, String[], String[], String[], TypeMeaningWordRecord[], String[], TypePublicNoteRecord[], TypeGrammarRecord[], TypeGovernmentRecord[], TypeUsageRecord[], TypeLangComplexityRecord[]> {

    private static final long serialVersionUID = -1393966268;
