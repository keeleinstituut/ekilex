...
public class ViewWwLexemeRecord extends TableRecordImpl<ViewWwLexemeRecord> implements Record20<Long, Long, Long, String, String, Integer, Integer, String, Long, String[], String[], String[], TypeMeaningWordRecord[], String[], TypePublicNoteRecord[], TypeGrammarRecord[], TypeGovernmentRecord[], TypeUsageRecord[], TypeLangComplexityRecord[], String[]> {

    private static final long serialVersionUID = 646317929;
    ...
    /**
     * Setter for <code>public.view_ww_lexeme.od_lexeme_suggestions</code>.
     */
    ...
    /**
     * Getter for <code>public.view_ww_lexeme.od_lexeme_suggestions</code>.
     */
     ...
     */
    @Override
    public Row20<Long, Long, Long, String, String, Integer, Integer, String, Long, String[], String[], String[], TypeMeaningWordRecord[], String[], TypePublicNoteRecord[], TypeGrammarRecord[], TypeGovernmentRecord[], TypeUsageRecord[], TypeLangComplexityRecord[], String[]> fieldsRow() {
     ...
     */
    @Override
    public Row20<Long, Long, Long, String, String, Integer, Integer, String, Long, String[], String[], String[], TypeMeaningWordRecord[], String[], TypePublicNoteRecord[], TypeGrammarRecord[], TypeGovernmentRecord[], TypeUsageRecord[], TypeLangComplexityRecord[], String[]> valuesRow() {
    ...
    public Field<String[]> field20() {
        return ViewWwLexeme.VIEW_WW_LEXEME.OD_LEXEME_SUGGESTIONS;
    }
     ...
     */
    @Override
    public ViewWwLexemeRecord value13(TypeMeaningWordRecord... value) {
     ...
     */
    @Override
    public ViewWwLexemeRecord value15(TypePublicNoteRecord... value) {
     ...
     */
    @Override
    public ViewWwLexemeRecord value16(TypeGrammarRecord... value) {
        setGrammars(value);
        return this;
    }
     ...
     */
    @Override
    public ViewWwLexemeRecord value17(TypeGovernmentRecord... value) {
     ...
     */
    @Override
    public ViewWwLexemeRecord value18(TypeUsageRecord... value) {
        setUsages(value);
        return this;
    }
     ...
     */
    @Override
    public ViewWwLexemeRecord value19(TypeLangComplexityRecord... value) {
