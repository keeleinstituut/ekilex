...
public class ViewWwWordSearchRecord extends TableRecordImpl<ViewWwWordSearchRecord> implements Record6<String, String, String, String[], Long, TypeLangDatasetPublishingRecord[]> {
    ...
    /**
     * Setter for <code>public.view_ww_word_search.word_value</code>.
     */
    ...
    /**
     * Getter for <code>public.view_ww_word_search.word_value</code>.
     */
    ...
    /**
     * Setter for <code>public.view_ww_word_search.filt_langs</code>.
     */
    ...
    /**
     * Getter for <code>public.view_ww_word_search.filt_langs</code>.
     */
    ...
    /**
     * Setter for <code>public.view_ww_word_search.lang_ds_pubs</code>.
     */
    ...
    /**
     * Getter for <code>public.view_ww_word_search.lang_ds_pubs</code>.
     */
    ...
    public Field<String> field2() {
        return ViewWwWordSearch.VIEW_WW_WORD_SEARCH.WORD_VALUE;
    }
    ...
    public Field<String[]> field4() {
        return ViewWwWordSearch.VIEW_WW_WORD_SEARCH.FILT_LANGS;
    }
    ...
    public Field<TypeLangDatasetPublishingRecord[]> field6() {
        return ViewWwWordSearch.VIEW_WW_WORD_SEARCH.LANG_DS_PUBS;
    }
    ...
    @Override
    public ViewWwWordSearchRecord value6(TypeLangDatasetPublishingRecord[] value) {
        setLangDsPubs(value);
        return this;
    }

    @Override
    public ViewWwWordSearchRecord values(String value1, String value2, String value3, String[] value4, Long value5, TypeLangDatasetPublishingRecord[] value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ViewWwWordSearchRecord(String sgroup, String wordValue, String crit, String[] filtLangs, Long langOrderBy, TypeLangDatasetPublishingRecord[] langDsPubs) {
        super(ViewWwWordSearch.VIEW_WW_WORD_SEARCH);
