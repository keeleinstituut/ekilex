...
public class UsageTranslation extends TableImpl<UsageTranslationRecord> {
     ...
     */
    public final TableField<UsageTranslationRecord, LocalDateTime> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.LOCALDATETIME(6), this, "");
     ...
     */
    public final TableField<UsageTranslationRecord, LocalDateTime> MODIFIED_ON = createField(DSL.name("modified_on"), SQLDataType.LOCALDATETIME(6), this, "");
