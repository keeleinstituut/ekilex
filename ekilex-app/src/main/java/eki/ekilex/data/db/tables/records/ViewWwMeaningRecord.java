...
public class ViewWwMeaningRecord extends TableRecordImpl<ViewWwMeaningRecord> implements Record8<Long, String, TypeDomainRecord[], String[], String[], String[], String[], TypeDefinitionRecord[]> {

    private static final long serialVersionUID = -603262246;
    ...
    /**
     * Setter for <code>public.view_ww_meaning.complexity</code>.
     */
    ...
    /**
     * Getter for <code>public.view_ww_meaning.complexity</code>.
     */
    ...
    public Field<String> field2() {
        return ViewWwMeaning.VIEW_WW_MEANING.COMPLEXITY;
    }
     ...
     */
    @Override
    public ViewWwMeaningRecord value2(String value) {
        setComplexity(value);
        return this;
    }
     ...
     */
    @Override
    public ViewWwMeaningRecord values(Long value1, String value2, TypeDomainRecord[] value3, String[] value4, String[] value5, String[] value6, String[] value7, TypeDefinitionRecord[] value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ViewWwMeaningRecord(Long meaningId, String complexity, TypeDomainRecord[] domainCodes, String[] imageFiles, String[] systematicPolysemyPatterns, String[] semanticTypes, String[] learnerComments, TypeDefinitionRecord[] definitions) {
        super(ViewWwMeaning.VIEW_WW_MEANING);
