...
public class ViewWwMeaningRecord extends TableRecordImpl<ViewWwMeaningRecord> implements Record11<Long, Timestamp, Timestamp, TypeDomainRecord[], TypeMediaFileRecord[], TypeMediaFileRecord[], String[], String[], String[], TypeFreeformRecord[], TypeDefinitionRecord[]> {
    ...
    @Override
    public ViewWwMeaningRecord value4(TypeDomainRecord[] value) {
    ...
    @Override
    public ViewWwMeaningRecord value6(TypeMediaFileRecord[] value) {
        setMediaFiles(value);
        return this;
    }
    ...
    @Override
    public ViewWwMeaningRecord value10(TypeFreeformRecord[] value) {
        setNotes(value);
        return this;
    }

    @Override
    public ViewWwMeaningRecord value11(TypeDefinitionRecord[] value) {
        setDefinitions(value);
        return this;
    }

    @Override
    public ViewWwMeaningRecord values(Long value1, Timestamp value2, Timestamp value3, TypeDomainRecord[] value4, TypeMediaFileRecord[] value5, TypeMediaFileRecord[] value6, String[] value7, String[] value8, String[] value9, TypeFreeformRecord[] value10, TypeDefinitionRecord[] value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
