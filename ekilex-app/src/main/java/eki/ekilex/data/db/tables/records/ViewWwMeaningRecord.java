...
public class ViewWwMeaningRecord extends TableRecordImpl<ViewWwMeaningRecord> implements Record9<Long, TypeDomainRecord[], TypeMediaFileRecord[], TypeMediaFileRecord[], String[], String[], String[], TypeFreeformRecord[], TypeDefinitionRecord[]> {

    private static final long serialVersionUID = -1925073258;
    ...
    @Override
    public ViewWwMeaningRecord value3(TypeMediaFileRecord[] value) {
        setImageFiles(value);
        return this;
    }
    ...
    @Override
    public ViewWwMeaningRecord value8(TypeFreeformRecord[] value) {
        setNotes(value);
        return this;
    }

    @Override
    public ViewWwMeaningRecord value9(TypeDefinitionRecord[] value) {
        setDefinitions(value);
        return this;
    }

    @Override
    public ViewWwMeaningRecord values(Long value1, TypeDomainRecord[] value2, TypeMediaFileRecord[] value3, TypeMediaFileRecord[] value4, String[] value5, String[] value6, String[] value7, TypeFreeformRecord[] value8, TypeDefinitionRecord[] value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ViewWwMeaningRecord(Long meaningId, TypeDomainRecord[] domainCodes, TypeMediaFileRecord[] imageFiles, TypeMediaFileRecord[] mediaFiles, String[] systematicPolysemyPatterns, String[] semanticTypes, String[] learnerComments, TypeFreeformRecord[] notes, TypeDefinitionRecord[] definitions) {
        super(ViewWwMeaning.VIEW_WW_MEANING);
