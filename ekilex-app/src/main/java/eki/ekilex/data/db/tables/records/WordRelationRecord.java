...
public class WordRelationRecord extends UpdatableRecordImpl<WordRelationRecord> implements Record5<Long, Long, Long, String, Long> {

    private static final long serialVersionUID = 2138047983;
     ...
     */
    @Override
    public WordRelationRecord value5(Long value) {
        setOrderBy(value);
        return this;
    }
     ...
     */
    @Override
    public WordRelationRecord values(Long value1, Long value2, Long value3, String value4, Long value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WordRelationRecord(Long id, Long word1Id, Long word2Id, String wordRelTypeCode, Long orderBy) {
        super(WordRelation.WORD_RELATION);
