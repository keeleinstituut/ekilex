...
public class ViewWwWord extends TableImpl<ViewWwWordRecord> {
    ...
    /**
     * The column <code>public.view_ww_word.word_os_recommendations</code>.
     */
    public final TableField<ViewWwWordRecord, JSON> WORD_OS_RECOMMENDATIONS = createField(DSL.name("word_os_recommendations"), SQLDataType.JSON, this, "");
