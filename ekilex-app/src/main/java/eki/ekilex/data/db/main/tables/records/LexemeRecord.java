...
public class LexemeRecord extends UpdatableRecordImpl<LexemeRecord> implements Record15<Long, Long, Long, String, Integer, Integer, String, String, Long, BigDecimal, Boolean, Integer, String, Boolean, Boolean> {
    ...
    @Override
    public Row15<Long, Long, Long, String, Integer, Integer, String, String, Long, BigDecimal, Boolean, Integer, String, Boolean, Boolean> valuesRow() {
    ...
    @Override
    public LexemeRecord value15(Boolean value) {
        setIsCollocation(value);
        return this;
    }

    @Override
    public LexemeRecord values(Long value1, Long value2, Long value3, String value4, Integer value5, Integer value6, String value7, String value8, Long value9, BigDecimal value10, Boolean value11, Integer value12, String value13, Boolean value14, Boolean value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LexemeRecord(Long id, Long wordId, Long meaningId, String datasetCode, Integer level1, Integer level2, String valueStateCode, String complexity, Long orderBy, BigDecimal weight, Boolean isPublic, Integer reliability, String proficiencyLevelCode, Boolean isWord, Boolean isCollocation) {
        super(Lexeme.LEXEME);
