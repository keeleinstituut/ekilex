...
public class WordProcessLog extends TableImpl<WordProcessLogRecord> {
    ...
    private static final long serialVersionUID = 1032128905;
     ...
     */
    public final TableField<WordProcessLogRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('word_process_log_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.word_process_log.word_id</code>.
     */
    public final TableField<WordProcessLogRecord, Long> WORD_ID = createField("word_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.word_process_log.process_log_id</code>.
     */
    public final TableField<WordProcessLogRecord, Long> PROCESS_LOG_ID = createField("process_log_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.WORD_PROCESS_LOG_LOG_ID_IDX, Indexes.WORD_PROCESS_LOG_PKEY, Indexes.WORD_PROCESS_LOG_WORD_ID_IDX);
    }
