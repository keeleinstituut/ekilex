...
public class ViewWwMeaning extends TableImpl<ViewWwMeaningRecord> {
    ...
    private static final long serialVersionUID = 514652309;
     ...
     */
    public final TableField<ViewWwMeaningRecord, Timestamp> MANUAL_EVENT_ON = createField(DSL.name("manual_event_on"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>public.view_ww_meaning.last_approve_or_edit_event_on</code>.
     */
    public final TableField<ViewWwMeaningRecord, Timestamp> LAST_APPROVE_OR_EDIT_EVENT_ON = createField(DSL.name("last_approve_or_edit_event_on"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
