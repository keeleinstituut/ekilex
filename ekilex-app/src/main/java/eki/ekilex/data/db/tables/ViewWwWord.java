...
public class ViewWwWord extends TableImpl<ViewWwWordRecord> {
    ...
    private static final long serialVersionUID = 36954174;
    ...
    @Override
    public Row21<Long, String, String, String, String, Long, Integer, String[], String, String, String, Timestamp, TypeLangComplexityRecord[], TypeMeaningWordRecord[], TypeDefinitionRecord[], String[], BigDecimal, Long, Boolean, Long, Long> fieldsRow() {
