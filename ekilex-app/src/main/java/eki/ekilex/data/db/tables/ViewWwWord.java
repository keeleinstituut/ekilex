...
public class ViewWwWord extends TableImpl<ViewWwWordRecord> {
    ...
    private static final long serialVersionUID = 1549076969;
     ...
     */
    public final TableField<ViewWwWordRecord, String> GENDER_CODE = createField(DSL.name("gender_code"), org.jooq.impl.SQLDataType.VARCHAR(100), this, "");
     ...
     */
    public final TableField<ViewWwWordRecord, String> VOCAL_FORM = createField(DSL.name("vocal_form"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.view_ww_word.manual_event_on</code>.
     */
    public final TableField<ViewWwWordRecord, Timestamp> MANUAL_EVENT_ON = createField(DSL.name("manual_event_on"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>public.view_ww_word.last_activity_event_on</code>.
     */
    public final TableField<ViewWwWordRecord, Timestamp> LAST_ACTIVITY_EVENT_ON = createField(DSL.name("last_activity_event_on"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
     ...
     */
    public final TableField<ViewWwWordRecord, TypeFreeformRecord[]> OD_WORD_RECOMMENDATIONS = createField(DSL.name("od_word_recommendations"), eki.ekilex.data.db.udt.TypeFreeform.TYPE_FREEFORM.getDataType().getArrayDataType(), this, "");

    /**
     * The column <code>public.view_ww_word.freq_value</code>.
     */
    public final TableField<ViewWwWordRecord, BigDecimal> FREQ_VALUE = createField(DSL.name("freq_value"), org.jooq.impl.SQLDataType.NUMERIC(12, 7), this, "");

    /**
     * The column <code>public.view_ww_word.freq_rank</code>.
     */
    public final TableField<ViewWwWordRecord, Long> FREQ_RANK = createField(DSL.name("freq_rank"), org.jooq.impl.SQLDataType.BIGINT, this, "");
