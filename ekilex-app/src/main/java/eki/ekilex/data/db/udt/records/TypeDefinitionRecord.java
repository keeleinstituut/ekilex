...
public class TypeDefinitionRecord extends UDTRecordImpl<TypeDefinitionRecord> implements Record9<Long, Long, Long, String, String, String, String, JSON, JSON> {
    ...
    /**
     * Setter for <code>public.type_definition.source_links</code>.
     */
    ...
    /**
     * Getter for <code>public.type_definition.source_links</code>.
     */
    ...
    @Override
    public Row9<Long, Long, Long, String, String, String, String, JSON, JSON> fieldsRow() {
        return (Row9) super.fieldsRow();
    }

    @Override
    public Row9<Long, Long, Long, String, String, String, String, JSON, JSON> valuesRow() {
    ...
    public Field<JSON> field8() {
        return TypeDefinition.SOURCE_LINKS;
    }
    ...
    @Override
    public TypeDefinitionRecord value8(JSON value) {
        setSourceLinks(value);
        return this;
    }

    @Override
    public TypeDefinitionRecord value9(JSON value) {
        setNotes(value);
        return this;
    }

    @Override
    public TypeDefinitionRecord values(Long value1, Long value2, Long value3, String value4, String value5, String value6, String value7, JSON value8, JSON value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TypeDefinitionRecord(Long lexemeId, Long meaningId, Long definitionId, String value, String valuePrese, String lang, String complexity, JSON sourceLinks, JSON notes) {
        super(TypeDefinition.TYPE_DEFINITION);
