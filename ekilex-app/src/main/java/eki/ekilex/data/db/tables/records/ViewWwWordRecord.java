...
public class ViewWwWordRecord extends TableRecordImpl<ViewWwWordRecord> implements Record10<Long, String, Integer, String, String, String, String[], Long, TypeWordRecord[], TypeDefinitionRecord[]> {

    private static final long serialVersionUID = -980322195;
     ...
     */
    @Override
    public Row10<Long, String, Integer, String, String, String, String[], Long, TypeWordRecord[], TypeDefinitionRecord[]> fieldsRow() {
     ...
     */
    @Override
    public Row10<Long, String, Integer, String, String, String, String[], Long, TypeWordRecord[], TypeDefinitionRecord[]> valuesRow() {
     ...
     */
    @Override
    public ViewWwWordRecord value9(TypeWordRecord... value) {
     ...
     */
    @Override
    public ViewWwWordRecord values(Long value1, String value2, Integer value3, String value4, String value5, String value6, String[] value7, Long value8, TypeWordRecord[] value9, TypeDefinitionRecord[] value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ViewWwWordRecord(Long wordId, String word, Integer homonymNr, String lang, String morphCode, String displayMorphCode, String[] datasetCodes, Long meaningCount, TypeWordRecord[] meaningWords, TypeDefinitionRecord[] definitions) {
        super(ViewWwWord.VIEW_WW_WORD);
