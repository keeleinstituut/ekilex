...
public class ViewWwWordRecord extends TableRecordImpl<ViewWwWordRecord> implements Record21<Long, String, String, String, String, Long, Integer, String[], String, String, String, Timestamp, TypeLangComplexityRecord[], TypeMeaningWordRecord[], TypeDefinitionRecord[], String[], BigDecimal, Long, Boolean, Long, Long> {

    private static final long serialVersionUID = 1709353790;
    ...
    @Override
    public Row21<Long, String, String, String, String, Long, Integer, String[], String, String, String, Timestamp, TypeLangComplexityRecord[], TypeMeaningWordRecord[], TypeDefinitionRecord[], String[], BigDecimal, Long, Boolean, Long, Long> valuesRow() {
    ...
    @Override
    public ViewWwWordRecord value12(Timestamp value) {
    ...
    @Override
    public ViewWwWordRecord value17(BigDecimal value) {
        setFreqValue(value);
        return this;
    }
