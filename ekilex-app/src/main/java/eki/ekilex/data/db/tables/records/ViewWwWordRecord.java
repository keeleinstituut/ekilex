...
public class ViewWwWordRecord extends TableRecordImpl<ViewWwWordRecord> implements Record20<Long, String, String, String, String, Long, Integer, String, String[], String, String, String, String[], TypeLangComplexityRecord[], TypeMeaningWordRecord[], TypeDefinitionRecord[], String[], Boolean, Boolean, Boolean> {

    private static final long serialVersionUID = 1716195982;
