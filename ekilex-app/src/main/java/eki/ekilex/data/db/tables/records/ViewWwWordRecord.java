...
public class ViewWwWordRecord extends TableRecordImpl<ViewWwWordRecord> implements Record18<Long, String, String, String, Integer, String, String[], String, String, String, String[], TypeLangComplexityRecord[], TypeMeaningWordRecord[], TypeDefinitionRecord[], String[], Boolean, Boolean, Boolean> {

    private static final long serialVersionUID = -1984997232;
     ...
     */
    @Override
    public ViewWwWordRecord value12(TypeLangComplexityRecord... value) {
     ...
     */
    @Override
    public ViewWwWordRecord value13(TypeMeaningWordRecord... value) {
