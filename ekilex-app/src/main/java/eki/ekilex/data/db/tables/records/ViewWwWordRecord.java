...
public class ViewWwWordRecord extends TableRecordImpl<ViewWwWordRecord> implements Record15<Long, String, Integer, String, String, String, String, String, String, String, String[], String[], Long, TypeWordRecord[], TypeDefinitionRecord[]> {
    ...
    private static final long serialVersionUID = -1704453511;
     ...
     */
    public ViewWwWordRecord(Long wordId, String word, Integer homonymNr, String wordClass, String lang, String morphCode, String displayMorphCode, String aspectCode, String etymologyYear, String etymologyTypeCode, String[] wordTypeCodes, String[] datasetCodes, Long meaningCount, TypeWordRecord[] meaningWords, TypeDefinitionRecord[] definitions) {
        super(ViewWwWord.VIEW_WW_WORD);
