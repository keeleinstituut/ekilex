...
public class ViewWwWordRecord extends TableRecordImpl<ViewWwWordRecord> implements Record13<Long, String, Integer, String, String, String[], String, String, String, String[], Long, TypeWordRecord[], TypeDefinitionRecord[]> {
    ...
    private static final long serialVersionUID = -1690118352;
     ...
     */
    public ViewWwWordRecord(Long wordId, String word, Integer homonymNr, String wordClass, String lang, String[] wordTypeCodes, String morphCode, String displayMorphCode, String aspectCode, String[] datasetCodes, Long meaningCount, TypeWordRecord[] meaningWords, TypeDefinitionRecord[] definitions) {
        super(ViewWwWord.VIEW_WW_WORD);
