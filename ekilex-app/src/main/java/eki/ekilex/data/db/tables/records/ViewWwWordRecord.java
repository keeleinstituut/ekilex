...
public class ViewWwWordRecord extends TableRecordImpl<ViewWwWordRecord> implements Record13<Long, String, String, String, Integer, String[], String, String, String, TypeLangComplexityRecord[], Long, TypeWordRecord[], TypeDefinitionRecord[]> {

    private static final long serialVersionUID = 374591369;
    ...
    /**
     * Setter for <code>public.view_ww_word.lang_complexitites</code>.
     */
    public void setLangComplexitites(TypeLangComplexityRecord... value) {
        set(9, value);
    }

    /**
     * Getter for <code>public.view_ww_word.lang_complexitites</code>.
     */
    public TypeLangComplexityRecord[] getLangComplexitites() {
     ...
     */
    @Override
    public Row13<Long, String, String, String, Integer, String[], String, String, String, TypeLangComplexityRecord[], Long, TypeWordRecord[], TypeDefinitionRecord[]> fieldsRow() {
     ...
     */
    @Override
    public Row13<Long, String, String, String, Integer, String[], String, String, String, TypeLangComplexityRecord[], Long, TypeWordRecord[], TypeDefinitionRecord[]> valuesRow() {
    ...
    public Field<TypeLangComplexityRecord[]> field10() {
        return ViewWwWord.VIEW_WW_WORD.LANG_COMPLEXITITES;
    }
     ...
     */
    @Override
    public ViewWwWordRecord values(Long value1, String value2, String value3, String value4, Integer value5, String[] value6, String value7, String value8, String value9, TypeLangComplexityRecord[] value10, Long value11, TypeWordRecord[] value12, TypeDefinitionRecord[] value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ViewWwWordRecord(Long wordId, String word, String wordClass, String lang, Integer homonymNr, String[] wordTypeCodes, String morphCode, String displayMorphCode, String aspectCode, TypeLangComplexityRecord[] langComplexitites, Long meaningCount, TypeWordRecord[] meaningWords, TypeDefinitionRecord[] definitions) {
        super(ViewWwWord.VIEW_WW_WORD);
