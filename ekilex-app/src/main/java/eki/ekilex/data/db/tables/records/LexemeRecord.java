...
public class LexemeRecord extends UpdatableRecordImpl<LexemeRecord> implements Record12<Long, Long, Long, String, Integer, Integer, String, String, Long, BigDecimal, Boolean, Integer> {

    private static final long serialVersionUID = 646889071;
    ...
    @Override
    public Row12<Long, Long, Long, String, Integer, Integer, String, String, Long, BigDecimal, Boolean, Integer> valuesRow() {
    ...
    @Override
    public LexemeRecord values(Long value1, Long value2, Long value3, String value4, Integer value5, Integer value6, String value7, String value8, Long value9, BigDecimal value10, Boolean value11, Integer value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LexemeRecord(Long id, Long wordId, Long meaningId, String datasetCode, Integer level1, Integer level2, String valueStateCode, String complexity, Long orderBy, BigDecimal weight, Boolean isPublic, Integer reliability) {
        super(Lexeme.LEXEME);
