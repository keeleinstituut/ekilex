...
public class LexemeRecord extends UpdatableRecordImpl<LexemeRecord> implements Record13<Long, Long, Long, String, Timestamp, String, Timestamp, String, String, Integer, Integer, Integer, String> {

    private static final long serialVersionUID = -1637188340;
     ...
     */
    @Override
    public Row13<Long, Long, Long, String, Timestamp, String, Timestamp, String, String, Integer, Integer, Integer, String> fieldsRow() {
     ...
     */
    @Override
    public Row13<Long, Long, Long, String, Timestamp, String, Timestamp, String, String, Integer, Integer, Integer, String> valuesRow() {
     ...
     */
    @Override
    public LexemeRecord values(Long value1, Long value2, Long value3, String value4, Timestamp value5, String value6, Timestamp value7, String value8, String value9, Integer value10, Integer value11, Integer value12, String value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LexemeRecord(Long id, Long wordId, Long meaningId, String datasetCode, Timestamp createdOn, String createdBy, Timestamp modifiedOn, String modifiedBy, String frequencyGroup, Integer level1, Integer level2, Integer level3, String valueStateCode) {
        super(Lexeme.LEXEME);
