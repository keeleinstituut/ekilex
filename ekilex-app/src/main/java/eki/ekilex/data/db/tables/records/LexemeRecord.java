...
public class LexemeRecord extends UpdatableRecordImpl<LexemeRecord> implements Record12<Long, Long, Long, String, Integer, Integer, String, String, Long, String, BigDecimal, Boolean> {

    private static final long serialVersionUID = -31994347;
    ...
    @Override
    public Row12<Long, Long, Long, String, Integer, Integer, String, String, Long, String, BigDecimal, Boolean> valuesRow() {
    ...
    @Override
    public LexemeRecord value11(BigDecimal value) {
        setWeight(value);
        return this;
    }

    @Override
    public LexemeRecord value12(Boolean value) {
        setIsPublic(value);
        return this;
    }

    @Override
    public LexemeRecord values(Long value1, Long value2, Long value3, String value4, Integer value5, Integer value6, String value7, String value8, Long value9, String value10, BigDecimal value11, Boolean value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LexemeRecord(Long id, Long wordId, Long meaningId, String datasetCode, Integer level1, Integer level2, String valueStateCode, String complexity, Long orderBy, String type, BigDecimal weight, Boolean isPublic) {
        super(Lexeme.LEXEME);
