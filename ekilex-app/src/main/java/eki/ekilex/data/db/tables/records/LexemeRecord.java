...
public class LexemeRecord extends UpdatableRecordImpl<LexemeRecord> implements Record12<Long, Long, Long, String, String, BigDecimal, Integer, Integer, Integer, String, String, Long> {

    private static final long serialVersionUID = 1727504814;
     ...
     */
    @Override
    public Row12<Long, Long, Long, String, String, BigDecimal, Integer, Integer, Integer, String, String, Long> fieldsRow() {
     ...
     */
    @Override
    public Row12<Long, Long, Long, String, String, BigDecimal, Integer, Integer, Integer, String, String, Long> valuesRow() {
     ...
     */
    @Override
    public LexemeRecord values(Long value1, Long value2, Long value3, String value4, String value5, BigDecimal value6, Integer value7, Integer value8, Integer value9, String value10, String value11, Long value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LexemeRecord(Long id, Long wordId, Long meaningId, String datasetCode, String frequencyGroupCode, BigDecimal corpusFrequency, Integer level1, Integer level2, Integer level3, String valueStateCode, String processStateCode, Long orderBy) {
        super(Lexeme.LEXEME);
