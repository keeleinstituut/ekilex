...
public class Register extends TableImpl<RegisterRecord> {
    ...
    private static final long serialVersionUID = -940961747;
     ...
     */
    public final TableField<RegisterRecord, String> CODE = createField(DSL.name("code"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.register.datasets</code>.
     */
    public final TableField<RegisterRecord, String[]> DATASETS = createField(DSL.name("datasets"), org.jooq.impl.SQLDataType.VARCHAR(10).getArrayDataType(), this, "");

    /**
     * The column <code>public.register.order_by</code>.
     */
    public final TableField<RegisterRecord, Long> ORDER_BY = createField(DSL.name("order_by"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('register_order_by_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
