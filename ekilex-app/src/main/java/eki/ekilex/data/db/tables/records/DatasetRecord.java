...
public class DatasetRecord extends UpdatableRecordImpl<DatasetRecord> implements Record6<String, String, String, Boolean, Long, Boolean> {

    private static final long serialVersionUID = 1586207901;
     ...
     */
    @Override
    public Row6<String, String, String, Boolean, Long, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row6<String, String, String, Boolean, Long, Boolean> valuesRow() {
     ...
     */
    @Override
    public DatasetRecord values(String value1, String value2, String value3, Boolean value4, Long value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DatasetRecord(String code, String name, String description, Boolean isPublic, Long orderBy, Boolean isVisible) {
        super(Dataset.DATASET);
