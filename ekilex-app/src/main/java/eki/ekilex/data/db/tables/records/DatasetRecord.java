...
public class DatasetRecord extends UpdatableRecordImpl<DatasetRecord> implements Record8<String, String, String, String, Boolean, Boolean, Boolean, Long> {

    private static final long serialVersionUID = -334934582;
     ...
     */
    @Override
    public Row8<String, String, String, String, Boolean, Boolean, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row8<String, String, String, String, Boolean, Boolean, Boolean, Long> valuesRow() {
     ...
     */
    @Override
    public DatasetRecord values(String value1, String value2, String value3, String value4, Boolean value5, Boolean value6, Boolean value7, Long value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DatasetRecord(String code, String type, String name, String description, Boolean isVisible, Boolean isPublic, Boolean isSuperior, Long orderBy) {
        super(Dataset.DATASET);
