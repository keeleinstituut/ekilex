...
public class DatasetRecord extends UpdatableRecordImpl<DatasetRecord> implements Record10<String, String, String, String, Boolean, Boolean, Long, Boolean, String, String> {

    private static final long serialVersionUID = 1717484639;
    ...
    @Override
    public Row10<String, String, String, String, Boolean, Boolean, Long, Boolean, String, String> valuesRow() {
    ...
    @Override
    public DatasetRecord values(String value1, String value2, String value3, String value4, Boolean value5, Boolean value6, Long value7, Boolean value8, String value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DatasetRecord(String code, String type, String name, String description, Boolean isVisible, Boolean isPublic, Long orderBy, Boolean isSuperior, String contact, String imageUrl) {
        super(Dataset.DATASET);
