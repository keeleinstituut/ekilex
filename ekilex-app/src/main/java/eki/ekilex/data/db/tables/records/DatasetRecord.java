...
public class DatasetRecord extends UpdatableRecordImpl<DatasetRecord> implements Record9<String, String, String, String, Boolean, Boolean, Long, Boolean, String> {

    private static final long serialVersionUID = -1236970602;
    ...
    @Override
    public Row9<String, String, String, String, Boolean, Boolean, Long, Boolean, String> valuesRow() {
    ...
    @Override
    public DatasetRecord values(String value1, String value2, String value3, String value4, Boolean value5, Boolean value6, Long value7, Boolean value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DatasetRecord(String code, String type, String name, String description, Boolean isVisible, Boolean isPublic, Long orderBy, Boolean isSuperior, String contact) {
        super(Dataset.DATASET);
