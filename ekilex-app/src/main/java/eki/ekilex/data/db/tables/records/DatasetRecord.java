...
public class DatasetRecord extends UpdatableRecordImpl<DatasetRecord> implements Record6<String, String, String, Boolean, Boolean, Long> {

    private static final long serialVersionUID = -1986408035;
     ...
     */
    @Override
    public Row6<String, String, String, Boolean, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row6<String, String, String, Boolean, Boolean, Long> valuesRow() {
     ...
     */
    @Override
    public DatasetRecord value6(Long value) {
        setOrderBy(value);
        return this;
    }
     ...
     */
    @Override
    public DatasetRecord values(String value1, String value2, String value3, Boolean value4, Boolean value5, Long value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DatasetRecord(String code, String name, String description, Boolean isVisible, Boolean isPublic, Long orderBy) {
        super(Dataset.DATASET);
