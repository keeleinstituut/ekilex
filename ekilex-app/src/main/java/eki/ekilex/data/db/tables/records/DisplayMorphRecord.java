...
public class DisplayMorphRecord extends UpdatableRecordImpl<DisplayMorphRecord> implements Record3<String, String[], Long> {

    private static final long serialVersionUID = 2133810251;
     ...
     */
    @Override
    public DisplayMorphRecord value3(Long value) {
        setOrderBy(value);
        return this;
    }
     ...
     */
    @Override
    public DisplayMorphRecord values(String value1, String[] value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public DisplayMorphRecord(String code, String[] datasets, Long orderBy) {
        super(DisplayMorph.DISPLAY_MORPH);
