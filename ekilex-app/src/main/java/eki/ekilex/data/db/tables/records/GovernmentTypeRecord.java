...
public class GovernmentTypeRecord extends UpdatableRecordImpl<GovernmentTypeRecord> implements Record2<String, String[]> {

    private static final long serialVersionUID = 1572245782;
     ...
     */
    @Override
    public GovernmentTypeRecord values(String value1, String[] value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public GovernmentTypeRecord(String code, String[] datasets) {
        super(GovernmentType.GOVERNMENT_TYPE);
