...
public class LexemeFrequency extends TableImpl<LexemeFrequencyRecord> {
    ...
    private static final long serialVersionUID = -1888068105;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.LEXEME_FREQUENCY_LEXEME_ID_IDX, Indexes.LEXEME_FREQUENCY_LEXEME_ID_SOURCE_NAME_KEY, Indexes.LEXEME_FREQUENCY_PKEY);
    }
