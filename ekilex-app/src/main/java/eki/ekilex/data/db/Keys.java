...
public class Keys {
    ...
    private static class Identities0 extends AbstractKeys {
        ...
        public static Identity<CollocationPosGroupRecord, Long> IDENTITY_COLLOCATION_POS_GROUP = createIdentity(CollocationPosGroup.COLLOCATION_POS_GROUP, CollocationPosGroup.COLLOCATION_POS_GROUP.ID);
        public static Identity<CollocationRelGroupRecord, Long> IDENTITY_COLLOCATION_REL_GROUP = createIdentity(CollocationRelGroup.COLLOCATION_REL_GROUP, CollocationRelGroup.COLLOCATION_REL_GROUP.ID);
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<CollocationPosGroupRecord> COLLOCATION_POS_GROUP_PKEY = createUniqueKey(CollocationPosGroup.COLLOCATION_POS_GROUP, "collocation_pos_group_pkey", CollocationPosGroup.COLLOCATION_POS_GROUP.ID);
        public static final UniqueKey<CollocationRelGroupRecord> COLLOCATION_REL_GROUP_PKEY = createUniqueKey(CollocationRelGroup.COLLOCATION_REL_GROUP, "collocation_rel_group_pkey", CollocationRelGroup.COLLOCATION_REL_GROUP.ID);
        ...
        public static final UniqueKey<PersonRecord> PERSON_NAME_KEY = createUniqueKey(Person.PERSON, "person_name_key", Person.PERSON.NAME);
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        public static final ForeignKey<CollocationRecord, CollocationRelGroupRecord> COLLOCATION__COLLOCATION_COLLOCATION_REL_GROUP_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.COLLOCATION_REL_GROUP_PKEY, Collocation.COLLOCATION, "collocation__collocation_collocation_rel_group_id_fkey", Collocation.COLLOCATION.COLLOCATION_REL_GROUP_ID);
        public static final ForeignKey<CollocationRecord, LexemeRecord> COLLOCATION__COLLOCATION_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, Collocation.COLLOCATION, "collocation__collocation_lexeme_id_fkey", Collocation.COLLOCATION.LEXEME_ID);
        public static final ForeignKey<CollocationPosGroupRecord, LexemeRecord> COLLOCATION_POS_GROUP__COLLOCATION_POS_GROUP_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, CollocationPosGroup.COLLOCATION_POS_GROUP, "collocation_pos_group__collocation_pos_group_lexeme_id_fkey", CollocationPosGroup.COLLOCATION_POS_GROUP.LEXEME_ID);
        public static final ForeignKey<CollocationRelGroupRecord, CollocationPosGroupRecord> COLLOCATION_REL_GROUP__COLLOCATION_REL_GROUP_COLLOCATION_POS_GROUP_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.COLLOCATION_POS_GROUP_PKEY, CollocationRelGroup.COLLOCATION_REL_GROUP, "collocation_rel_group__collocation_rel_group_collocation_pos_group_id_fkey", CollocationRelGroup.COLLOCATION_REL_GROUP.COLLOCATION_POS_GROUP_ID);
        ...
        public static final ForeignKey<GovernmentTypeLabelRecord, GovernmentTypeRecord> GOVERNMENT_TYPE_LABEL__GOVERNMENT_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.GOVERNMENT_TYPE_PKEY, GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL, "government_type_label__government_type_label_code_fkey", GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL.CODE);
        public static final ForeignKey<GovernmentTypeLabelRecord, LangRecord> GOVERNMENT_TYPE_LABEL__GOVERNMENT_TYPE_LABEL_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL, "government_type_label__government_type_label_lang_fkey", GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL.LANG);
        public static final ForeignKey<GovernmentTypeLabelRecord, LabelTypeRecord> GOVERNMENT_TYPE_LABEL__GOVERNMENT_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL, "government_type_label__government_type_label_type_fkey", GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL.TYPE);
        ...
        public static final ForeignKey<LexemeRecord, DatasetRecord> LEXEME__LEXEME_DATASET_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.DATASET_PKEY, Lexeme.LEXEME, "lexeme__lexeme_dataset_code_fkey", Lexeme.LEXEME.DATASET_CODE);
        public static final ForeignKey<LexemeRecord, LexemeTypeRecord> LEXEME__LEXEME_TYPE_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_TYPE_PKEY, Lexeme.LEXEME, "lexeme__lexeme_type_code_fkey", Lexeme.LEXEME.TYPE_CODE);
        ...
        public static final ForeignKey<LexemePosRecord, ProcessStateRecord> LEXEME_POS__LEXEME_POS_PROCESS_STATE_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.PROCESS_STATE_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_process_state_code_fkey", LexemePos.LEXEME_POS.PROCESS_STATE_CODE);
        ...
        public static final ForeignKey<MeaningRecord, ProcessStateRecord> MEANING__MEANING_PROCESS_STATE_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.PROCESS_STATE_PKEY, Meaning.MEANING, "meaning__meaning_process_state_code_fkey", Meaning.MEANING.PROCESS_STATE_CODE);
        ...
        public static final ForeignKey<MeaningRelTypeLabelRecord, MeaningRelTypeRecord> MEANING_REL_TYPE_LABEL__MEANING_REL_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_REL_TYPE_PKEY, MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL, "meaning_rel_type_label__meaning_rel_type_label_code_fkey", MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<MeaningRelTypeLabelRecord, LangRecord> MEANING_REL_TYPE_LABEL__MEANING_REL_TYPE_LABEL_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL, "meaning_rel_type_label__meaning_rel_type_label_lang_fkey", MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<MeaningRelTypeLabelRecord, LabelTypeRecord> MEANING_REL_TYPE_LABEL__MEANING_REL_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL, "meaning_rel_type_label__meaning_rel_type_label_type_fkey", MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<MeaningRelationRecord, MeaningRecord> MEANING_RELATION__MEANING_RELATION_MEANING1_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_PKEY, MeaningRelation.MEANING_RELATION, "meaning_relation__meaning_relation_meaning1_id_fkey", MeaningRelation.MEANING_RELATION.MEANING1_ID);
        public static final ForeignKey<MeaningRelationRecord, MeaningRecord> MEANING_RELATION__MEANING_RELATION_MEANING2_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_PKEY, MeaningRelation.MEANING_RELATION, "meaning_relation__meaning_relation_meaning2_id_fkey", MeaningRelation.MEANING_RELATION.MEANING2_ID);
        public static final ForeignKey<MeaningRelationRecord, MeaningRelTypeRecord> MEANING_RELATION__MEANING_RELATION_MEANING_REL_TYPE_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_REL_TYPE_PKEY, MeaningRelation.MEANING_RELATION, "meaning_relation__meaning_relation_meaning_rel_type_code_fkey", MeaningRelation.MEANING_RELATION.MEANING_REL_TYPE_CODE);
