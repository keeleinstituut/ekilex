...
public class Keys {
    ...
    public static final UniqueKey<CollocationFreeformRecord> COLLOCATION_FREEFORM_COLLOCATION_ID_FREEFORM_ID_KEY = Internal.createUniqueKey(CollocationFreeform.COLLOCATION_FREEFORM, DSL.name("collocation_freeform_collocation_id_freeform_id_key"), new TableField[] { CollocationFreeform.COLLOCATION_FREEFORM.COLLOCATION_ID, CollocationFreeform.COLLOCATION_FREEFORM.FREEFORM_ID }, true);
    public static final UniqueKey<CollocationFreeformRecord> COLLOCATION_FREEFORM_PKEY = Internal.createUniqueKey(CollocationFreeform.COLLOCATION_FREEFORM, DSL.name("collocation_freeform_pkey"), new TableField[] { CollocationFreeform.COLLOCATION_FREEFORM.ID }, true);
    ...
    public static final ForeignKey<CollocationFreeformRecord, CollocationRecord> COLLOCATION_FREEFORM__COLLOCATION_FREEFORM_COLLOCATION_ID_FKEY = Internal.createForeignKey(CollocationFreeform.COLLOCATION_FREEFORM, DSL.name("collocation_freeform_collocation_id_fkey"), new TableField[] { CollocationFreeform.COLLOCATION_FREEFORM.COLLOCATION_ID }, Keys.COLLOCATION_PKEY, new TableField[] { Collocation.COLLOCATION.ID }, true);
    public static final ForeignKey<CollocationFreeformRecord, FreeformRecord> COLLOCATION_FREEFORM__COLLOCATION_FREEFORM_FREEFORM_ID_FKEY = Internal.createForeignKey(CollocationFreeform.COLLOCATION_FREEFORM, DSL.name("collocation_freeform_freeform_id_fkey"), new TableField[] { CollocationFreeform.COLLOCATION_FREEFORM.FREEFORM_ID }, Keys.FREEFORM_PKEY, new TableField[] { Freeform.FREEFORM.ID }, true);
