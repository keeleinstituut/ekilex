...
public class Keys {
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<LexRelMappingRecord> LEX_REL_MAPPING_CODE1_CODE2_KEY = Internal.createUniqueKey(LexRelMapping.LEX_REL_MAPPING, "lex_rel_mapping_code1_code2_key", LexRelMapping.LEX_REL_MAPPING.CODE1, LexRelMapping.LEX_REL_MAPPING.CODE2);
        ...
        public static final UniqueKey<LexemeProcessLogRecord> LEXEME_PROCESS_LOG_PKEY = Internal.createUniqueKey(LexemeProcessLog.LEXEME_PROCESS_LOG, "lexeme_process_log_pkey", LexemeProcessLog.LEXEME_PROCESS_LOG.ID);
        public static final UniqueKey<LexemeRegionRecord> LEXEME_REGION_PKEY = Internal.createUniqueKey(LexemeRegion.LEXEME_REGION, "lexeme_region_pkey", LexemeRegion.LEXEME_REGION.ID);
        public static final UniqueKey<LexemeRegionRecord> LEXEME_REGION_LEXEME_ID_REGION_CODE_KEY = Internal.createUniqueKey(LexemeRegion.LEXEME_REGION, "lexeme_region_lexeme_id_region_code_key", LexemeRegion.LEXEME_REGION.LEXEME_ID, LexemeRegion.LEXEME_REGION.REGION_CODE);
        ...
        public static final UniqueKey<MeaningProcessLogRecord> MEANING_PROCESS_LOG_PKEY = Internal.createUniqueKey(MeaningProcessLog.MEANING_PROCESS_LOG, "meaning_process_log_pkey", MeaningProcessLog.MEANING_PROCESS_LOG.ID);
        public static final UniqueKey<MeaningRelMappingRecord> MEANING_REL_MAPPING_CODE1_CODE2_KEY = Internal.createUniqueKey(MeaningRelMapping.MEANING_REL_MAPPING, "meaning_rel_mapping_code1_code2_key", MeaningRelMapping.MEANING_REL_MAPPING.CODE1, MeaningRelMapping.MEANING_REL_MAPPING.CODE2);
        ...
        public static final UniqueKey<MeaningSemanticTypeRecord> MEANING_SEMANTIC_TYPE_PKEY = Internal.createUniqueKey(MeaningSemanticType.MEANING_SEMANTIC_TYPE, "meaning_semantic_type_pkey", MeaningSemanticType.MEANING_SEMANTIC_TYPE.ID);
        public static final UniqueKey<MeaningSemanticTypeRecord> MEANING_SEMANTIC_TYPE_MEANING_ID_SEMANTIC_TYPE_CODE_KEY = Internal.createUniqueKey(MeaningSemanticType.MEANING_SEMANTIC_TYPE, "meaning_semantic_type_meaning_id_semantic_type_code_key", MeaningSemanticType.MEANING_SEMANTIC_TYPE.MEANING_ID, MeaningSemanticType.MEANING_SEMANTIC_TYPE.SEMANTIC_TYPE_CODE);
        ...
        public static final UniqueKey<ProcessLogRecord> PROCESS_LOG_PKEY = Internal.createUniqueKey(ProcessLog.PROCESS_LOG, "process_log_pkey", ProcessLog.PROCESS_LOG.ID);
        public static final UniqueKey<ProcessLogSourceLinkRecord> PROCESS_LOG_SOURCE_LINK_PKEY = Internal.createUniqueKey(ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, "process_log_source_link_pkey", ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.ID);
        ...
        public static final UniqueKey<RegionRecord> REGION_PKEY = Internal.createUniqueKey(Region.REGION, "region_pkey", Region.REGION.CODE);
        ...
        public static final UniqueKey<SemanticTypeRecord> SEMANTIC_TYPE_PKEY = Internal.createUniqueKey(SemanticType.SEMANTIC_TYPE, "semantic_type_pkey", SemanticType.SEMANTIC_TYPE.CODE);
        public static final UniqueKey<SemanticTypeLabelRecord> SEMANTIC_TYPE_LABEL_CODE_LANG_TYPE_KEY = Internal.createUniqueKey(SemanticTypeLabel.SEMANTIC_TYPE_LABEL, "semantic_type_label_code_lang_type_key", SemanticTypeLabel.SEMANTIC_TYPE_LABEL.CODE, SemanticTypeLabel.SEMANTIC_TYPE_LABEL.LANG, SemanticTypeLabel.SEMANTIC_TYPE_LABEL.TYPE);
        ...
        public static final UniqueKey<SourceLifecycleLogRecord> SOURCE_LIFECYCLE_LOG_PKEY = Internal.createUniqueKey(SourceLifecycleLog.SOURCE_LIFECYCLE_LOG, "source_lifecycle_log_pkey", SourceLifecycleLog.SOURCE_LIFECYCLE_LOG.ID);
        public static final UniqueKey<TempDsImportPkMapRecord> TEMP_DS_IMPORT_PK_MAP_PKEY = Internal.createUniqueKey(TempDsImportPkMap.TEMP_DS_IMPORT_PK_MAP, "temp_ds_import_pk_map_pkey", TempDsImportPkMap.TEMP_DS_IMPORT_PK_MAP.ID);
        public static final UniqueKey<TempDsImportQueueRecord> TEMP_DS_IMPORT_QUEUE_PKEY = Internal.createUniqueKey(TempDsImportQueue.TEMP_DS_IMPORT_QUEUE, "temp_ds_import_queue_pkey", TempDsImportQueue.TEMP_DS_IMPORT_QUEUE.ID);
        ...
        public static final UniqueKey<WordProcessLogRecord> WORD_PROCESS_LOG_PKEY = Internal.createUniqueKey(WordProcessLog.WORD_PROCESS_LOG, "word_process_log_pkey", WordProcessLog.WORD_PROCESS_LOG.ID);
        public static final UniqueKey<WordRelMappingRecord> WORD_REL_MAPPING_CODE1_CODE2_KEY = Internal.createUniqueKey(WordRelMapping.WORD_REL_MAPPING, "word_rel_mapping_code1_code2_key", WordRelMapping.WORD_REL_MAPPING.CODE1, WordRelMapping.WORD_REL_MAPPING.CODE2);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<LexRelMappingRecord, LexRelTypeRecord> LEX_REL_MAPPING__LEX_REL_MAPPING_CODE1_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LEX_REL_TYPE_PKEY, LexRelMapping.LEX_REL_MAPPING, "lex_rel_mapping__lex_rel_mapping_code1_fkey", LexRelMapping.LEX_REL_MAPPING.CODE1);
        public static final ForeignKey<LexRelMappingRecord, LexRelTypeRecord> LEX_REL_MAPPING__LEX_REL_MAPPING_CODE2_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LEX_REL_TYPE_PKEY, LexRelMapping.LEX_REL_MAPPING, "lex_rel_mapping__lex_rel_mapping_code2_fkey", LexRelMapping.LEX_REL_MAPPING.CODE2);
        ...
        public static final ForeignKey<LexemeProcessLogRecord, LexemeRecord> LEXEME_PROCESS_LOG__LEXEME_PROCESS_LOG_LEXEME_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexemeProcessLog.LEXEME_PROCESS_LOG, "lexeme_process_log__lexeme_process_log_lexeme_id_fkey", LexemeProcessLog.LEXEME_PROCESS_LOG.LEXEME_ID);
        public static final ForeignKey<LexemeProcessLogRecord, ProcessLogRecord> LEXEME_PROCESS_LOG__LEXEME_PROCESS_LOG_PROCESS_LOG_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.PROCESS_LOG_PKEY, LexemeProcessLog.LEXEME_PROCESS_LOG, "lexeme_process_log__lexeme_process_log_process_log_id_fkey", LexemeProcessLog.LEXEME_PROCESS_LOG.PROCESS_LOG_ID);
        public static final ForeignKey<LexemeRegionRecord, LexemeRecord> LEXEME_REGION__LEXEME_REGION_LEXEME_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexemeRegion.LEXEME_REGION, "lexeme_region__lexeme_region_lexeme_id_fkey", LexemeRegion.LEXEME_REGION.LEXEME_ID);
        public static final ForeignKey<LexemeRegionRecord, RegionRecord> LEXEME_REGION__LEXEME_REGION_REGION_CODE_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.REGION_PKEY, LexemeRegion.LEXEME_REGION, "lexeme_region__lexeme_region_region_code_fkey", LexemeRegion.LEXEME_REGION.REGION_CODE);
        ...
        public static final ForeignKey<MeaningProcessLogRecord, MeaningRecord> MEANING_PROCESS_LOG__MEANING_PROCESS_LOG_MEANING_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.MEANING_PKEY, MeaningProcessLog.MEANING_PROCESS_LOG, "meaning_process_log__meaning_process_log_meaning_id_fkey", MeaningProcessLog.MEANING_PROCESS_LOG.MEANING_ID);
        public static final ForeignKey<MeaningProcessLogRecord, ProcessLogRecord> MEANING_PROCESS_LOG__MEANING_PROCESS_LOG_PROCESS_LOG_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.PROCESS_LOG_PKEY, MeaningProcessLog.MEANING_PROCESS_LOG, "meaning_process_log__meaning_process_log_process_log_id_fkey", MeaningProcessLog.MEANING_PROCESS_LOG.PROCESS_LOG_ID);
        public static final ForeignKey<MeaningRelMappingRecord, MeaningRelTypeRecord> MEANING_REL_MAPPING__MEANING_REL_MAPPING_CODE1_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.MEANING_REL_TYPE_PKEY, MeaningRelMapping.MEANING_REL_MAPPING, "meaning_rel_mapping__meaning_rel_mapping_code1_fkey", MeaningRelMapping.MEANING_REL_MAPPING.CODE1);
        public static final ForeignKey<MeaningRelMappingRecord, MeaningRelTypeRecord> MEANING_REL_MAPPING__MEANING_REL_MAPPING_CODE2_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.MEANING_REL_TYPE_PKEY, MeaningRelMapping.MEANING_REL_MAPPING, "meaning_rel_mapping__meaning_rel_mapping_code2_fkey", MeaningRelMapping.MEANING_REL_MAPPING.CODE2);
        ...
        public static final ForeignKey<MeaningSemanticTypeRecord, MeaningRecord> MEANING_SEMANTIC_TYPE__MEANING_SEMANTIC_TYPE_MEANING_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.MEANING_PKEY, MeaningSemanticType.MEANING_SEMANTIC_TYPE, "meaning_semantic_type__meaning_semantic_type_meaning_id_fkey", MeaningSemanticType.MEANING_SEMANTIC_TYPE.MEANING_ID);
        public static final ForeignKey<MeaningSemanticTypeRecord, SemanticTypeRecord> MEANING_SEMANTIC_TYPE__MEANING_SEMANTIC_TYPE_SEMANTIC_TYPE_CODE_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.SEMANTIC_TYPE_PKEY, MeaningSemanticType.MEANING_SEMANTIC_TYPE, "meaning_semantic_type__meaning_semantic_type_semantic_type_code_fkey", MeaningSemanticType.MEANING_SEMANTIC_TYPE.SEMANTIC_TYPE_CODE);
        ...
        public static final ForeignKey<ProcessLogRecord, ProcessStateRecord> PROCESS_LOG__PROCESS_LOG_PROCESS_STATE_CODE_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.PROCESS_STATE_PKEY, ProcessLog.PROCESS_LOG, "process_log__process_log_process_state_code_fkey", ProcessLog.PROCESS_LOG.PROCESS_STATE_CODE);
        public static final ForeignKey<ProcessLogRecord, DatasetRecord> PROCESS_LOG__PROCESS_LOG_DATASET_CODE_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.DATASET_PKEY, ProcessLog.PROCESS_LOG, "process_log__process_log_dataset_code_fkey", ProcessLog.PROCESS_LOG.DATASET_CODE);
        public static final ForeignKey<ProcessLogSourceLinkRecord, ProcessLogRecord> PROCESS_LOG_SOURCE_LINK__PROCESS_LOG_SOURCE_LINK_PROCESS_LOG_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.PROCESS_LOG_PKEY, ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, "process_log_source_link__process_log_source_link_process_log_id_fkey", ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.PROCESS_LOG_ID);
        public static final ForeignKey<ProcessLogSourceLinkRecord, SourceRecord> PROCESS_LOG_SOURCE_LINK__PROCESS_LOG_SOURCE_LINK_SOURCE_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.SOURCE_PKEY, ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, "process_log_source_link__process_log_source_link_source_id_fkey", ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.SOURCE_ID);
        ...
        public static final ForeignKey<SemanticTypeLabelRecord, SemanticTypeRecord> SEMANTIC_TYPE_LABEL__SEMANTIC_TYPE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.SEMANTIC_TYPE_PKEY, SemanticTypeLabel.SEMANTIC_TYPE_LABEL, "semantic_type_label__semantic_type_label_code_fkey", SemanticTypeLabel.SEMANTIC_TYPE_LABEL.CODE);
        public static final ForeignKey<SemanticTypeLabelRecord, LanguageRecord> SEMANTIC_TYPE_LABEL__SEMANTIC_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LANGUAGE_PKEY, SemanticTypeLabel.SEMANTIC_TYPE_LABEL, "semantic_type_label__semantic_type_label_lang_fkey", SemanticTypeLabel.SEMANTIC_TYPE_LABEL.LANG);
        public static final ForeignKey<SemanticTypeLabelRecord, LabelTypeRecord> SEMANTIC_TYPE_LABEL__SEMANTIC_TYPE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, SemanticTypeLabel.SEMANTIC_TYPE_LABEL, "semantic_type_label__semantic_type_label_type_fkey", SemanticTypeLabel.SEMANTIC_TYPE_LABEL.TYPE);
        ...
        public static final ForeignKey<SourceLifecycleLogRecord, SourceRecord> SOURCE_LIFECYCLE_LOG__SOURCE_LIFECYCLE_LOG_SOURCE_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.SOURCE_PKEY, SourceLifecycleLog.SOURCE_LIFECYCLE_LOG, "source_lifecycle_log__source_lifecycle_log_source_id_fkey", SourceLifecycleLog.SOURCE_LIFECYCLE_LOG.SOURCE_ID);
        public static final ForeignKey<SourceLifecycleLogRecord, LifecycleLogRecord> SOURCE_LIFECYCLE_LOG__SOURCE_LIFECYCLE_LOG_LIFECYCLE_LOG_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LIFECYCLE_LOG_PKEY, SourceLifecycleLog.SOURCE_LIFECYCLE_LOG, "source_lifecycle_log__source_lifecycle_log_lifecycle_log_id_fkey", SourceLifecycleLog.SOURCE_LIFECYCLE_LOG.LIFECYCLE_LOG_ID);
        ...
        public static final ForeignKey<WordEtymologyRecord, WordRecord> WORD_ETYMOLOGY__WORD_ETYMOLOGY_WORD_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.WORD_PKEY, WordEtymology.WORD_ETYMOLOGY, "word_etymology__word_etymology_word_id_fkey", WordEtymology.WORD_ETYMOLOGY.WORD_ID);
        ...
        public static final ForeignKey<WordEtymologyRelationRecord, WordEtymologyRecord> WORD_ETYMOLOGY_RELATION__WORD_ETYMOLOGY_RELATION_WORD_ETYM_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.WORD_ETYMOLOGY_PKEY, WordEtymologyRelation.WORD_ETYMOLOGY_RELATION, "word_etymology_relation__word_etymology_relation_word_etym_id_fkey", WordEtymologyRelation.WORD_ETYMOLOGY_RELATION.WORD_ETYM_ID);
        ...
        public static final ForeignKey<WordProcessLogRecord, WordRecord> WORD_PROCESS_LOG__WORD_PROCESS_LOG_WORD_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.WORD_PKEY, WordProcessLog.WORD_PROCESS_LOG, "word_process_log__word_process_log_word_id_fkey", WordProcessLog.WORD_PROCESS_LOG.WORD_ID);
        public static final ForeignKey<WordProcessLogRecord, ProcessLogRecord> WORD_PROCESS_LOG__WORD_PROCESS_LOG_PROCESS_LOG_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.PROCESS_LOG_PKEY, WordProcessLog.WORD_PROCESS_LOG, "word_process_log__word_process_log_process_log_id_fkey", WordProcessLog.WORD_PROCESS_LOG.PROCESS_LOG_ID);
        public static final ForeignKey<WordRelMappingRecord, WordRelTypeRecord> WORD_REL_MAPPING__WORD_REL_MAPPING_CODE1_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.WORD_REL_TYPE_PKEY, WordRelMapping.WORD_REL_MAPPING, "word_rel_mapping__word_rel_mapping_code1_fkey", WordRelMapping.WORD_REL_MAPPING.CODE1);
        public static final ForeignKey<WordRelMappingRecord, WordRelTypeRecord> WORD_REL_MAPPING__WORD_REL_MAPPING_CODE2_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.WORD_REL_TYPE_PKEY, WordRelMapping.WORD_REL_MAPPING, "word_rel_mapping__word_rel_mapping_code2_fkey", WordRelMapping.WORD_REL_MAPPING.CODE2);
        ...
        public static final ForeignKey<WordRelationParamRecord, WordRelationRecord> WORD_RELATION_PARAM__WORD_RELATION_PARAM_WORD_RELATION_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.WORD_RELATION_PKEY, WordRelationParam.WORD_RELATION_PARAM, "word_relation_param__word_relation_param_word_relation_id_fkey", WordRelationParam.WORD_RELATION_PARAM.WORD_RELATION_ID);
