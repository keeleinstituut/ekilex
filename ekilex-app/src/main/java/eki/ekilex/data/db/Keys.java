...
public class Keys {
    ...
    public static final Identity<LexemeProcessLogRecord, Long> IDENTITY_LEXEME_PROCESS_LOG = Identities0.IDENTITY_LEXEME_PROCESS_LOG;
    ...
    public static final Identity<MeaningProcessLogRecord, Long> IDENTITY_MEANING_PROCESS_LOG = Identities0.IDENTITY_MEANING_PROCESS_LOG;
    ...
    public static final Identity<ProcessLogRecord, Long> IDENTITY_PROCESS_LOG = Identities0.IDENTITY_PROCESS_LOG;
    public static final Identity<ProcessLogSourceLinkRecord, Long> IDENTITY_PROCESS_LOG_SOURCE_LINK = Identities0.IDENTITY_PROCESS_LOG_SOURCE_LINK;
    ...
    public static final Identity<WordProcessLogRecord, Long> IDENTITY_WORD_PROCESS_LOG = Identities0.IDENTITY_WORD_PROCESS_LOG;
    ...
    public static final UniqueKey<LexemeProcessLogRecord> LEXEME_PROCESS_LOG_PKEY = UniqueKeys0.LEXEME_PROCESS_LOG_PKEY;
    ...
    public static final UniqueKey<MeaningProcessLogRecord> MEANING_PROCESS_LOG_PKEY = UniqueKeys0.MEANING_PROCESS_LOG_PKEY;
    ...
    public static final UniqueKey<ProcessLogRecord> PROCESS_LOG_PKEY = UniqueKeys0.PROCESS_LOG_PKEY;
    public static final UniqueKey<ProcessLogSourceLinkRecord> PROCESS_LOG_SOURCE_LINK_PKEY = UniqueKeys0.PROCESS_LOG_SOURCE_LINK_PKEY;
    ...
    public static final UniqueKey<WordProcessLogRecord> WORD_PROCESS_LOG_PKEY = UniqueKeys0.WORD_PROCESS_LOG_PKEY;
    ...
    public static final ForeignKey<EkiUserProfileRecord, TagRecord> EKI_USER_PROFILE__EKI_USER_PROFILE_PREFERRED_TAG_NAME_FKEY = ForeignKeys0.EKI_USER_PROFILE__EKI_USER_PROFILE_PREFERRED_TAG_NAME_FKEY;
    ...
    public static final ForeignKey<LexemeProcessLogRecord, LexemeRecord> LEXEME_PROCESS_LOG__LEXEME_PROCESS_LOG_LEXEME_ID_FKEY = ForeignKeys0.LEXEME_PROCESS_LOG__LEXEME_PROCESS_LOG_LEXEME_ID_FKEY;
    public static final ForeignKey<LexemeProcessLogRecord, ProcessLogRecord> LEXEME_PROCESS_LOG__LEXEME_PROCESS_LOG_PROCESS_LOG_ID_FKEY = ForeignKeys0.LEXEME_PROCESS_LOG__LEXEME_PROCESS_LOG_PROCESS_LOG_ID_FKEY;
    ...
    public static final ForeignKey<MeaningProcessLogRecord, MeaningRecord> MEANING_PROCESS_LOG__MEANING_PROCESS_LOG_MEANING_ID_FKEY = ForeignKeys0.MEANING_PROCESS_LOG__MEANING_PROCESS_LOG_MEANING_ID_FKEY;
    public static final ForeignKey<MeaningProcessLogRecord, ProcessLogRecord> MEANING_PROCESS_LOG__MEANING_PROCESS_LOG_PROCESS_LOG_ID_FKEY = ForeignKeys0.MEANING_PROCESS_LOG__MEANING_PROCESS_LOG_PROCESS_LOG_ID_FKEY;
    ...
    public static final ForeignKey<ProcessLogRecord, ProcessStateRecord> PROCESS_LOG__PROCESS_LOG_PROCESS_STATE_CODE_FKEY = ForeignKeys0.PROCESS_LOG__PROCESS_LOG_PROCESS_STATE_CODE_FKEY;
    public static final ForeignKey<ProcessLogRecord, DatasetRecord> PROCESS_LOG__PROCESS_LOG_DATASET_CODE_FKEY = ForeignKeys0.PROCESS_LOG__PROCESS_LOG_DATASET_CODE_FKEY;
    public static final ForeignKey<ProcessLogSourceLinkRecord, ProcessLogRecord> PROCESS_LOG_SOURCE_LINK__PROCESS_LOG_SOURCE_LINK_PROCESS_LOG_ID_FKEY = ForeignKeys0.PROCESS_LOG_SOURCE_LINK__PROCESS_LOG_SOURCE_LINK_PROCESS_LOG_ID_FKEY;
    public static final ForeignKey<ProcessLogSourceLinkRecord, SourceRecord> PROCESS_LOG_SOURCE_LINK__PROCESS_LOG_SOURCE_LINK_SOURCE_ID_FKEY = ForeignKeys0.PROCESS_LOG_SOURCE_LINK__PROCESS_LOG_SOURCE_LINK_SOURCE_ID_FKEY;
    ...
    public static final ForeignKey<SourceLifecycleLogRecord, LifecycleLogRecord> SOURCE_LIFECYCLE_LOG__SOURCE_LIFECYCLE_LOG_LIFECYCLE_LOG_ID_FKEY = ForeignKeys0.SOURCE_LIFECYCLE_LOG__SOURCE_LIFECYCLE_LOG_LIFECYCLE_LOG_ID_FKEY;
    ...
    public static final ForeignKey<WordProcessLogRecord, WordRecord> WORD_PROCESS_LOG__WORD_PROCESS_LOG_WORD_ID_FKEY = ForeignKeys0.WORD_PROCESS_LOG__WORD_PROCESS_LOG_WORD_ID_FKEY;
    public static final ForeignKey<WordProcessLogRecord, ProcessLogRecord> WORD_PROCESS_LOG__WORD_PROCESS_LOG_PROCESS_LOG_ID_FKEY = ForeignKeys0.WORD_PROCESS_LOG__WORD_PROCESS_LOG_PROCESS_LOG_ID_FKEY;
    ...
    private static class Identities0 {
        ...
        public static Identity<LexemeProcessLogRecord, Long> IDENTITY_LEXEME_PROCESS_LOG = Internal.createIdentity(LexemeProcessLog.LEXEME_PROCESS_LOG, LexemeProcessLog.LEXEME_PROCESS_LOG.ID);
        ...
        public static Identity<MeaningProcessLogRecord, Long> IDENTITY_MEANING_PROCESS_LOG = Internal.createIdentity(MeaningProcessLog.MEANING_PROCESS_LOG, MeaningProcessLog.MEANING_PROCESS_LOG.ID);
        ...
        public static Identity<ProcessLogRecord, Long> IDENTITY_PROCESS_LOG = Internal.createIdentity(ProcessLog.PROCESS_LOG, ProcessLog.PROCESS_LOG.ID);
        public static Identity<ProcessLogSourceLinkRecord, Long> IDENTITY_PROCESS_LOG_SOURCE_LINK = Internal.createIdentity(ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.ID);
        ...
        public static Identity<WordProcessLogRecord, Long> IDENTITY_WORD_PROCESS_LOG = Internal.createIdentity(WordProcessLog.WORD_PROCESS_LOG, WordProcessLog.WORD_PROCESS_LOG.ID);
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<FormFrequencyRecord> FORM_FREQUENCY_PKEY = Internal.createUniqueKey(FormFrequency.FORM_FREQUENCY, "form_frequency_pkey", new TableField[] { FormFrequency.FORM_FREQUENCY.ID }, true);
        ...
        public static final UniqueKey<LayerStateRecord> LAYER_STATE_PKEY = Internal.createUniqueKey(LayerState.LAYER_STATE, "layer_state_pkey", new TableField[] { LayerState.LAYER_STATE.ID }, true);
        public static final UniqueKey<LayerStateRecord> LAYER_STATE_LEXEME_ID_LAYER_NAME_KEY = Internal.createUniqueKey(LayerState.LAYER_STATE, "layer_state_lexeme_id_layer_name_key", new TableField[] { LayerState.LAYER_STATE.LEXEME_ID, LayerState.LAYER_STATE.LAYER_NAME }, true);
        ...
        public static final UniqueKey<LexemeFrequencyRecord> LEXEME_FREQUENCY_PKEY = Internal.createUniqueKey(LexemeFrequency.LEXEME_FREQUENCY, "lexeme_frequency_pkey", new TableField[] { LexemeFrequency.LEXEME_FREQUENCY.ID }, true);
        public static final UniqueKey<LexemeFrequencyRecord> LEXEME_FREQUENCY_LEXEME_ID_SOURCE_NAME_KEY = Internal.createUniqueKey(LexemeFrequency.LEXEME_FREQUENCY, "lexeme_frequency_lexeme_id_source_name_key", new TableField[] { LexemeFrequency.LEXEME_FREQUENCY.LEXEME_ID, LexemeFrequency.LEXEME_FREQUENCY.SOURCE_NAME }, true);
        public static final UniqueKey<LexemeLifecycleLogRecord> LEXEME_LIFECYCLE_LOG_PKEY = Internal.createUniqueKey(LexemeLifecycleLog.LEXEME_LIFECYCLE_LOG, "lexeme_lifecycle_log_pkey", new TableField[] { LexemeLifecycleLog.LEXEME_LIFECYCLE_LOG.ID }, true);
        ...
        public static final UniqueKey<LexemeProcessLogRecord> LEXEME_PROCESS_LOG_PKEY = Internal.createUniqueKey(LexemeProcessLog.LEXEME_PROCESS_LOG, "lexeme_process_log_pkey", new TableField[] { LexemeProcessLog.LEXEME_PROCESS_LOG.ID }, true);
        ...
        public static final UniqueKey<MeaningLifecycleLogRecord> MEANING_LIFECYCLE_LOG_PKEY = Internal.createUniqueKey(MeaningLifecycleLog.MEANING_LIFECYCLE_LOG, "meaning_lifecycle_log_pkey", new TableField[] { MeaningLifecycleLog.MEANING_LIFECYCLE_LOG.ID }, true);
        ...
        public static final UniqueKey<MeaningProcessLogRecord> MEANING_PROCESS_LOG_PKEY = Internal.createUniqueKey(MeaningProcessLog.MEANING_PROCESS_LOG, "meaning_process_log_pkey", new TableField[] { MeaningProcessLog.MEANING_PROCESS_LOG.ID }, true);
        ...
        public static final UniqueKey<ProcessLogRecord> PROCESS_LOG_PKEY = Internal.createUniqueKey(ProcessLog.PROCESS_LOG, "process_log_pkey", new TableField[] { ProcessLog.PROCESS_LOG.ID }, true);
        public static final UniqueKey<ProcessLogSourceLinkRecord> PROCESS_LOG_SOURCE_LINK_PKEY = Internal.createUniqueKey(ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, "process_log_source_link_pkey", new TableField[] { ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.ID }, true);
        ...
        public static final UniqueKey<WordLifecycleLogRecord> WORD_LIFECYCLE_LOG_PKEY = Internal.createUniqueKey(WordLifecycleLog.WORD_LIFECYCLE_LOG, "word_lifecycle_log_pkey", new TableField[] { WordLifecycleLog.WORD_LIFECYCLE_LOG.ID }, true);
        public static final UniqueKey<WordProcessLogRecord> WORD_PROCESS_LOG_PKEY = Internal.createUniqueKey(WordProcessLog.WORD_PROCESS_LOG, "word_process_log_pkey", new TableField[] { WordProcessLog.WORD_PROCESS_LOG.ID }, true);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<EkiUserProfileRecord, TagRecord> EKI_USER_PROFILE__EKI_USER_PROFILE_PREFERRED_TAG_NAME_FKEY = Internal.createForeignKey(Keys.TAG_PKEY, EkiUserProfile.EKI_USER_PROFILE, "eki_user_profile_preferred_tag_name_fkey", new TableField[] { EkiUserProfile.EKI_USER_PROFILE.PREFERRED_TAG_NAME }, true);
        ...
        public static final ForeignKey<FormFrequencyRecord, MorphRecord> FORM_FREQUENCY__FORM_FREQUENCY_MORPH_CODE_FKEY = Internal.createForeignKey(Keys.MORPH_PKEY, FormFrequency.FORM_FREQUENCY, "form_frequency_morph_code_fkey", new TableField[] { FormFrequency.FORM_FREQUENCY.MORPH_CODE }, true);
        ...
        public static final ForeignKey<LayerStateRecord, LexemeRecord> LAYER_STATE__LAYER_STATE_LEXEME_ID_FKEY = Internal.createForeignKey(Keys.LEXEME_PKEY, LayerState.LAYER_STATE, "layer_state_lexeme_id_fkey", new TableField[] { LayerState.LAYER_STATE.LEXEME_ID }, true);
        public static final ForeignKey<LayerStateRecord, ProcessStateRecord> LAYER_STATE__LAYER_STATE_PROCESS_STATE_CODE_FKEY = Internal.createForeignKey(Keys.PROCESS_STATE_PKEY, LayerState.LAYER_STATE, "layer_state_process_state_code_fkey", new TableField[] { LayerState.LAYER_STATE.PROCESS_STATE_CODE }, true);
        ...
        public static final ForeignKey<LexemeFrequencyRecord, LexemeRecord> LEXEME_FREQUENCY__LEXEME_FREQUENCY_LEXEME_ID_FKEY = Internal.createForeignKey(Keys.LEXEME_PKEY, LexemeFrequency.LEXEME_FREQUENCY, "lexeme_frequency_lexeme_id_fkey", new TableField[] { LexemeFrequency.LEXEME_FREQUENCY.LEXEME_ID }, true);
        public static final ForeignKey<LexemeLifecycleLogRecord, LexemeRecord> LEXEME_LIFECYCLE_LOG__LEXEME_LIFECYCLE_LOG_LEXEME_ID_FKEY = Internal.createForeignKey(Keys.LEXEME_PKEY, LexemeLifecycleLog.LEXEME_LIFECYCLE_LOG, "lexeme_lifecycle_log_lexeme_id_fkey", new TableField[] { LexemeLifecycleLog.LEXEME_LIFECYCLE_LOG.LEXEME_ID }, true);
        public static final ForeignKey<LexemeLifecycleLogRecord, LifecycleLogRecord> LEXEME_LIFECYCLE_LOG__LEXEME_LIFECYCLE_LOG_LIFECYCLE_LOG_ID_FKEY = Internal.createForeignKey(Keys.LIFECYCLE_LOG_PKEY, LexemeLifecycleLog.LEXEME_LIFECYCLE_LOG, "lexeme_lifecycle_log_lifecycle_log_id_fkey", new TableField[] { LexemeLifecycleLog.LEXEME_LIFECYCLE_LOG.LIFECYCLE_LOG_ID }, true);
        ...
        public static final ForeignKey<LexemeProcessLogRecord, LexemeRecord> LEXEME_PROCESS_LOG__LEXEME_PROCESS_LOG_LEXEME_ID_FKEY = Internal.createForeignKey(Keys.LEXEME_PKEY, LexemeProcessLog.LEXEME_PROCESS_LOG, "lexeme_process_log_lexeme_id_fkey", new TableField[] { LexemeProcessLog.LEXEME_PROCESS_LOG.LEXEME_ID }, true);
        public static final ForeignKey<LexemeProcessLogRecord, ProcessLogRecord> LEXEME_PROCESS_LOG__LEXEME_PROCESS_LOG_PROCESS_LOG_ID_FKEY = Internal.createForeignKey(Keys.PROCESS_LOG_PKEY, LexemeProcessLog.LEXEME_PROCESS_LOG, "lexeme_process_log_process_log_id_fkey", new TableField[] { LexemeProcessLog.LEXEME_PROCESS_LOG.PROCESS_LOG_ID }, true);
        ...
        public static final ForeignKey<MeaningLifecycleLogRecord, MeaningRecord> MEANING_LIFECYCLE_LOG__MEANING_LIFECYCLE_LOG_MEANING_ID_FKEY = Internal.createForeignKey(Keys.MEANING_PKEY, MeaningLifecycleLog.MEANING_LIFECYCLE_LOG, "meaning_lifecycle_log_meaning_id_fkey", new TableField[] { MeaningLifecycleLog.MEANING_LIFECYCLE_LOG.MEANING_ID }, true);
        public static final ForeignKey<MeaningLifecycleLogRecord, LifecycleLogRecord> MEANING_LIFECYCLE_LOG__MEANING_LIFECYCLE_LOG_LIFECYCLE_LOG_ID_FKEY = Internal.createForeignKey(Keys.LIFECYCLE_LOG_PKEY, MeaningLifecycleLog.MEANING_LIFECYCLE_LOG, "meaning_lifecycle_log_lifecycle_log_id_fkey", new TableField[] { MeaningLifecycleLog.MEANING_LIFECYCLE_LOG.LIFECYCLE_LOG_ID }, true);
        ...
        public static final ForeignKey<MeaningProcessLogRecord, MeaningRecord> MEANING_PROCESS_LOG__MEANING_PROCESS_LOG_MEANING_ID_FKEY = Internal.createForeignKey(Keys.MEANING_PKEY, MeaningProcessLog.MEANING_PROCESS_LOG, "meaning_process_log_meaning_id_fkey", new TableField[] { MeaningProcessLog.MEANING_PROCESS_LOG.MEANING_ID }, true);
        public static final ForeignKey<MeaningProcessLogRecord, ProcessLogRecord> MEANING_PROCESS_LOG__MEANING_PROCESS_LOG_PROCESS_LOG_ID_FKEY = Internal.createForeignKey(Keys.PROCESS_LOG_PKEY, MeaningProcessLog.MEANING_PROCESS_LOG, "meaning_process_log_process_log_id_fkey", new TableField[] { MeaningProcessLog.MEANING_PROCESS_LOG.PROCESS_LOG_ID }, true);
        ...
        public static final ForeignKey<ProcessLogRecord, ProcessStateRecord> PROCESS_LOG__PROCESS_LOG_PROCESS_STATE_CODE_FKEY = Internal.createForeignKey(Keys.PROCESS_STATE_PKEY, ProcessLog.PROCESS_LOG, "process_log_process_state_code_fkey", new TableField[] { ProcessLog.PROCESS_LOG.PROCESS_STATE_CODE }, true);
        public static final ForeignKey<ProcessLogRecord, DatasetRecord> PROCESS_LOG__PROCESS_LOG_DATASET_CODE_FKEY = Internal.createForeignKey(Keys.DATASET_PKEY, ProcessLog.PROCESS_LOG, "process_log_dataset_code_fkey", new TableField[] { ProcessLog.PROCESS_LOG.DATASET_CODE }, true);
        public static final ForeignKey<ProcessLogSourceLinkRecord, ProcessLogRecord> PROCESS_LOG_SOURCE_LINK__PROCESS_LOG_SOURCE_LINK_PROCESS_LOG_ID_FKEY = Internal.createForeignKey(Keys.PROCESS_LOG_PKEY, ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, "process_log_source_link_process_log_id_fkey", new TableField[] { ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.PROCESS_LOG_ID }, true);
        public static final ForeignKey<ProcessLogSourceLinkRecord, SourceRecord> PROCESS_LOG_SOURCE_LINK__PROCESS_LOG_SOURCE_LINK_SOURCE_ID_FKEY = Internal.createForeignKey(Keys.SOURCE_PKEY, ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK, "process_log_source_link_source_id_fkey", new TableField[] { ProcessLogSourceLink.PROCESS_LOG_SOURCE_LINK.SOURCE_ID }, true);
        ...
        public static final ForeignKey<SourceLifecycleLogRecord, LifecycleLogRecord> SOURCE_LIFECYCLE_LOG__SOURCE_LIFECYCLE_LOG_LIFECYCLE_LOG_ID_FKEY = Internal.createForeignKey(Keys.LIFECYCLE_LOG_PKEY, SourceLifecycleLog.SOURCE_LIFECYCLE_LOG, "source_lifecycle_log_lifecycle_log_id_fkey", new TableField[] { SourceLifecycleLog.SOURCE_LIFECYCLE_LOG.LIFECYCLE_LOG_ID }, true);
        ...
        public static final ForeignKey<WordLifecycleLogRecord, WordRecord> WORD_LIFECYCLE_LOG__WORD_LIFECYCLE_LOG_WORD_ID_FKEY = Internal.createForeignKey(Keys.WORD_PKEY, WordLifecycleLog.WORD_LIFECYCLE_LOG, "word_lifecycle_log_word_id_fkey", new TableField[] { WordLifecycleLog.WORD_LIFECYCLE_LOG.WORD_ID }, true);
        public static final ForeignKey<WordLifecycleLogRecord, LifecycleLogRecord> WORD_LIFECYCLE_LOG__WORD_LIFECYCLE_LOG_LIFECYCLE_LOG_ID_FKEY = Internal.createForeignKey(Keys.LIFECYCLE_LOG_PKEY, WordLifecycleLog.WORD_LIFECYCLE_LOG, "word_lifecycle_log_lifecycle_log_id_fkey", new TableField[] { WordLifecycleLog.WORD_LIFECYCLE_LOG.LIFECYCLE_LOG_ID }, true);
        public static final ForeignKey<WordProcessLogRecord, WordRecord> WORD_PROCESS_LOG__WORD_PROCESS_LOG_WORD_ID_FKEY = Internal.createForeignKey(Keys.WORD_PKEY, WordProcessLog.WORD_PROCESS_LOG, "word_process_log_word_id_fkey", new TableField[] { WordProcessLog.WORD_PROCESS_LOG.WORD_ID }, true);
        public static final ForeignKey<WordProcessLogRecord, ProcessLogRecord> WORD_PROCESS_LOG__WORD_PROCESS_LOG_PROCESS_LOG_ID_FKEY = Internal.createForeignKey(Keys.PROCESS_LOG_PKEY, WordProcessLog.WORD_PROCESS_LOG, "word_process_log_process_log_id_fkey", new TableField[] { WordProcessLog.WORD_PROCESS_LOG.PROCESS_LOG_ID }, true);
