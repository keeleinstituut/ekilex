...
import eki.ekilex.data.db.tables.records.LexRelationDatasetRecord;
...
public class Keys {
    ...
    public static final UniqueKey<EntryClassRecord> ENTRY_CLASS_PKEY = UniqueKeys0.ENTRY_CLASS_PKEY;
    ...
    public static final UniqueKey<LexemeFrequencyLabelRecord> LEXEME_FREQUENCY_LABEL_CODE_LANG_TYPE_KEY = UniqueKeys0.LEXEME_FREQUENCY_LABEL_CODE_LANG_TYPE_KEY;
    ...
    public static final ForeignKey<LexemeFrequencyLabelRecord, LexemeFrequencyRecord> LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_CODE_FKEY = ForeignKeys0.LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_CODE_FKEY;
    public static final ForeignKey<LexemeFrequencyLabelRecord, LangRecord> LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_LANG_FKEY = ForeignKeys0.LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_LANG_FKEY;
    public static final ForeignKey<LexemeFrequencyLabelRecord, LabelTypeRecord> LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_TYPE_FKEY = ForeignKeys0.LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_TYPE_FKEY;
    ...
    public static final ForeignKey<MeaningRecord, EntryClassRecord> MEANING__MEANING_ENTRY_CLASS_CODE_FKEY = ForeignKeys0.MEANING__MEANING_ENTRY_CLASS_CODE_FKEY;
    ...
    private static class Identities0 extends AbstractKeys {
        ...
        public static Identity<LexemeFreeformRecord, Long> IDENTITY_LEXEME_FREEFORM = createIdentity(LexemeFreeform.LEXEME_FREEFORM, LexemeFreeform.LEXEME_FREEFORM.ID);
        ...
        public static Identity<LifecycleLogRecord, Long> IDENTITY_LIFECYCLE_LOG = createIdentity(LifecycleLog.LIFECYCLE_LOG, LifecycleLog.LIFECYCLE_LOG.ID);
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<EntryClassRecord> ENTRY_CLASS_PKEY = createUniqueKey(EntryClass.ENTRY_CLASS, "entry_class_pkey", EntryClass.ENTRY_CLASS.CODE);
        public static final UniqueKey<FormRecord> FORM_PKEY = createUniqueKey(Form.FORM, "form_pkey", Form.FORM.ID);
        public static final UniqueKey<FormRelTypeRecord> FORM_REL_TYPE_PKEY = createUniqueKey(FormRelType.FORM_REL_TYPE, "form_rel_type_pkey", FormRelType.FORM_REL_TYPE.CODE);
        public static final UniqueKey<FormRelTypeLabelRecord> FORM_REL_TYPE_LABEL_CODE_LANG_TYPE_KEY = createUniqueKey(FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label_code_lang_type_key", FormRelTypeLabel.FORM_REL_TYPE_LABEL.CODE, FormRelTypeLabel.FORM_REL_TYPE_LABEL.LANG, FormRelTypeLabel.FORM_REL_TYPE_LABEL.TYPE);
        ...
        public static final UniqueKey<LexemeFreeformRecord> LEXEME_FREEFORM_LEXEME_ID_FREEFORM_ID_KEY = createUniqueKey(LexemeFreeform.LEXEME_FREEFORM, "lexeme_freeform_lexeme_id_freeform_id_key", LexemeFreeform.LEXEME_FREEFORM.LEXEME_ID, LexemeFreeform.LEXEME_FREEFORM.FREEFORM_ID);
        public static final UniqueKey<LexemeFrequencyRecord> LEXEME_FREQUENCY_PKEY = createUniqueKey(LexemeFrequency.LEXEME_FREQUENCY, "lexeme_frequency_pkey", LexemeFrequency.LEXEME_FREQUENCY.CODE);
        public static final UniqueKey<LexemeFrequencyLabelRecord> LEXEME_FREQUENCY_LABEL_CODE_LANG_TYPE_KEY = createUniqueKey(LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL, "lexeme_frequency_label_code_lang_type_key", LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL.CODE, LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL.LANG, LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL.TYPE);
        ...
        public static final UniqueKey<LifecycleLogRecord> LIFECYCLE_LOG_PKEY = createUniqueKey(LifecycleLog.LIFECYCLE_LOG, "lifecycle_log_pkey", LifecycleLog.LIFECYCLE_LOG.ID);
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        ...
        public static final ForeignKey<DomainLabelRecord, LabelTypeRecord> DOMAIN_LABEL__DOMAIN_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, DomainLabel.DOMAIN_LABEL, "domain_label__domain_label_type_fkey", DomainLabel.DOMAIN_LABEL.TYPE);
        public static final ForeignKey<FormRecord, ParadigmRecord> FORM__FORM_PARADIGM_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.PARADIGM_PKEY, Form.FORM, "form__form_paradigm_id_fkey", Form.FORM.PARADIGM_ID);
        public static final ForeignKey<FormRecord, MorphRecord> FORM__FORM_MORPH_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MORPH_PKEY, Form.FORM, "form__form_morph_code_fkey", Form.FORM.MORPH_CODE);
        public static final ForeignKey<FormRelTypeLabelRecord, FormRelTypeRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.FORM_REL_TYPE_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_code_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<FormRelTypeLabelRecord, LangRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_lang_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<FormRelTypeLabelRecord, LabelTypeRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_type_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<FormRelationRecord, FormRecord> FORM_RELATION__FORM_RELATION_FORM1_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.FORM_PKEY, FormRelation.FORM_RELATION, "form_relation__form_relation_form1_id_fkey", FormRelation.FORM_RELATION.FORM1_ID);
        public static final ForeignKey<FormRelationRecord, FormRecord> FORM_RELATION__FORM_RELATION_FORM2_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.FORM_PKEY, FormRelation.FORM_RELATION, "form_relation__form_relation_form2_id_fkey", FormRelation.FORM_RELATION.FORM2_ID);
        ...
        public static final ForeignKey<GrammarRecord, LexemeRecord> GRAMMAR__GRAMMAR_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, Grammar.GRAMMAR, "grammar__grammar_lexeme_id_fkey", Grammar.GRAMMAR.LEXEME_ID);
        public static final ForeignKey<GrammarRecord, LangRecord> GRAMMAR__GRAMMAR_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, Grammar.GRAMMAR, "grammar__grammar_lang_fkey", Grammar.GRAMMAR.LANG);
        public static final ForeignKey<GrammarDatasetRecord, GrammarRecord> GRAMMAR_DATASET__GRAMMAR_DATASET_GRAMMAR_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.GRAMMAR_PKEY, GrammarDataset.GRAMMAR_DATASET, "grammar_dataset__grammar_dataset_grammar_id_fkey", GrammarDataset.GRAMMAR_DATASET.GRAMMAR_ID);
        public static final ForeignKey<GrammarDatasetRecord, DatasetRecord> GRAMMAR_DATASET__GRAMMAR_DATASET_DATASET_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.DATASET_PKEY, GrammarDataset.GRAMMAR_DATASET, "grammar_dataset__grammar_dataset_dataset_code_fkey", GrammarDataset.GRAMMAR_DATASET.DATASET_CODE);
        public static final ForeignKey<LangLabelRecord, LangRecord> LANG_LABEL__LANG_LABEL_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_code_fkey", LangLabel.LANG_LABEL.CODE);
        public static final ForeignKey<LangLabelRecord, LangRecord> LANG_LABEL__LANG_LABEL_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_lang_fkey", LangLabel.LANG_LABEL.LANG);
        public static final ForeignKey<LangLabelRecord, LabelTypeRecord> LANG_LABEL__LANG_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_type_fkey", LangLabel.LANG_LABEL.TYPE);
        public static final ForeignKey<LexRelTypeLabelRecord, LexRelTypeRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEX_REL_TYPE_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_code_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<LexRelTypeLabelRecord, LangRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_lang_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<LexRelTypeLabelRecord, LabelTypeRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_type_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<LexRelationRecord, LexemeRecord> LEX_RELATION__LEX_RELATION_LEXEME1_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lexeme1_id_fkey", LexRelation.LEX_RELATION.LEXEME1_ID);
        public static final ForeignKey<LexRelationRecord, LexemeRecord> LEX_RELATION__LEX_RELATION_LEXEME2_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lexeme2_id_fkey", LexRelation.LEX_RELATION.LEXEME2_ID);
        public static final ForeignKey<LexRelationRecord, LexRelTypeRecord> LEX_RELATION__LEX_RELATION_LEX_REL_TYPE_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEX_REL_TYPE_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lex_rel_type_code_fkey", LexRelation.LEX_RELATION.LEX_REL_TYPE_CODE);
        public static final ForeignKey<LexRelationDatasetRecord, LexRelationRecord> LEX_RELATION_DATASET__LEX_RELATION_DATASET_LEX_RELATION_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEX_RELATION_PKEY, LexRelationDataset.LEX_RELATION_DATASET, "lex_relation_dataset__lex_relation_dataset_lex_relation_id_fkey", LexRelationDataset.LEX_RELATION_DATASET.LEX_RELATION_ID);
        public static final ForeignKey<LexRelationDatasetRecord, DatasetRecord> LEX_RELATION_DATASET__LEX_RELATION_DATASET_DATASET_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.DATASET_PKEY, LexRelationDataset.LEX_RELATION_DATASET, "lex_relation_dataset__lex_relation_dataset_dataset_code_fkey", LexRelationDataset.LEX_RELATION_DATASET.DATASET_CODE);
        public static final ForeignKey<LexemeRecord, WordRecord> LEXEME__LEXEME_WORD_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.WORD_PKEY, Lexeme.LEXEME, "lexeme__lexeme_word_id_fkey", Lexeme.LEXEME.WORD_ID);
        public static final ForeignKey<LexemeRecord, MeaningRecord> LEXEME__LEXEME_MEANING_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_PKEY, Lexeme.LEXEME, "lexeme__lexeme_meaning_id_fkey", Lexeme.LEXEME.MEANING_ID);
        public static final ForeignKey<LexemeRecord, LexemeTypeRecord> LEXEME__LEXEME_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_TYPE_PKEY, Lexeme.LEXEME, "lexeme__lexeme_type_fkey", Lexeme.LEXEME.TYPE);
        public static final ForeignKey<LexemeRecord, LexemeFrequencyRecord> LEXEME__LEXEME_FREQUENCY_GROUP_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_FREQUENCY_PKEY, Lexeme.LEXEME, "lexeme__lexeme_frequency_group_fkey", Lexeme.LEXEME.FREQUENCY_GROUP);
        public static final ForeignKey<LexemeDatasetRecord, LexemeRecord> LEXEME_DATASET__LEXEME_DATASET_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexemeDataset.LEXEME_DATASET, "lexeme_dataset__lexeme_dataset_lexeme_id_fkey", LexemeDataset.LEXEME_DATASET.LEXEME_ID);
        public static final ForeignKey<LexemeDatasetRecord, DatasetRecord> LEXEME_DATASET__LEXEME_DATASET_DATASET_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.DATASET_PKEY, LexemeDataset.LEXEME_DATASET, "lexeme_dataset__lexeme_dataset_dataset_code_fkey", LexemeDataset.LEXEME_DATASET.DATASET_CODE);
        public static final ForeignKey<LexemeDerivRecord, LexemeRecord> LEXEME_DERIV__LEXEME_DERIV_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexemeDeriv.LEXEME_DERIV, "lexeme_deriv__lexeme_deriv_lexeme_id_fkey", LexemeDeriv.LEXEME_DERIV.LEXEME_ID);
        public static final ForeignKey<LexemeDerivRecord, DerivRecord> LEXEME_DERIV__LEXEME_DERIV_DERIV_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.DERIV_PKEY, LexemeDeriv.LEXEME_DERIV, "lexeme_deriv__lexeme_deriv_deriv_code_fkey", LexemeDeriv.LEXEME_DERIV.DERIV_CODE);
        public static final ForeignKey<LexemeFreeformRecord, LexemeRecord> LEXEME_FREEFORM__LEXEME_FREEFORM_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexemeFreeform.LEXEME_FREEFORM, "lexeme_freeform__lexeme_freeform_lexeme_id_fkey", LexemeFreeform.LEXEME_FREEFORM.LEXEME_ID);
        public static final ForeignKey<LexemeFreeformRecord, FreeformRecord> LEXEME_FREEFORM__LEXEME_FREEFORM_FREEFORM_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.FREEFORM_PKEY, LexemeFreeform.LEXEME_FREEFORM, "lexeme_freeform__lexeme_freeform_freeform_id_fkey", LexemeFreeform.LEXEME_FREEFORM.FREEFORM_ID);
        public static final ForeignKey<LexemeFrequencyLabelRecord, LexemeFrequencyRecord> LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_FREQUENCY_PKEY, LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL, "lexeme_frequency_label__lexeme_frequency_label_code_fkey", LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL.CODE);
        public static final ForeignKey<LexemeFrequencyLabelRecord, LangRecord> LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL, "lexeme_frequency_label__lexeme_frequency_label_lang_fkey", LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL.LANG);
        public static final ForeignKey<LexemeFrequencyLabelRecord, LabelTypeRecord> LEXEME_FREQUENCY_LABEL__LEXEME_FREQUENCY_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL, "lexeme_frequency_label__lexeme_frequency_label_type_fkey", LexemeFrequencyLabel.LEXEME_FREQUENCY_LABEL.TYPE);
        public static final ForeignKey<LexemePosRecord, LexemeRecord> LEXEME_POS__LEXEME_POS_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_lexeme_id_fkey", LexemePos.LEXEME_POS.LEXEME_ID);
        public static final ForeignKey<LexemePosRecord, PosRecord> LEXEME_POS__LEXEME_POS_POS_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.POS_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_pos_code_fkey", LexemePos.LEXEME_POS.POS_CODE);
        public static final ForeignKey<LexemeRegisterRecord, LexemeRecord> LEXEME_REGISTER__LEXEME_REGISTER_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexemeRegister.LEXEME_REGISTER, "lexeme_register__lexeme_register_lexeme_id_fkey", LexemeRegister.LEXEME_REGISTER.LEXEME_ID);
        public static final ForeignKey<LexemeRegisterRecord, RegisterRecord> LEXEME_REGISTER__LEXEME_REGISTER_REGISTER_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.REGISTER_PKEY, LexemeRegister.LEXEME_REGISTER, "lexeme_register__lexeme_register_register_code_fkey", LexemeRegister.LEXEME_REGISTER.REGISTER_CODE);
        public static final ForeignKey<LexemeTypeLabelRecord, LexemeTypeRecord> LEXEME_TYPE_LABEL__LEXEME_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_TYPE_PKEY, LexemeTypeLabel.LEXEME_TYPE_LABEL, "lexeme_type_label__lexeme_type_label_code_fkey", LexemeTypeLabel.LEXEME_TYPE_LABEL.CODE);
        public static final ForeignKey<LexemeTypeLabelRecord, LangRecord> LEXEME_TYPE_LABEL__LEXEME_TYPE_LABEL_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, LexemeTypeLabel.LEXEME_TYPE_LABEL, "lexeme_type_label__lexeme_type_label_lang_fkey", LexemeTypeLabel.LEXEME_TYPE_LABEL.LANG);
        public static final ForeignKey<LexemeTypeLabelRecord, LabelTypeRecord> LEXEME_TYPE_LABEL__LEXEME_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, LexemeTypeLabel.LEXEME_TYPE_LABEL, "lexeme_type_label__lexeme_type_label_type_fkey", LexemeTypeLabel.LEXEME_TYPE_LABEL.TYPE);
        public static final ForeignKey<MeaningRecord, EntryClassRecord> MEANING__MEANING_ENTRY_CLASS_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.ENTRY_CLASS_PKEY, Meaning.MEANING, "meaning__meaning_entry_class_code_fkey", Meaning.MEANING.ENTRY_CLASS_CODE);
        public static final ForeignKey<MeaningRecord, MeaningStateRecord> MEANING__MEANING_STATE_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_STATE_PKEY, Meaning.MEANING, "meaning__meaning_state_code_fkey", Meaning.MEANING.STATE_CODE);
        public static final ForeignKey<MeaningRecord, MeaningTypeRecord> MEANING__MEANING_TYPE_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_TYPE_PKEY, Meaning.MEANING, "meaning__meaning_type_code_fkey", Meaning.MEANING.TYPE_CODE);
        public static final ForeignKey<MeaningDatasetRecord, MeaningRecord> MEANING_DATASET__MEANING_DATASET_MEANING_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_PKEY, MeaningDataset.MEANING_DATASET, "meaning_dataset__meaning_dataset_meaning_id_fkey", MeaningDataset.MEANING_DATASET.MEANING_ID);
        public static final ForeignKey<MeaningDatasetRecord, DatasetRecord> MEANING_DATASET__MEANING_DATASET_DATASET_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.DATASET_PKEY, MeaningDataset.MEANING_DATASET, "meaning_dataset__meaning_dataset_dataset_code_fkey", MeaningDataset.MEANING_DATASET.DATASET_CODE);
        public static final ForeignKey<MeaningDomainRecord, MeaningRecord> MEANING_DOMAIN__MEANING_DOMAIN_MEANING_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_PKEY, MeaningDomain.MEANING_DOMAIN, "meaning_domain__meaning_domain_meaning_id_fkey", MeaningDomain.MEANING_DOMAIN.MEANING_ID);
        public static final ForeignKey<MeaningDomainRecord, DomainRecord> MEANING_DOMAIN__MEANING_DOMAIN_DOMAIN_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.DOMAIN_PKEY, MeaningDomain.MEANING_DOMAIN, "meaning_domain__meaning_domain_domain_code_fkey", MeaningDomain.MEANING_DOMAIN.DOMAIN_CODE, MeaningDomain.MEANING_DOMAIN.DOMAIN_ORIGIN);
        public static final ForeignKey<MeaningFreeformRecord, MeaningRecord> MEANING_FREEFORM__MEANING_FREEFORM_MEANING_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MEANING_PKEY, MeaningFreeform.MEANING_FREEFORM, "meaning_freeform__meaning_freeform_meaning_id_fkey", MeaningFreeform.MEANING_FREEFORM.MEANING_ID);
        public static final ForeignKey<MeaningFreeformRecord, FreeformRecord> MEANING_FREEFORM__MEANING_FREEFORM_FREEFORM_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.FREEFORM_PKEY, MeaningFreeform.MEANING_FREEFORM, "meaning_freeform__meaning_freeform_freeform_id_fkey", MeaningFreeform.MEANING_FREEFORM.FREEFORM_ID);
        public static final ForeignKey<MorphLabelRecord, MorphRecord> MORPH_LABEL__MORPH_LABEL_CODE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.MORPH_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_code_fkey", MorphLabel.MORPH_LABEL.CODE);
        public static final ForeignKey<MorphLabelRecord, LangRecord> MORPH_LABEL__MORPH_LABEL_LANG_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_lang_fkey", MorphLabel.MORPH_LABEL.LANG);
        public static final ForeignKey<MorphLabelRecord, LabelTypeRecord> MORPH_LABEL__MORPH_LABEL_TYPE_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LABEL_TYPE_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_type_fkey", MorphLabel.MORPH_LABEL.TYPE);
        public static final ForeignKey<ParadigmRecord, WordRecord> PARADIGM__PARADIGM_WORD_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.WORD_PKEY, Paradigm.PARADIGM, "paradigm__paradigm_word_id_fkey", Paradigm.PARADIGM.WORD_ID);
        ...
        public static final ForeignKey<RectionRecord, LexemeRecord> RECTION__RECTION_LEXEME_ID_FKEY = createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, Rection.RECTION, "rection__rection_lexeme_id_fkey", Rection.RECTION.LEXEME_ID);
