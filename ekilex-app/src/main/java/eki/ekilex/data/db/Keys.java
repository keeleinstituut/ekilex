...
public class Keys {
    ...
    public static final Identity<LexemeGroupRecord, Long> IDENTITY_LEXEME_GROUP = Identities0.IDENTITY_LEXEME_GROUP;
    public static final Identity<LexemeGroupMemberRecord, Long> IDENTITY_LEXEME_GROUP_MEMBER = Identities0.IDENTITY_LEXEME_GROUP_MEMBER;
    ...
    public static final UniqueKey<LexemeGroupRecord> LEXEME_GROUP_PKEY = UniqueKeys0.LEXEME_GROUP_PKEY;
    public static final UniqueKey<LexemeGroupMemberRecord> LEXEME_GROUP_MEMBER_PKEY = UniqueKeys0.LEXEME_GROUP_MEMBER_PKEY;
    public static final UniqueKey<LexemeGroupMemberRecord> LEXEME_GROUP_MEMBER_LEXEME_GROUP_ID_LEXEME_ID_KEY = UniqueKeys0.LEXEME_GROUP_MEMBER_LEXEME_GROUP_ID_LEXEME_ID_KEY;
    ...
    public static final ForeignKey<LexemeGroupRecord, LexRelTypeRecord> LEXEME_GROUP__LEXEME_GROUP_LEX_REL_TYPE_CODE_FKEY = ForeignKeys0.LEXEME_GROUP__LEXEME_GROUP_LEX_REL_TYPE_CODE_FKEY;
    public static final ForeignKey<LexemeGroupMemberRecord, LexemeGroupRecord> LEXEME_GROUP_MEMBER__LEXEME_GROUP_MEMBER_LEXEME_GROUP_ID_FKEY = ForeignKeys0.LEXEME_GROUP_MEMBER__LEXEME_GROUP_MEMBER_LEXEME_GROUP_ID_FKEY;
    public static final ForeignKey<LexemeGroupMemberRecord, LexemeRecord> LEXEME_GROUP_MEMBER__LEXEME_GROUP_MEMBER_LEXEME_ID_FKEY = ForeignKeys0.LEXEME_GROUP_MEMBER__LEXEME_GROUP_MEMBER_LEXEME_ID_FKEY;
    ...
    public static final ForeignKey<PosGroupLabelRecord, LangRecord> POS_GROUP_LABEL__POS_GROUP_LABEL_LANG_FKEY = ForeignKeys0.POS_GROUP_LABEL__POS_GROUP_LABEL_LANG_FKEY;
    ...
    public static final ForeignKey<ValueStateLabelRecord, LangRecord> VALUE_STATE_LABEL__VALUE_STATE_LABEL_LANG_FKEY = ForeignKeys0.VALUE_STATE_LABEL__VALUE_STATE_LABEL_LANG_FKEY;
    ...
    public static final ForeignKey<WordTypeLabelRecord, LangRecord> WORD_TYPE_LABEL__WORD_TYPE_LABEL_LANG_FKEY = ForeignKeys0.WORD_TYPE_LABEL__WORD_TYPE_LABEL_LANG_FKEY;
    ...
    private static class Identities0 {
        ...
        public static Identity<LexemeGroupRecord, Long> IDENTITY_LEXEME_GROUP = Internal.createIdentity(LexemeGroup.LEXEME_GROUP, LexemeGroup.LEXEME_GROUP.ID);
        public static Identity<LexemeGroupMemberRecord, Long> IDENTITY_LEXEME_GROUP_MEMBER = Internal.createIdentity(LexemeGroupMember.LEXEME_GROUP_MEMBER, LexemeGroupMember.LEXEME_GROUP_MEMBER.ID);
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<LexemeGroupRecord> LEXEME_GROUP_PKEY = Internal.createUniqueKey(LexemeGroup.LEXEME_GROUP, "lexeme_group_pkey", LexemeGroup.LEXEME_GROUP.ID);
        public static final UniqueKey<LexemeGroupMemberRecord> LEXEME_GROUP_MEMBER_PKEY = Internal.createUniqueKey(LexemeGroupMember.LEXEME_GROUP_MEMBER, "lexeme_group_member_pkey", LexemeGroupMember.LEXEME_GROUP_MEMBER.ID);
        public static final UniqueKey<LexemeGroupMemberRecord> LEXEME_GROUP_MEMBER_LEXEME_GROUP_ID_LEXEME_ID_KEY = Internal.createUniqueKey(LexemeGroupMember.LEXEME_GROUP_MEMBER, "lexeme_group_member_lexeme_group_id_lexeme_id_key", LexemeGroupMember.LEXEME_GROUP_MEMBER.LEXEME_GROUP_ID, LexemeGroupMember.LEXEME_GROUP_MEMBER.LEXEME_ID);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<LexemeGroupRecord, LexRelTypeRecord> LEXEME_GROUP__LEXEME_GROUP_LEX_REL_TYPE_CODE_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LEX_REL_TYPE_PKEY, LexemeGroup.LEXEME_GROUP, "lexeme_group__lexeme_group_lex_rel_type_code_fkey", LexemeGroup.LEXEME_GROUP.LEX_REL_TYPE_CODE);
        public static final ForeignKey<LexemeGroupMemberRecord, LexemeGroupRecord> LEXEME_GROUP_MEMBER__LEXEME_GROUP_MEMBER_LEXEME_GROUP_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LEXEME_GROUP_PKEY, LexemeGroupMember.LEXEME_GROUP_MEMBER, "lexeme_group_member__lexeme_group_member_lexeme_group_id_fkey", LexemeGroupMember.LEXEME_GROUP_MEMBER.LEXEME_GROUP_ID);
        public static final ForeignKey<LexemeGroupMemberRecord, LexemeRecord> LEXEME_GROUP_MEMBER__LEXEME_GROUP_MEMBER_LEXEME_ID_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LEXEME_PKEY, LexemeGroupMember.LEXEME_GROUP_MEMBER, "lexeme_group_member__lexeme_group_member_lexeme_id_fkey", LexemeGroupMember.LEXEME_GROUP_MEMBER.LEXEME_ID);
        ...
        public static final ForeignKey<PosGroupLabelRecord, LangRecord> POS_GROUP_LABEL__POS_GROUP_LABEL_LANG_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, PosGroupLabel.POS_GROUP_LABEL, "pos_group_label__pos_group_label_lang_fkey", PosGroupLabel.POS_GROUP_LABEL.LANG);
        ...
        public static final ForeignKey<ValueStateLabelRecord, LangRecord> VALUE_STATE_LABEL__VALUE_STATE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, ValueStateLabel.VALUE_STATE_LABEL, "value_state_label__value_state_label_lang_fkey", ValueStateLabel.VALUE_STATE_LABEL.LANG);
        ...
        public static final ForeignKey<WordTypeLabelRecord, LangRecord> WORD_TYPE_LABEL__WORD_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.ekilex.data.db.Keys.LANG_PKEY, WordTypeLabel.WORD_TYPE_LABEL, "word_type_label__word_type_label_lang_fkey", WordTypeLabel.WORD_TYPE_LABEL.LANG);
