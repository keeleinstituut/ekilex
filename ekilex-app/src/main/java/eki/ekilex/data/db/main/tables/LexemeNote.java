...
public class LexemeNote extends TableImpl<LexemeNoteRecord> {
     ...
     */
    public final TableField<LexemeNoteRecord, LocalDateTime> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.LOCALDATETIME(6), this, "");
     ...
     */
    public final TableField<LexemeNoteRecord, LocalDateTime> MODIFIED_ON = createField(DSL.name("modified_on"), SQLDataType.LOCALDATETIME(6), this, "");
