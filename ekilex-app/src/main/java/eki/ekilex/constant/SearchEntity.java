...
public enum SearchEntity {
	...
	HEADWORD(new SearchKey[] {
			...
			SearchKey.LEXEME_REGISTER, SearchKey.LEXEME_VALUE_STATE, SearchKey.COMPLEXITY, SearchKey.OD_RECOMMENDATION, SearchKey.WORD_NOTE, SearchKey.LEXEME_NOTE,
			SearchKey.CREATED_OR_UPDATED_BY, SearchKey.UPDATED_ON, SearchKey.CREATED_ON, SearchKey.LAST_UPDATE_ON, SearchKey.FREQUENCY, SearchKey.RANK, SearchKey.WORD_RELATION}),
	WORD(new SearchKey[] {
			SearchKey.VALUE, SearchKey.ID, SearchKey.LANGUAGE, SearchKey.WORD_TYPE, SearchKey.ASPECT, SearchKey.SOURCE_REF, SearchKey.SOURCE_NAME,
	...
	TERM(new SearchKey[] {
			SearchKey.VALUE, SearchKey.ID, SearchKey.LANGUAGE, SearchKey.WORD_TYPE, SearchKey.LEXEME_REGISTER, SearchKey.LEXEME_VALUE_STATE, SearchKey.WORD_NOTE, SearchKey.LEXEME_NOTE,
