...
public enum SearchEntity {
	...
	HEADWORD(new SearchKey[] {
			...
			SearchKey.LEXEME_REGISTER, SearchKey.LEXEME_VALUE_STATE, SearchKey.COMPLEXITY, SearchKey.OD_RECOMMENDATION, SearchKey.CREATED_OR_UPDATED_BY,
			SearchKey.UPDATED_ON, SearchKey.CREATED_ON, SearchKey.LAST_UPDATE_ON, SearchKey.FREQUENCY, SearchKey.RANK, SearchKey.WORD_RELATION}),
	WORD(new SearchKey[] {
			SearchKey.VALUE, SearchKey.ID, SearchKey.LANGUAGE, SearchKey.WORD_TYPE, SearchKey.ASPECT, SearchKey.SOURCE_REF, SearchKey.SOURCE_NAME,
	...
	TERM(new SearchKey[] {
			SearchKey.VALUE, SearchKey.ID, SearchKey.LANGUAGE, SearchKey.WORD_TYPE, SearchKey.LEXEME_REGISTER, SearchKey.LEXEME_VALUE_STATE,
			SearchKey.SOURCE_REF, SearchKey.SOURCE_NAME, SearchKey.PUBLICITY, SearchKey.WORD_RELATION, SearchKey.CREATED_OR_UPDATED_BY, SearchKey.UPDATED_ON}),
	...
	USAGE(new SearchKey[] {
			SearchKey.VALUE_AND_EXISTS, SearchKey.LANGUAGE, SearchKey.PUBLICITY, SearchKey.COMPLEXITY, SearchKey.SOURCE_REF, SearchKey.SOURCE_NAME}),
	MEANING(new SearchKey[] {SearchKey.DOMAIN, SearchKey.ID, SearchKey.MEANING_RELATION, SearchKey.SEMANTIC_TYPE}),
	CONCEPT(new SearchKey[] {
			SearchKey.DOMAIN, SearchKey.ID, SearchKey.ATTRIBUTE_NAME, SearchKey.ATTRIBUTE_VALUE, SearchKey.MEANING_RELATION,
