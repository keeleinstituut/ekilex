...
function handleSearchOperandChange(searchOperand) {
	...
	const selectTypeSearchKeys = [
		...
		"PUBLISHING_TARGET", "PUBLISHING_GRAMMAR", "PUBLISHING_GOVERNMENT", "PUBLISHING_MEANING_MEDIA", "PUBLISHING_LEXEME",
		"WORD_TYPE", "DISPLAY_MORPH", "REG_YEAR", "ASPECT", "SEMANTIC_TYPE", "ATTRIBUTE_NAME", "WORD_RELATION", "MEANING_RELATION"
	];
