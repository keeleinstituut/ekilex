...
public interface GlobalConstant {
	...
	String WORD_REL_TYPE_CODE_DERIVATIVE = "deriv";

	String WORD_REL_TYPE_CODE_DERIVATIVE_BASE = "deriv_base";

	String WORD_REL_TYPE_CODE_COMPARATIVE = "komp";

	String WORD_REL_TYPE_CODE_SUPERLATIVE = "superl";

	String WORD_REL_TYPE_CODE_POSITIVE = "posit";
	...
	String[] OS_TITLE_1_WORD_REL_TYPE_CODES = new String[] {
			WORD_REL_TYPE_CODE_WPRECOMP,
			WORD_REL_TYPE_CODE_WPOSTCOMP};

	String[] OS_TITLE_2_WORD_REL_TYPE_CODES = new String[] {
			WORD_REL_TYPE_CODE_DERIVATIVE};

	String[] OS_TITLE_3_WORD_REL_TYPE_CODES = new String[] {
			WORD_REL_TYPE_CODE_COMPARATIVE,
			WORD_REL_TYPE_CODE_SUPERLATIVE,
			WORD_REL_TYPE_CODE_POSITIVE};

	String[] OS_WORD_RELATION_TYPE_CODES = new String[] {
			WORD_REL_TYPE_CODE_WPRECOMP,
			WORD_REL_TYPE_CODE_WPOSTCOMP,
			WORD_REL_TYPE_CODE_DERIVATIVE,
			WORD_REL_TYPE_CODE_COMPARATIVE,
