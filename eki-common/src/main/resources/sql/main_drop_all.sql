...
drop table if exists word_etym_group_member;
drop table if exists word_etym_group_tree;
drop table if exists word_etym_group;
drop table if exists word_etym_source_link;
drop table if exists word_etym_note;
drop table if exists word_etym_comment;
drop table if exists word_etym;
