...
insert into word (id, value, value_prese, lang, morph_code, homonym_nr) values (1001, 'hall', 'hall', 'est', 'SgN', 1);
insert into word (id, value, value_prese, lang, morph_code, homonym_nr) values (1002, 'hall', 'hall', 'est', 'SgN', 2);
insert into word (id, value, value_prese, lang, morph_code) values (1003, 'hallakord', 'hallakord', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1004, 'hallaudu', 'hallaudu', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1005, 'hallaöö', 'hallaöö', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1006, 'hallasääsk', 'hallasääsk', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1007, 'kaubahall', 'kaubahall', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1008, 'linnahall', 'linnahall', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1009, 'helehall', 'helehall', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1010, 'tumehall', 'tumehall', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1011, 'hiirhall', 'hiirhall', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1012, 'hiirjas', 'hiirjas', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1013, 'hiirukas', 'hiirukas', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1014, 'väär', 'väär', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1015, 'väär', 'väär', 'est', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1016, 'заморозки', 'заморозки', 'rus', 'PlN');
insert into word (id, value, value_prese, lang, morph_code) values (1017, 'серый', 'серый', 'rus', 'SgN');
insert into word (id, value, value_prese, lang, morph_code) values (1018, 'холл', 'холл', 'rus', 'SgN');
...
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4001, 1001, 2001, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4002, 1002, 2002, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4003, 1002, 2003, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4004, 1001, 2004, 'ss_', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4005, 1002, 2005, 'ss_', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4006, 1002, 2006, 'ss_', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4007, 1002, 2007, 'ss_', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4008, 1002, 2008, 'ss_', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4009, 1002, 2009, 'ss_', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4010, 1002, 2010, 'ss_', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4011, 1002, 2011, 'ss_', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4012, 1001, 2012, 'sys', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4013, 1002, 2013, 'sys', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4014, 1001, 2014, 'evs', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4015, 1002, 2015, 'evs', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4016, 1002, 2016, 'evs', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4017, 1003, 2017, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4018, 1004, 2018, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4019, 1005, 2019, 'qq2', 'PRIMARY', false, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4020, 1006, 2020, 'qq2', 'PRIMARY', false, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4021, 1007, 2021, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4022, 1008, 2022, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4023, 1009, 2023, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4024, 1010, 2024, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4025, 1011, 2025, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4026, 1012, 2025, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4027, 1013, 2025, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4028, 1014, 2026, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4029, 1015, 2027, 'qq2', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4031, 1016, 2014, 'evs', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4032, 1017, 2015, 'evs', 'PRIMARY', true, 'DEFAULT');
insert into lexeme (id, word_id, meaning_id, dataset_code, type, is_public, complexity) values (4033, 1018, 2016, 'evs', 'PRIMARY', true, 'DEFAULT');
