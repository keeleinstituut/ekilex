...
insert into definition (id, meaning_id, value, value_prese, lang) values (1001, 2001, 'külmunud kaste maas', 'külmunud kaste maas', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1002, 2002, 'avar üldkasutatav hoone v ruum', 'avar üldkasutatav hoone v ruum', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1003, 2002, 'suur esinduslik ruum elamus, kodasaal', 'suur esinduslik ruum elamus, kodasaal', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1004, 2004, 'temperatuuri langemisel alla 0 °C õhus olevast veeaurust tekkinud ebaühtlane jääkristallide kiht maapinnal, taimedel ja esemetel (hrl. kevadel ja sügisel)', 'temperatuuri langemisel alla 0 °C õhus olevast veeaurust tekkinud ebaühtlane jääkristallide kiht maapinnal, taimedel ja esemetel (hrl. kevadel ja sügisel)', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1005, 2005, 'värvuselt musta ja valge vahepealne', 'värvuselt musta ja valge vahepealne', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1006, 2006, 'valge ja pimeda vahepealne, hämar; sombune', 'valge ja pimeda vahepealne, hämar; sombune', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1007, 2007, 'kaugesse minevikku ulatuv, ajaloo hämarusse kaduv', 'kaugesse minevikku ulatuv, ajaloo hämarusse kaduv', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1008, 2008, 'üksluine, ühetooniline, vaheldusetu, tuim, igav', 'üksluine, ühetooniline, vaheldusetu, tuim, igav', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1009, 2009, 'see, kes v. mis on hall (1. täh.)', 'see, kes v. mis on hall (1. täh.)', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1010, 2010, 'kodasaal, elamu suurem siseruum; suur köetav esik (esimesel korrusel)', 'kodasaal, elamu suurem siseruum; suur köetav esik (esimesel korrusel)', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1011, 2011, 'rohkearvulisele publikule mõeldud suur saal v. hoone; suur tootmisruum v. hoone', 'rohkearvulisele publikule mõeldud suur saal v. hoone; suur tootmisruum v. hoone', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1012, 2016, 'suur esik; saal; tootmishoone', 'suur esik; saal; tootmishoone', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1013, 2021, 'suur selvekauplus, kus peale toiduainete müüakse ka muid igapäevakaupu', 'suur selvekauplus, kus peale toiduainete müüakse ka muid igapäevakaupu', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1014, 2025, 'hiirekarva hall', 'hiirekarva hall', 'est');
insert into definition (id, meaning_id, value, value_prese, lang) values (1015, 2026, 'rõdu, eriti kirikus', 'rõdu, eriti kirikus', 'est');
