...
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1001, 2001, 'määramata', 'külmunud kaste maas', 'külmunud kaste maas', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1002, 2002, 'määramata', 'avar üldkasutatav hoone v ruum', 'avar üldkasutatav hoone v ruum', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1003, 2002, 'määramata', 'suur esinduslik ruum elamus, kodasaal', 'suur esinduslik ruum elamus, kodasaal', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1004, 2004, 'määramata', 'temperatuuri langemisel alla 0 °C õhus olevast veeaurust tekkinud ebaühtlane jääkristallide kiht maapinnal, taimedel ja esemetel (hrl. kevadel ja sügisel)', 'temperatuuri langemisel alla 0 °C õhus olevast veeaurust tekkinud ebaühtlane jääkristallide kiht maapinnal, taimedel ja esemetel (hrl. kevadel ja sügisel)', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1005, 2005, 'määramata', 'värvuselt musta ja valge vahepealne', 'värvuselt musta ja valge vahepealne', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1006, 2006, 'määramata', 'valge ja pimeda vahepealne, hämar; sombune', 'valge ja pimeda vahepealne, hämar; sombune', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1007, 2007, 'määramata', 'kaugesse minevikku ulatuv, ajaloo hämarusse kaduv', 'kaugesse minevikku ulatuv, ajaloo hämarusse kaduv', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1008, 2008, 'määramata', 'üksluine, ühetooniline, vaheldusetu, tuim, igav', 'üksluine, ühetooniline, vaheldusetu, tuim, igav', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1009, 2009, 'määramata', 'see, kes v. mis on hall (1. täh.)', 'see, kes v. mis on hall (1. täh.)', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1010, 2010, 'määramata', 'kodasaal, elamu suurem siseruum; suur köetav esik (esimesel korrusel)', 'kodasaal, elamu suurem siseruum; suur köetav esik (esimesel korrusel)', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1011, 2011, 'määramata', 'rohkearvulisele publikule mõeldud suur saal v. hoone; suur tootmisruum v. hoone', 'rohkearvulisele publikule mõeldud suur saal v. hoone; suur tootmisruum v. hoone', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1012, 2016, 'määramata', 'suur esik; saal; tootmishoone', 'suur esik; saal; tootmishoone', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1013, 2021, 'määramata', 'suur selvekauplus, kus peale toiduainete müüakse ka muid igapäevakaupu', 'suur selvekauplus, kus peale toiduainete müüakse ka muid igapäevakaupu', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1014, 2025, 'määramata', 'hiirekarva hall', 'hiirekarva hall', 'est');
insert into definition (id, meaning_id, definition_type_code, value, value_prese, lang) values (1015, 2026, 'määramata', 'rõdu, eriti kirikus', 'rõdu, eriti kirikus', 'est');
...
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4001, 1001, 2001, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4002, 1002, 2002, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4003, 1002, 2003, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4004, 1001, 2004, 'ss_', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4005, 1002, 2005, 'ss_', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4006, 1002, 2006, 'ss_', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4007, 1002, 2007, 'ss_', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4008, 1002, 2008, 'ss_', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4009, 1002, 2009, 'ss_', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4010, 1002, 2010, 'ss_', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4011, 1002, 2011, 'ss_', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4012, 1001, 2012, 'sys', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4013, 1002, 2013, 'sys', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4014, 1001, 2014, 'evs', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4015, 1002, 2015, 'evs', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4016, 1002, 2016, 'evs', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4017, 1003, 2017, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4018, 1004, 2018, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4019, 1005, 2019, 'qq2', true, false, false);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4020, 1006, 2020, 'qq2', true, false, false);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4021, 1007, 2021, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4022, 1008, 2022, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4023, 1009, 2023, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4024, 1010, 2024, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4025, 1011, 2025, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4026, 1012, 2025, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4027, 1013, 2025, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4028, 1014, 2026, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4029, 1015, 2027, 'qq2', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4031, 1016, 2014, 'evs', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4032, 1017, 2015, 'evs', true, false, true);
insert into lexeme (id, word_id, meaning_id, dataset_code, is_word, is_collocation, is_public) values (4033, 1018, 2016, 'evs', true, false, true);

insert into usage (id, lexeme_id, value, value_prese, lang, is_public) values (1003, 4001, 'Hommikul oli hall maas', 'Hommikul oli hall maas', 'est', true);
insert into usage (id, lexeme_id, value, value_prese, lang, is_public) values (1004, 4001, 'Haned lähevad, hallad taga', 'Haned lähevad, hallad taga', 'est', true);
...
insert into freeform (id, parent_id, freeform_type_code, value, lang) values (1001, null, 'CONCEPT_ID', '123456', null);
insert into freeform (id, parent_id, freeform_type_code, value, lang) values (1002, null, 'GOVERNMENT', 'keda mida', 'est');
