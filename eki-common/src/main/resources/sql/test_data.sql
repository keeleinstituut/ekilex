...
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1001, 'WORD', 'SgN', true, 'hall', '{hall}', 'hall');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1001, 'FORM', 'SgG', true, 'halla', '{hall}', 'halla');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1001, 'FORM', 'SgP', true, 'halla', '{hall}', 'h`alla');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1001, 'FORM', 'Neg', false, '-', null, null);
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1002, 'WORD', 'SgN', true, 'hall', '{hall}', 'hall');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1002, 'FORM', 'SgG', true, 'halli', '{hall}', 'halli');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1002, 'FORM', 'SgP', true, 'halli', '{hall}', 'h`alli');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1002, 'FORM', 'Neg', false, '-', null, null);
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1003, 'WORD', 'SgN', true, 'hallakord', '{halla, kord}', 'halla+k`ord');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1004, 'WORD', 'SgN', true, 'hallaudu', '{halla, udu}', 'halla+udu');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1005, 'WORD', 'SgN', true, 'hallaöö', '{halla, öö}', 'halla+`öö');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1006, 'WORD', 'SgN', true, 'hallasääsk', '{halla, sääsk}', 'halla+s`ääsk');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1007, 'WORD', 'SgN', true, 'kaubahall', '{kauba, hall}', 'kauba+h`al''l');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1008, 'WORD', 'SgN', true, 'linnahall', '{linna, hall}', 'linna+h`al''l');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1009, 'WORD', 'SgN', true, 'helehall', '{hele, hall}', 'hele+h`al''l');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1010, 'WORD', 'SgN', true, 'tumehall', '{tume, hall}', 'tume+h`al''l');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1011, 'WORD', 'SgN', true, 'hiirhall', '{hiir, hall}', 'h`iir+h`al''l');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1012, 'WORD', 'SgN', true, 'hiirjas', '{hiirjas}', 'h`iirjas');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1013, 'WORD', 'SgN', true, 'hiirukas', '{hiirukas}', 'hiirukas');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1014, 'WORD', 'SgN', true, 'väär', '{väär}', 'v`äär');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1014, 'FORM', 'SgG', true, 'vääri', '{väär}', 'vääri');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1014, 'FORM', 'SgP', true, 'vääri', '{väär}', 'v`ääri');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1015, 'WORD', 'SgN', true, 'väär', '{väär}', 'v`äär');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1015, 'FORM', 'SgG', true, 'väära', '{väär}', 'väära');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1015, 'FORM', 'SgP', true, 'väära', '{väär}', 'v`äära');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1016, 'WORD', 'SgN', true, 'väär', '{väär}', 'v`äär');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1016, 'FORM', 'SgG', true, 'väära', '{väär}', 'v`äära');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1016, 'FORM', 'SgP', true, 'väärat', '{väär}', 'v`äärat');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1017, 'WORD', 'PlN', true, 'заморозки', '{заморозки}', 'заморозки');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1018, 'WORD', 'SgN', true, 'серый', '{серый}', 'серый');
insert into form (paradigm_id, mode, morph_code, morph_exists, value, components, display_form) values (1019, 'WORD', 'SgN', true, 'холл', '{холл}', 'холл');
