...
create index word_etymology_word_id_idx on word_etymology(word_id);
...
create index word_etymology_source_link_word_etym_id_idx on word_etymology_source_link(word_etym_id);
...
create index feedback_log_word_value_idx on feedback_log(word_value);
create index feedback_log_word_value_lower_idx on feedback_log(lower(word_value));
