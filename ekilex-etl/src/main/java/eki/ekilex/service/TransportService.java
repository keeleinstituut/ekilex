...
public class TransportService extends AbstractLoaderCommons implements InitializingBean {
	...
	public void initialise() throws Exception {
		...
		String[] importTableNamesArr = new String[] {
				...
				WORD_GROUP_MEMBER, WORD_GROUP, WORD_LIFECYCLE_LOG, WORD_FREEFORM,
				MEANING, MEANING_FREEFORM, MEANING_NR, MEANING_DOMAIN, MEANING_RELATION, MEANING_LIFECYCLE_LOG,
				LEXEME, LEXEME_FREEFORM, LEXEME_POS, LEXEME_DERIV, LEXEME_REGISTER, LEXEME_REGION, LEXEME_FREQUENCY, LEXEME_RELATION,
				LEXEME_SOURCE_LINK, LEXEME_TAG, LEXEME_LIFECYCLE_LOG, LEX_COLLOC, LEX_COLLOC_POS_GROUP, LEX_COLLOC_REL_GROUP,
				DEFINITION, DEFINITION_FREEFORM, DEFINITION_SOURCE_LINK, DEFINITION_DATASET,
				COLLOCATION, PARADIGM, FORM, FORM_FREQUENCY,
				LIFECYCLE_LOG, FREEFORM_SOURCE_LINK};
