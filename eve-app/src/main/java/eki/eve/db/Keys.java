...
import eki.eve.db.tables.records.DatasetRecord;
import eki.eve.db.tables.records.DefinitionRecord;
...
import eki.eve.db.tables.records.EkiUserRecord;
import eki.eve.db.tables.records.FormRecord;
...
import eki.eve.db.tables.records.LangRecord;
...
import eki.eve.db.tables.records.LexemeDomainRecord;
import eki.eve.db.tables.records.LexemePosRecord;
import eki.eve.db.tables.records.LexemeRecord;
import eki.eve.db.tables.records.LexemeRegisterRecord;
import eki.eve.db.tables.records.MeaningRecord;
import eki.eve.db.tables.records.MorphLabelRecord;
import eki.eve.db.tables.records.MorphRecord;
import eki.eve.db.tables.records.ParadigmRecord;
import eki.eve.db.tables.records.PosLabelRecord;
import eki.eve.db.tables.records.PosRecord;
import eki.eve.db.tables.records.RectionRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        ...
        public static final ForeignKey<DomainRecord, DomainRecord> DOMAIN__DOMAIN_PARENT_CODE_FKEY = createForeignKey(eki.eve.db.Keys.DOMAIN_PKEY, Domain.DOMAIN, "domain__domain_parent_code_fkey", Domain.DOMAIN.PARENT_CODE, Domain.DOMAIN.PARENT_ORIGIN);
        public static final ForeignKey<DomainLabelRecord, DomainRecord> DOMAIN_LABEL__DOMAIN_LABEL_CODE_FKEY = createForeignKey(eki.eve.db.Keys.DOMAIN_PKEY, DomainLabel.DOMAIN_LABEL, "domain_label__domain_label_code_fkey", DomainLabel.DOMAIN_LABEL.CODE, DomainLabel.DOMAIN_LABEL.ORIGIN);
        public static final ForeignKey<DomainLabelRecord, LangRecord> DOMAIN_LABEL__DOMAIN_LABEL_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, DomainLabel.DOMAIN_LABEL, "domain_label__domain_label_lang_fkey", DomainLabel.DOMAIN_LABEL.LANG);
        public static final ForeignKey<DomainLabelRecord, LabelTypeRecord> DOMAIN_LABEL__DOMAIN_LABEL_TYPE_FKEY = createForeignKey(eki.eve.db.Keys.LABEL_TYPE_PKEY, DomainLabel.DOMAIN_LABEL, "domain_label__domain_label_type_fkey", DomainLabel.DOMAIN_LABEL.TYPE);
        public static final ForeignKey<FormRecord, ParadigmRecord> FORM__FORM_PARADIGM_ID_FKEY = createForeignKey(eki.eve.db.Keys.PARADIGM_PKEY, Form.FORM, "form__form_paradigm_id_fkey", Form.FORM.PARADIGM_ID);
        public static final ForeignKey<FormRecord, MorphRecord> FORM__FORM_MORPH_CODE_FKEY = createForeignKey(eki.eve.db.Keys.MORPH_PKEY, Form.FORM, "form__form_morph_code_fkey", Form.FORM.MORPH_CODE);
        public static final ForeignKey<GenderLabelRecord, GenderRecord> GENDER_LABEL__GENDER_LABEL_CODE_FKEY = createForeignKey(eki.eve.db.Keys.GENDER_PKEY, GenderLabel.GENDER_LABEL, "gender_label__gender_label_code_fkey", GenderLabel.GENDER_LABEL.CODE);
        public static final ForeignKey<GenderLabelRecord, LangRecord> GENDER_LABEL__GENDER_LABEL_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, GenderLabel.GENDER_LABEL, "gender_label__gender_label_lang_fkey", GenderLabel.GENDER_LABEL.LANG);
        public static final ForeignKey<GenderLabelRecord, LabelTypeRecord> GENDER_LABEL__GENDER_LABEL_TYPE_FKEY = createForeignKey(eki.eve.db.Keys.LABEL_TYPE_PKEY, GenderLabel.GENDER_LABEL, "gender_label__gender_label_type_fkey", GenderLabel.GENDER_LABEL.TYPE);
        public static final ForeignKey<GrammarRecord, LexemeRecord> GRAMMAR__GRAMMAR_LEXEME_ID_FKEY = createForeignKey(eki.eve.db.Keys.LEXEME_PKEY, Grammar.GRAMMAR, "grammar__grammar_lexeme_id_fkey", Grammar.GRAMMAR.LEXEME_ID);
        public static final ForeignKey<GrammarRecord, LangRecord> GRAMMAR__GRAMMAR_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, Grammar.GRAMMAR, "grammar__grammar_lang_fkey", Grammar.GRAMMAR.LANG);
        public static final ForeignKey<LangLabelRecord, LangRecord> LANG_LABEL__LANG_LABEL_CODE_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_code_fkey", LangLabel.LANG_LABEL.CODE);
        public static final ForeignKey<LangLabelRecord, LangRecord> LANG_LABEL__LANG_LABEL_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_lang_fkey", LangLabel.LANG_LABEL.LANG);
        public static final ForeignKey<LangLabelRecord, LabelTypeRecord> LANG_LABEL__LANG_LABEL_TYPE_FKEY = createForeignKey(eki.eve.db.Keys.LABEL_TYPE_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_type_fkey", LangLabel.LANG_LABEL.TYPE);
        public static final ForeignKey<LexRelTypeLabelRecord, LexRelTypeRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.eve.db.Keys.LEX_REL_TYPE_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_code_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<LexRelTypeLabelRecord, LangRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_lang_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<LexRelTypeLabelRecord, LabelTypeRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.eve.db.Keys.LABEL_TYPE_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_type_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<LexRelationRecord, LexemeRecord> LEX_RELATION__LEX_RELATION_LEXEME1_ID_FKEY = createForeignKey(eki.eve.db.Keys.LEXEME_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lexeme1_id_fkey", LexRelation.LEX_RELATION.LEXEME1_ID);
        public static final ForeignKey<LexRelationRecord, LexemeRecord> LEX_RELATION__LEX_RELATION_LEXEME2_ID_FKEY = createForeignKey(eki.eve.db.Keys.LEXEME_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lexeme2_id_fkey", LexRelation.LEX_RELATION.LEXEME2_ID);
        public static final ForeignKey<LexRelationRecord, LexRelTypeRecord> LEX_RELATION__LEX_RELATION_LEX_REL_TYPE_CODE_FKEY = createForeignKey(eki.eve.db.Keys.LEX_REL_TYPE_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lex_rel_type_code_fkey", LexRelation.LEX_RELATION.LEX_REL_TYPE_CODE);
        public static final ForeignKey<LexemeRecord, WordRecord> LEXEME__LEXEME_WORD_ID_FKEY = createForeignKey(eki.eve.db.Keys.WORD_PKEY, Lexeme.LEXEME, "lexeme__lexeme_word_id_fkey", Lexeme.LEXEME.WORD_ID);
        public static final ForeignKey<LexemeRecord, MeaningRecord> LEXEME__LEXEME_MEANING_ID_FKEY = createForeignKey(eki.eve.db.Keys.MEANING_PKEY, Lexeme.LEXEME, "lexeme__lexeme_meaning_id_fkey", Lexeme.LEXEME.MEANING_ID);
        public static final ForeignKey<LexemeDerivRecord, LexemeRecord> LEXEME_DERIV__LEXEME_DERIV_LEXEME_ID_FKEY = createForeignKey(eki.eve.db.Keys.LEXEME_PKEY, LexemeDeriv.LEXEME_DERIV, "lexeme_deriv__lexeme_deriv_lexeme_id_fkey", LexemeDeriv.LEXEME_DERIV.LEXEME_ID);
        public static final ForeignKey<LexemeDerivRecord, DerivRecord> LEXEME_DERIV__LEXEME_DERIV_DERIV_CODE_FKEY = createForeignKey(eki.eve.db.Keys.DERIV_PKEY, LexemeDeriv.LEXEME_DERIV, "lexeme_deriv__lexeme_deriv_deriv_code_fkey", LexemeDeriv.LEXEME_DERIV.DERIV_CODE);
        public static final ForeignKey<LexemeDomainRecord, LexemeRecord> LEXEME_DOMAIN__LEXEME_DOMAIN_LEXEME_ID_FKEY = createForeignKey(eki.eve.db.Keys.LEXEME_PKEY, LexemeDomain.LEXEME_DOMAIN, "lexeme_domain__lexeme_domain_lexeme_id_fkey", LexemeDomain.LEXEME_DOMAIN.LEXEME_ID);
        public static final ForeignKey<LexemeDomainRecord, DomainRecord> LEXEME_DOMAIN__LEXEME_DOMAIN_DOMAIN_CODE_FKEY = createForeignKey(eki.eve.db.Keys.DOMAIN_PKEY, LexemeDomain.LEXEME_DOMAIN, "lexeme_domain__lexeme_domain_domain_code_fkey", LexemeDomain.LEXEME_DOMAIN.DOMAIN_CODE, LexemeDomain.LEXEME_DOMAIN.DOMAIN_ORIGIN);
        public static final ForeignKey<LexemePosRecord, LexemeRecord> LEXEME_POS__LEXEME_POS_LEXEME_ID_FKEY = createForeignKey(eki.eve.db.Keys.LEXEME_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_lexeme_id_fkey", LexemePos.LEXEME_POS.LEXEME_ID);
        public static final ForeignKey<LexemePosRecord, PosRecord> LEXEME_POS__LEXEME_POS_POS_CODE_FKEY = createForeignKey(eki.eve.db.Keys.POS_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_pos_code_fkey", LexemePos.LEXEME_POS.POS_CODE);
        public static final ForeignKey<LexemeRegisterRecord, LexemeRecord> LEXEME_REGISTER__LEXEME_REGISTER_LEXEME_ID_FKEY = createForeignKey(eki.eve.db.Keys.LEXEME_PKEY, LexemeRegister.LEXEME_REGISTER, "lexeme_register__lexeme_register_lexeme_id_fkey", LexemeRegister.LEXEME_REGISTER.LEXEME_ID);
        public static final ForeignKey<LexemeRegisterRecord, RegisterRecord> LEXEME_REGISTER__LEXEME_REGISTER_REGISTER_CODE_FKEY = createForeignKey(eki.eve.db.Keys.REGISTER_PKEY, LexemeRegister.LEXEME_REGISTER, "lexeme_register__lexeme_register_register_code_fkey", LexemeRegister.LEXEME_REGISTER.REGISTER_CODE);
        public static final ForeignKey<MorphLabelRecord, MorphRecord> MORPH_LABEL__MORPH_LABEL_CODE_FKEY = createForeignKey(eki.eve.db.Keys.MORPH_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_code_fkey", MorphLabel.MORPH_LABEL.CODE);
        public static final ForeignKey<MorphLabelRecord, LangRecord> MORPH_LABEL__MORPH_LABEL_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_lang_fkey", MorphLabel.MORPH_LABEL.LANG);
        public static final ForeignKey<MorphLabelRecord, LabelTypeRecord> MORPH_LABEL__MORPH_LABEL_TYPE_FKEY = createForeignKey(eki.eve.db.Keys.LABEL_TYPE_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_type_fkey", MorphLabel.MORPH_LABEL.TYPE);
        public static final ForeignKey<ParadigmRecord, WordRecord> PARADIGM__PARADIGM_WORD_ID_FKEY = createForeignKey(eki.eve.db.Keys.WORD_PKEY, Paradigm.PARADIGM, "paradigm__paradigm_word_id_fkey", Paradigm.PARADIGM.WORD_ID);
        public static final ForeignKey<PosLabelRecord, PosRecord> POS_LABEL__POS_LABEL_CODE_FKEY = createForeignKey(eki.eve.db.Keys.POS_PKEY, PosLabel.POS_LABEL, "pos_label__pos_label_code_fkey", PosLabel.POS_LABEL.CODE);
        public static final ForeignKey<PosLabelRecord, LangRecord> POS_LABEL__POS_LABEL_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, PosLabel.POS_LABEL, "pos_label__pos_label_lang_fkey", PosLabel.POS_LABEL.LANG);
        public static final ForeignKey<PosLabelRecord, LabelTypeRecord> POS_LABEL__POS_LABEL_TYPE_FKEY = createForeignKey(eki.eve.db.Keys.LABEL_TYPE_PKEY, PosLabel.POS_LABEL, "pos_label__pos_label_type_fkey", PosLabel.POS_LABEL.TYPE);
        public static final ForeignKey<RectionRecord, LexemeRecord> RECTION__RECTION_LEXEME_ID_FKEY = createForeignKey(eki.eve.db.Keys.LEXEME_PKEY, Rection.RECTION, "rection__rection_lexeme_id_fkey", Rection.RECTION.LEXEME_ID);
        public static final ForeignKey<RegisterLabelRecord, RegisterRecord> REGISTER_LABEL__REGISTER_LABEL_CODE_FKEY = createForeignKey(eki.eve.db.Keys.REGISTER_PKEY, RegisterLabel.REGISTER_LABEL, "register_label__register_label_code_fkey", RegisterLabel.REGISTER_LABEL.CODE);
        public static final ForeignKey<RegisterLabelRecord, LangRecord> REGISTER_LABEL__REGISTER_LABEL_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, RegisterLabel.REGISTER_LABEL, "register_label__register_label_lang_fkey", RegisterLabel.REGISTER_LABEL.LANG);
        public static final ForeignKey<RegisterLabelRecord, LabelTypeRecord> REGISTER_LABEL__REGISTER_LABEL_TYPE_FKEY = createForeignKey(eki.eve.db.Keys.LABEL_TYPE_PKEY, RegisterLabel.REGISTER_LABEL, "register_label__register_label_type_fkey", RegisterLabel.REGISTER_LABEL.TYPE);
        public static final ForeignKey<UsageRecord, RectionRecord> USAGE__USAGE_RECTION_ID_FKEY = createForeignKey(eki.eve.db.Keys.RECTION_PKEY, Usage.USAGE, "usage__usage_rection_id_fkey", Usage.USAGE.RECTION_ID);
        public static final ForeignKey<WordRecord, LangRecord> WORD__WORD_LANG_FKEY = createForeignKey(eki.eve.db.Keys.LANG_PKEY, Word.WORD, "word__word_lang_fkey", Word.WORD.LANG);
        public static final ForeignKey<WordRecord, MorphRecord> WORD__WORD_MORPH_CODE_FKEY = createForeignKey(eki.eve.db.Keys.MORPH_PKEY, Word.WORD, "word__word_morph_code_fkey", Word.WORD.MORPH_CODE);
    }
}
