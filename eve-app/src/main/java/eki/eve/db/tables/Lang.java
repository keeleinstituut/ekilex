...
public class Lang extends TableImpl<LangRecord> {
    ...
    private static final long serialVersionUID = -1823915782;
     ...
     */
    public final TableField<LangRecord, String> CODE = createField("code", org.jooq.impl.SQLDataType.CHAR.length(3).nullable(false), this, "");
    ...
    private Lang(String alias, Table<LangRecord> aliased) {
        this(alias, aliased, null);
    }

    private Lang(String alias, Table<LangRecord> aliased, Field<?>[] parameters) {
