...
public class Form extends TableImpl<FormRecord> {
     ...
     */
    public final TableField<FormRecord, String> MORPH_CODE = createField("morph_code", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false), this, "");
     ...
     */
    public final TableField<FormRecord, String> DISPLAY_FORM = createField("display_form", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>public.form.vocal_form</code>.
     */
    public final TableField<FormRecord, String> VOCAL_FORM = createField("vocal_form", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
