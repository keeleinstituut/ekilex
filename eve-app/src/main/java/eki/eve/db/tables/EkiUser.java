...
public class EkiUser extends TableImpl<EkiUserRecord> {
     ...
     */
    public final TableField<EkiUserRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>public.eki_user.password</code>.
     */
    public final TableField<EkiUserRecord, String> PASSWORD = createField("password", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
    ...
    private EkiUser(String alias, Table<EkiUserRecord> aliased) {
        this(alias, aliased, null);
    }

    private EkiUser(String alias, Table<EkiUserRecord> aliased, Field<?>[] parameters) {
