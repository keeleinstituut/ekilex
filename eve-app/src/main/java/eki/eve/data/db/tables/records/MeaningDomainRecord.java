...
public class MeaningDomainRecord extends UpdatableRecordImpl<MeaningDomainRecord> implements Record4<Long, Long, String, String> {

    private static final long serialVersionUID = -1092167394;
     ...
     */
    @Override
    public MeaningDomainRecord values(Long value1, Long value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MeaningDomainRecord(Long id, Long meaningId, String domainCode, String domainOrigin) {
        super(MeaningDomain.MEANING_DOMAIN);
