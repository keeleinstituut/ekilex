...
public class DefinitionRefLink extends TableImpl<DefinitionRefLinkRecord> {
    ...
    private static final long serialVersionUID = -1923133918;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.DEFINITION_REF_LINK_FREEFORM_ID_IDX, Indexes.DEFINITION_REF_LINK_PKEY);
    }
