...
import eki.eve.data.db.tables.records.ViewWwMeaningRelationRecord;
...
public class ViewWwMeaningRelation extends TableImpl<ViewWwMeaningRelationRecord> {
    ...
    private static final long serialVersionUID = 339110578;
     ...
     */
    public final TableField<ViewWwMeaningRelationRecord, TypeMeaningRelationRecord[]> RELATED_MEANINGS = createField("related_meanings", eki.eve.data.db.udt.TypeMeaningRelation.TYPE_MEANING_RELATION.getDataType().getArrayDataType(), this, "");
