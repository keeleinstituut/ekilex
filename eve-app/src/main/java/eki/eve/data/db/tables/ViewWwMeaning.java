...
import eki.eve.data.db.tables.records.ViewWwMeaningRecord;
...
public class ViewWwMeaning extends TableImpl<ViewWwMeaningRecord> {
    ...
    private static final long serialVersionUID = 1489301852;
     ...
     */
    public final TableField<ViewWwMeaningRecord, TypeDomainRecord[]> DOMAIN_CODES = createField("domain_codes", eki.eve.data.db.udt.TypeDomain.TYPE_DOMAIN.getDataType().getArrayDataType(), this, "");
