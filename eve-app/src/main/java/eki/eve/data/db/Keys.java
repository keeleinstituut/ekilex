...
public class Keys {
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        public static final ForeignKey<CollocationRecord, CollocationRelGroupRecord> COLLOCATION__COLLOCATION_COLLOCATION_REL_GROUP_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.COLLOCATION_REL_GROUP_PKEY, Collocation.COLLOCATION, "collocation__collocation_collocation_rel_group_id_fkey", Collocation.COLLOCATION.COLLOCATION_REL_GROUP_ID);
        public static final ForeignKey<CollocationRecord, LexemeRecord> COLLOCATION__COLLOCATION_LEXEME_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, Collocation.COLLOCATION, "collocation__collocation_lexeme_id_fkey", Collocation.COLLOCATION.LEXEME_ID);
        public static final ForeignKey<CollocationPosGroupRecord, LexemeRecord> COLLOCATION_POS_GROUP__COLLOCATION_POS_GROUP_LEXEME_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, CollocationPosGroup.COLLOCATION_POS_GROUP, "collocation_pos_group__collocation_pos_group_lexeme_id_fkey", CollocationPosGroup.COLLOCATION_POS_GROUP.LEXEME_ID);
        public static final ForeignKey<CollocationRelGroupRecord, CollocationPosGroupRecord> COLLOCATION_REL_GROUP__COLLOCATION_REL_GROUP_COLLOCATION_POS_GROUP_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.COLLOCATION_POS_GROUP_PKEY, CollocationRelGroup.COLLOCATION_REL_GROUP, "collocation_rel_group__collocation_rel_group_collocation_pos_group_id_fkey", CollocationRelGroup.COLLOCATION_REL_GROUP.COLLOCATION_POS_GROUP_ID);
        ...
        public static final ForeignKey<DefinitionFreeformRecord, DefinitionRecord> DEFINITION_FREEFORM__DEFINITION_FREEFORM_DEFINITION_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.DEFINITION_PKEY, DefinitionFreeform.DEFINITION_FREEFORM, "definition_freeform__definition_freeform_definition_id_fkey", DefinitionFreeform.DEFINITION_FREEFORM.DEFINITION_ID);
        public static final ForeignKey<DefinitionFreeformRecord, FreeformRecord> DEFINITION_FREEFORM__DEFINITION_FREEFORM_FREEFORM_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, DefinitionFreeform.DEFINITION_FREEFORM, "definition_freeform__definition_freeform_freeform_id_fkey", DefinitionFreeform.DEFINITION_FREEFORM.FREEFORM_ID);
        public static final ForeignKey<DefinitionRefLinkRecord, DefinitionRecord> DEFINITION_REF_LINK__DEFINITION_REF_LINK_DEFINITION_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.DEFINITION_PKEY, DefinitionRefLink.DEFINITION_REF_LINK, "definition_ref_link__definition_ref_link_definition_id_fkey", DefinitionRefLink.DEFINITION_REF_LINK.DEFINITION_ID);
        ...
        public static final ForeignKey<DisplayMorphLabelRecord, DisplayMorphRecord> DISPLAY_MORPH_LABEL__DISPLAY_MORPH_LABEL_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.DISPLAY_MORPH_PKEY, DisplayMorphLabel.DISPLAY_MORPH_LABEL, "display_morph_label__display_morph_label_code_fkey", DisplayMorphLabel.DISPLAY_MORPH_LABEL.CODE);
        public static final ForeignKey<DisplayMorphLabelRecord, LangRecord> DISPLAY_MORPH_LABEL__DISPLAY_MORPH_LABEL_LANG_FKEY = createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, DisplayMorphLabel.DISPLAY_MORPH_LABEL, "display_morph_label__display_morph_label_lang_fkey", DisplayMorphLabel.DISPLAY_MORPH_LABEL.LANG);
        public static final ForeignKey<DisplayMorphLabelRecord, LabelTypeRecord> DISPLAY_MORPH_LABEL__DISPLAY_MORPH_LABEL_TYPE_FKEY = createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, DisplayMorphLabel.DISPLAY_MORPH_LABEL, "display_morph_label__display_morph_label_type_fkey", DisplayMorphLabel.DISPLAY_MORPH_LABEL.TYPE);
        ...
        public static final ForeignKey<FormRelTypeLabelRecord, FormRelTypeRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.FORM_REL_TYPE_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_code_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<FormRelTypeLabelRecord, LangRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_LANG_FKEY = createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_lang_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<FormRelTypeLabelRecord, LabelTypeRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_type_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<FormRelationRecord, FormRecord> FORM_RELATION__FORM_RELATION_FORM1_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.FORM_PKEY, FormRelation.FORM_RELATION, "form_relation__form_relation_form1_id_fkey", FormRelation.FORM_RELATION.FORM1_ID);
        public static final ForeignKey<FormRelationRecord, FormRecord> FORM_RELATION__FORM_RELATION_FORM2_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.FORM_PKEY, FormRelation.FORM_RELATION, "form_relation__form_relation_form2_id_fkey", FormRelation.FORM_RELATION.FORM2_ID);
        public static final ForeignKey<FormRelationRecord, FormRelTypeRecord> FORM_RELATION__FORM_RELATION_FORM_REL_TYPE_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.FORM_REL_TYPE_PKEY, FormRelation.FORM_RELATION, "form_relation__form_relation_form_rel_type_code_fkey", FormRelation.FORM_RELATION.FORM_REL_TYPE_CODE);
        public static final ForeignKey<FreeformRecord, FreeformRecord> FREEFORM__FREEFORM_PARENT_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, Freeform.FREEFORM, "freeform__freeform_parent_id_fkey", Freeform.FREEFORM.PARENT_ID);
        public static final ForeignKey<FreeformRecord, LangRecord> FREEFORM__FREEFORM_LANG_FKEY = createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, Freeform.FREEFORM, "freeform__freeform_lang_fkey", Freeform.FREEFORM.LANG);
        public static final ForeignKey<FreeformRefLinkRecord, FreeformRecord> FREEFORM_REF_LINK__FREEFORM_REF_LINK_FREEFORM_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, FreeformRefLink.FREEFORM_REF_LINK, "freeform_ref_link__freeform_ref_link_freeform_id_fkey", FreeformRefLink.FREEFORM_REF_LINK.FREEFORM_ID);
        ...
        public static final ForeignKey<LexRelTypeLabelRecord, LexRelTypeRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.LEX_REL_TYPE_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_code_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.CODE);
        ...
        public static final ForeignKey<LexRelTypeLabelRecord, LabelTypeRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_type_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.TYPE);
        ...
        public static final ForeignKey<LexemeRecord, DatasetRecord> LEXEME__LEXEME_DATASET_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.DATASET_PKEY, Lexeme.LEXEME, "lexeme__lexeme_dataset_code_fkey", Lexeme.LEXEME.DATASET_CODE);
        public static final ForeignKey<LexemeRecord, LexemeTypeRecord> LEXEME__LEXEME_TYPE_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.LEXEME_TYPE_PKEY, Lexeme.LEXEME, "lexeme__lexeme_type_code_fkey", Lexeme.LEXEME.TYPE_CODE);
        public static final ForeignKey<LexemeRecord, LexemeFrequencyRecord> LEXEME__LEXEME_FREQUENCY_GROUP_FKEY = createForeignKey(eki.eve.data.db.Keys.LEXEME_FREQUENCY_PKEY, Lexeme.LEXEME, "lexeme__lexeme_frequency_group_fkey", Lexeme.LEXEME.FREQUENCY_GROUP);
        ...
        public static final ForeignKey<LexemeFreeformRecord, LexemeRecord> LEXEME_FREEFORM__LEXEME_FREEFORM_LEXEME_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, LexemeFreeform.LEXEME_FREEFORM, "lexeme_freeform__lexeme_freeform_lexeme_id_fkey", LexemeFreeform.LEXEME_FREEFORM.LEXEME_ID);
        public static final ForeignKey<LexemeFreeformRecord, FreeformRecord> LEXEME_FREEFORM__LEXEME_FREEFORM_FREEFORM_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, LexemeFreeform.LEXEME_FREEFORM, "lexeme_freeform__lexeme_freeform_freeform_id_fkey", LexemeFreeform.LEXEME_FREEFORM.FREEFORM_ID);
        ...
        public static final ForeignKey<LexemePosRecord, ProcessStateRecord> LEXEME_POS__LEXEME_POS_PROCESS_STATE_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.PROCESS_STATE_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_process_state_code_fkey", LexemePos.LEXEME_POS.PROCESS_STATE_CODE);
        ...
        public static final ForeignKey<LexemeRegisterRecord, RegisterRecord> LEXEME_REGISTER__LEXEME_REGISTER_REGISTER_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.REGISTER_PKEY, LexemeRegister.LEXEME_REGISTER, "lexeme_register__lexeme_register_register_code_fkey", LexemeRegister.LEXEME_REGISTER.REGISTER_CODE);
        ...
        public static final ForeignKey<MeaningRecord, ProcessStateRecord> MEANING__MEANING_PROCESS_STATE_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.PROCESS_STATE_PKEY, Meaning.MEANING, "meaning__meaning_process_state_code_fkey", Meaning.MEANING.PROCESS_STATE_CODE);
        public static final ForeignKey<MeaningRecord, MeaningStateRecord> MEANING__MEANING_STATE_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.MEANING_STATE_PKEY, Meaning.MEANING, "meaning__meaning_state_code_fkey", Meaning.MEANING.STATE_CODE);
        public static final ForeignKey<MeaningRecord, MeaningTypeRecord> MEANING__MEANING_TYPE_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.MEANING_TYPE_PKEY, Meaning.MEANING, "meaning__meaning_type_code_fkey", Meaning.MEANING.TYPE_CODE);
        ...
        public static final ForeignKey<WordRecord, GenderRecord> WORD__WORD_GENDER_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.GENDER_PKEY, Word.WORD, "word__word_gender_code_fkey", Word.WORD.GENDER_CODE);
        public static final ForeignKey<WordGuidRecord, WordRecord> WORD_GUID__WORD_GUID_WORD_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.WORD_PKEY, WordGuid.WORD_GUID, "word_guid__word_guid_word_id_fkey", WordGuid.WORD_GUID.WORD_ID);
        public static final ForeignKey<WordGuidRecord, DatasetRecord> WORD_GUID__WORD_GUID_DATASET_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.DATASET_PKEY, WordGuid.WORD_GUID, "word_guid__word_guid_dataset_code_fkey", WordGuid.WORD_GUID.DATASET_CODE);
        public static final ForeignKey<WordRelTypeLabelRecord, WordRelTypeRecord> WORD_REL_TYPE_LABEL__WORD_REL_TYPE_LABEL_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.WORD_REL_TYPE_PKEY, WordRelTypeLabel.WORD_REL_TYPE_LABEL, "word_rel_type_label__word_rel_type_label_code_fkey", WordRelTypeLabel.WORD_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<WordRelTypeLabelRecord, LangRecord> WORD_REL_TYPE_LABEL__WORD_REL_TYPE_LABEL_LANG_FKEY = createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, WordRelTypeLabel.WORD_REL_TYPE_LABEL, "word_rel_type_label__word_rel_type_label_lang_fkey", WordRelTypeLabel.WORD_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<WordRelTypeLabelRecord, LabelTypeRecord> WORD_REL_TYPE_LABEL__WORD_REL_TYPE_LABEL_TYPE_FKEY = createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, WordRelTypeLabel.WORD_REL_TYPE_LABEL, "word_rel_type_label__word_rel_type_label_type_fkey", WordRelTypeLabel.WORD_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<WordRelationRecord, WordRecord> WORD_RELATION__WORD_RELATION_WORD1_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.WORD_PKEY, WordRelation.WORD_RELATION, "word_relation__word_relation_word1_id_fkey", WordRelation.WORD_RELATION.WORD1_ID);
        public static final ForeignKey<WordRelationRecord, WordRecord> WORD_RELATION__WORD_RELATION_WORD2_ID_FKEY = createForeignKey(eki.eve.data.db.Keys.WORD_PKEY, WordRelation.WORD_RELATION, "word_relation__word_relation_word2_id_fkey", WordRelation.WORD_RELATION.WORD2_ID);
        public static final ForeignKey<WordRelationRecord, WordRelTypeRecord> WORD_RELATION__WORD_RELATION_WORD_REL_TYPE_CODE_FKEY = createForeignKey(eki.eve.data.db.Keys.WORD_REL_TYPE_PKEY, WordRelation.WORD_RELATION, "word_relation__word_relation_word_rel_type_code_fkey", WordRelation.WORD_RELATION.WORD_REL_TYPE_CODE);
    }
}
