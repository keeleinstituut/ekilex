...
import eki.eve.data.db.tables.records.FormRelTypeLabelRecord;
import eki.eve.data.db.tables.records.FormRelTypeRecord;
import eki.eve.data.db.tables.records.FormRelationRecord;
import eki.eve.data.db.tables.records.FreeformRecord;
...
import eki.eve.data.db.tables.records.LexemeFreeformRecord;
...
import eki.eve.data.db.tables.records.PersonRecord;
...
import eki.eve.data.db.tables.records.ValueStateLabelRecord;
...
import eki.eve.data.db.tables.records.WordRelationRecord;
import eki.eve.data.db.tables.records.WordTypeLabelRecord;
import eki.eve.data.db.tables.records.WordTypeRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<CollocationRecord, CollocationRelGroupRecord> COLLOCATION__COLLOCATION_COLLOCATION_REL_GROUP_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.COLLOCATION_REL_GROUP_PKEY, Collocation.COLLOCATION, "collocation__collocation_collocation_rel_group_id_fkey", Collocation.COLLOCATION.COLLOCATION_REL_GROUP_ID);
        public static final ForeignKey<CollocationRecord, LexemeRecord> COLLOCATION__COLLOCATION_LEXEME_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, Collocation.COLLOCATION, "collocation__collocation_lexeme_id_fkey", Collocation.COLLOCATION.LEXEME_ID);
        public static final ForeignKey<CollocationPosGroupRecord, LexemeRecord> COLLOCATION_POS_GROUP__COLLOCATION_POS_GROUP_LEXEME_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, CollocationPosGroup.COLLOCATION_POS_GROUP, "collocation_pos_group__collocation_pos_group_lexeme_id_fkey", CollocationPosGroup.COLLOCATION_POS_GROUP.LEXEME_ID);
        public static final ForeignKey<CollocationRelGroupRecord, CollocationPosGroupRecord> COLLOCATION_REL_GROUP__COLLOCATION_REL_GROUP_COLLOCATION_POS_GROUP_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.COLLOCATION_POS_GROUP_PKEY, CollocationRelGroup.COLLOCATION_REL_GROUP, "collocation_rel_group__collocation_rel_group_collocation_pos_group_id_fkey", CollocationRelGroup.COLLOCATION_REL_GROUP.COLLOCATION_POS_GROUP_ID);
        public static final ForeignKey<CollocationUsageRecord, CollocationRecord> COLLOCATION_USAGE__COLLOCATION_USAGE_COLLOCATION_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.COLLOCATION_PKEY, CollocationUsage.COLLOCATION_USAGE, "collocation_usage__collocation_usage_collocation_id_fkey", CollocationUsage.COLLOCATION_USAGE.COLLOCATION_ID);
        public static final ForeignKey<DefinitionRecord, MeaningRecord> DEFINITION__DEFINITION_MEANING_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_PKEY, Definition.DEFINITION, "definition__definition_meaning_id_fkey", Definition.DEFINITION.MEANING_ID);
        public static final ForeignKey<DefinitionRecord, LangRecord> DEFINITION__DEFINITION_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, Definition.DEFINITION, "definition__definition_lang_fkey", Definition.DEFINITION.LANG);
        public static final ForeignKey<DefinitionDatasetRecord, DefinitionRecord> DEFINITION_DATASET__DEFINITION_DATASET_DEFINITION_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DEFINITION_PKEY, DefinitionDataset.DEFINITION_DATASET, "definition_dataset__definition_dataset_definition_id_fkey", DefinitionDataset.DEFINITION_DATASET.DEFINITION_ID);
        public static final ForeignKey<DefinitionDatasetRecord, DatasetRecord> DEFINITION_DATASET__DEFINITION_DATASET_DATASET_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DATASET_PKEY, DefinitionDataset.DEFINITION_DATASET, "definition_dataset__definition_dataset_dataset_code_fkey", DefinitionDataset.DEFINITION_DATASET.DATASET_CODE);
        public static final ForeignKey<DefinitionFreeformRecord, DefinitionRecord> DEFINITION_FREEFORM__DEFINITION_FREEFORM_DEFINITION_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DEFINITION_PKEY, DefinitionFreeform.DEFINITION_FREEFORM, "definition_freeform__definition_freeform_definition_id_fkey", DefinitionFreeform.DEFINITION_FREEFORM.DEFINITION_ID);
        public static final ForeignKey<DefinitionFreeformRecord, FreeformRecord> DEFINITION_FREEFORM__DEFINITION_FREEFORM_FREEFORM_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, DefinitionFreeform.DEFINITION_FREEFORM, "definition_freeform__definition_freeform_freeform_id_fkey", DefinitionFreeform.DEFINITION_FREEFORM.FREEFORM_ID);
        public static final ForeignKey<DefinitionRefLinkRecord, DefinitionRecord> DEFINITION_REF_LINK__DEFINITION_REF_LINK_DEFINITION_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DEFINITION_PKEY, DefinitionRefLink.DEFINITION_REF_LINK, "definition_ref_link__definition_ref_link_definition_id_fkey", DefinitionRefLink.DEFINITION_REF_LINK.DEFINITION_ID);
        public static final ForeignKey<DerivLabelRecord, DerivRecord> DERIV_LABEL__DERIV_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DERIV_PKEY, DerivLabel.DERIV_LABEL, "deriv_label__deriv_label_code_fkey", DerivLabel.DERIV_LABEL.CODE);
        public static final ForeignKey<DerivLabelRecord, LangRecord> DERIV_LABEL__DERIV_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, DerivLabel.DERIV_LABEL, "deriv_label__deriv_label_lang_fkey", DerivLabel.DERIV_LABEL.LANG);
        public static final ForeignKey<DerivLabelRecord, LabelTypeRecord> DERIV_LABEL__DERIV_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, DerivLabel.DERIV_LABEL, "deriv_label__deriv_label_type_fkey", DerivLabel.DERIV_LABEL.TYPE);
        public static final ForeignKey<DisplayMorphLabelRecord, DisplayMorphRecord> DISPLAY_MORPH_LABEL__DISPLAY_MORPH_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DISPLAY_MORPH_PKEY, DisplayMorphLabel.DISPLAY_MORPH_LABEL, "display_morph_label__display_morph_label_code_fkey", DisplayMorphLabel.DISPLAY_MORPH_LABEL.CODE);
        public static final ForeignKey<DisplayMorphLabelRecord, LangRecord> DISPLAY_MORPH_LABEL__DISPLAY_MORPH_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, DisplayMorphLabel.DISPLAY_MORPH_LABEL, "display_morph_label__display_morph_label_lang_fkey", DisplayMorphLabel.DISPLAY_MORPH_LABEL.LANG);
        public static final ForeignKey<DisplayMorphLabelRecord, LabelTypeRecord> DISPLAY_MORPH_LABEL__DISPLAY_MORPH_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, DisplayMorphLabel.DISPLAY_MORPH_LABEL, "display_morph_label__display_morph_label_type_fkey", DisplayMorphLabel.DISPLAY_MORPH_LABEL.TYPE);
        public static final ForeignKey<DomainRecord, DomainRecord> DOMAIN__DOMAIN_PARENT_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DOMAIN_PKEY, Domain.DOMAIN, "domain__domain_parent_code_fkey", Domain.DOMAIN.PARENT_CODE, Domain.DOMAIN.PARENT_ORIGIN);
        public static final ForeignKey<DomainLabelRecord, DomainRecord> DOMAIN_LABEL__DOMAIN_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DOMAIN_PKEY, DomainLabel.DOMAIN_LABEL, "domain_label__domain_label_code_fkey", DomainLabel.DOMAIN_LABEL.CODE, DomainLabel.DOMAIN_LABEL.ORIGIN);
        public static final ForeignKey<DomainLabelRecord, LangRecord> DOMAIN_LABEL__DOMAIN_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, DomainLabel.DOMAIN_LABEL, "domain_label__domain_label_lang_fkey", DomainLabel.DOMAIN_LABEL.LANG);
        public static final ForeignKey<DomainLabelRecord, LabelTypeRecord> DOMAIN_LABEL__DOMAIN_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, DomainLabel.DOMAIN_LABEL, "domain_label__domain_label_type_fkey", DomainLabel.DOMAIN_LABEL.TYPE);
        public static final ForeignKey<FormRecord, ParadigmRecord> FORM__FORM_PARADIGM_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.PARADIGM_PKEY, Form.FORM, "form__form_paradigm_id_fkey", Form.FORM.PARADIGM_ID);
        public static final ForeignKey<FormRecord, MorphRecord> FORM__FORM_MORPH_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MORPH_PKEY, Form.FORM, "form__form_morph_code_fkey", Form.FORM.MORPH_CODE);
        public static final ForeignKey<FormRelTypeLabelRecord, FormRelTypeRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FORM_REL_TYPE_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_code_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<FormRelTypeLabelRecord, LangRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_lang_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<FormRelTypeLabelRecord, LabelTypeRecord> FORM_REL_TYPE_LABEL__FORM_REL_TYPE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, FormRelTypeLabel.FORM_REL_TYPE_LABEL, "form_rel_type_label__form_rel_type_label_type_fkey", FormRelTypeLabel.FORM_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<FormRelationRecord, FormRecord> FORM_RELATION__FORM_RELATION_FORM1_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FORM_PKEY, FormRelation.FORM_RELATION, "form_relation__form_relation_form1_id_fkey", FormRelation.FORM_RELATION.FORM1_ID);
        public static final ForeignKey<FormRelationRecord, FormRecord> FORM_RELATION__FORM_RELATION_FORM2_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FORM_PKEY, FormRelation.FORM_RELATION, "form_relation__form_relation_form2_id_fkey", FormRelation.FORM_RELATION.FORM2_ID);
        public static final ForeignKey<FormRelationRecord, FormRelTypeRecord> FORM_RELATION__FORM_RELATION_FORM_REL_TYPE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FORM_REL_TYPE_PKEY, FormRelation.FORM_RELATION, "form_relation__form_relation_form_rel_type_code_fkey", FormRelation.FORM_RELATION.FORM_REL_TYPE_CODE);
        public static final ForeignKey<FreeformRecord, FreeformRecord> FREEFORM__FREEFORM_PARENT_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, Freeform.FREEFORM, "freeform__freeform_parent_id_fkey", Freeform.FREEFORM.PARENT_ID);
        public static final ForeignKey<FreeformRecord, LangRecord> FREEFORM__FREEFORM_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, Freeform.FREEFORM, "freeform__freeform_lang_fkey", Freeform.FREEFORM.LANG);
        public static final ForeignKey<FreeformRefLinkRecord, FreeformRecord> FREEFORM_REF_LINK__FREEFORM_REF_LINK_FREEFORM_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, FreeformRefLink.FREEFORM_REF_LINK, "freeform_ref_link__freeform_ref_link_freeform_id_fkey", FreeformRefLink.FREEFORM_REF_LINK.FREEFORM_ID);
        public static final ForeignKey<GenderLabelRecord, GenderRecord> GENDER_LABEL__GENDER_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.GENDER_PKEY, GenderLabel.GENDER_LABEL, "gender_label__gender_label_code_fkey", GenderLabel.GENDER_LABEL.CODE);
        public static final ForeignKey<GenderLabelRecord, LangRecord> GENDER_LABEL__GENDER_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, GenderLabel.GENDER_LABEL, "gender_label__gender_label_lang_fkey", GenderLabel.GENDER_LABEL.LANG);
        public static final ForeignKey<GenderLabelRecord, LabelTypeRecord> GENDER_LABEL__GENDER_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, GenderLabel.GENDER_LABEL, "gender_label__gender_label_type_fkey", GenderLabel.GENDER_LABEL.TYPE);
        public static final ForeignKey<GovernmentTypeLabelRecord, GovernmentTypeRecord> GOVERNMENT_TYPE_LABEL__GOVERNMENT_TYPE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.GOVERNMENT_TYPE_PKEY, GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL, "government_type_label__government_type_label_code_fkey", GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL.CODE);
        public static final ForeignKey<GovernmentTypeLabelRecord, LangRecord> GOVERNMENT_TYPE_LABEL__GOVERNMENT_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL, "government_type_label__government_type_label_lang_fkey", GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL.LANG);
        public static final ForeignKey<GovernmentTypeLabelRecord, LabelTypeRecord> GOVERNMENT_TYPE_LABEL__GOVERNMENT_TYPE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL, "government_type_label__government_type_label_type_fkey", GovernmentTypeLabel.GOVERNMENT_TYPE_LABEL.TYPE);
        public static final ForeignKey<LangLabelRecord, LangRecord> LANG_LABEL__LANG_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_code_fkey", LangLabel.LANG_LABEL.CODE);
        public static final ForeignKey<LangLabelRecord, LangRecord> LANG_LABEL__LANG_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_lang_fkey", LangLabel.LANG_LABEL.LANG);
        public static final ForeignKey<LangLabelRecord, LabelTypeRecord> LANG_LABEL__LANG_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, LangLabel.LANG_LABEL, "lang_label__lang_label_type_fkey", LangLabel.LANG_LABEL.TYPE);
        public static final ForeignKey<LexRelTypeLabelRecord, LexRelTypeRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEX_REL_TYPE_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_code_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<LexRelTypeLabelRecord, LangRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_lang_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<LexRelTypeLabelRecord, LabelTypeRecord> LEX_REL_TYPE_LABEL__LEX_REL_TYPE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, LexRelTypeLabel.LEX_REL_TYPE_LABEL, "lex_rel_type_label__lex_rel_type_label_type_fkey", LexRelTypeLabel.LEX_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<LexRelationRecord, LexemeRecord> LEX_RELATION__LEX_RELATION_LEXEME1_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lexeme1_id_fkey", LexRelation.LEX_RELATION.LEXEME1_ID);
        public static final ForeignKey<LexRelationRecord, LexemeRecord> LEX_RELATION__LEX_RELATION_LEXEME2_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lexeme2_id_fkey", LexRelation.LEX_RELATION.LEXEME2_ID);
        public static final ForeignKey<LexRelationRecord, LexRelTypeRecord> LEX_RELATION__LEX_RELATION_LEX_REL_TYPE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEX_REL_TYPE_PKEY, LexRelation.LEX_RELATION, "lex_relation__lex_relation_lex_rel_type_code_fkey", LexRelation.LEX_RELATION.LEX_REL_TYPE_CODE);
        public static final ForeignKey<LexemeRecord, WordRecord> LEXEME__LEXEME_WORD_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_PKEY, Lexeme.LEXEME, "lexeme__lexeme_word_id_fkey", Lexeme.LEXEME.WORD_ID);
        public static final ForeignKey<LexemeRecord, MeaningRecord> LEXEME__LEXEME_MEANING_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_PKEY, Lexeme.LEXEME, "lexeme__lexeme_meaning_id_fkey", Lexeme.LEXEME.MEANING_ID);
        public static final ForeignKey<LexemeRecord, DatasetRecord> LEXEME__LEXEME_DATASET_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DATASET_PKEY, Lexeme.LEXEME, "lexeme__lexeme_dataset_code_fkey", Lexeme.LEXEME.DATASET_CODE);
        public static final ForeignKey<LexemeRecord, LexemeFrequencyRecord> LEXEME__LEXEME_FREQUENCY_GROUP_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_FREQUENCY_PKEY, Lexeme.LEXEME, "lexeme__lexeme_frequency_group_fkey", Lexeme.LEXEME.FREQUENCY_GROUP);
        public static final ForeignKey<LexemeRecord, ValueStateRecord> LEXEME__LEXEME_VALUE_STATE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.VALUE_STATE_PKEY, Lexeme.LEXEME, "lexeme__lexeme_value_state_code_fkey", Lexeme.LEXEME.VALUE_STATE_CODE);
        public static final ForeignKey<LexemeDerivRecord, LexemeRecord> LEXEME_DERIV__LEXEME_DERIV_LEXEME_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, LexemeDeriv.LEXEME_DERIV, "lexeme_deriv__lexeme_deriv_lexeme_id_fkey", LexemeDeriv.LEXEME_DERIV.LEXEME_ID);
        public static final ForeignKey<LexemeDerivRecord, DerivRecord> LEXEME_DERIV__LEXEME_DERIV_DERIV_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DERIV_PKEY, LexemeDeriv.LEXEME_DERIV, "lexeme_deriv__lexeme_deriv_deriv_code_fkey", LexemeDeriv.LEXEME_DERIV.DERIV_CODE);
        public static final ForeignKey<LexemeFreeformRecord, LexemeRecord> LEXEME_FREEFORM__LEXEME_FREEFORM_LEXEME_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, LexemeFreeform.LEXEME_FREEFORM, "lexeme_freeform__lexeme_freeform_lexeme_id_fkey", LexemeFreeform.LEXEME_FREEFORM.LEXEME_ID);
        public static final ForeignKey<LexemeFreeformRecord, FreeformRecord> LEXEME_FREEFORM__LEXEME_FREEFORM_FREEFORM_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, LexemeFreeform.LEXEME_FREEFORM, "lexeme_freeform__lexeme_freeform_freeform_id_fkey", LexemeFreeform.LEXEME_FREEFORM.FREEFORM_ID);
        public static final ForeignKey<LexemePosRecord, LexemeRecord> LEXEME_POS__LEXEME_POS_LEXEME_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_lexeme_id_fkey", LexemePos.LEXEME_POS.LEXEME_ID);
        public static final ForeignKey<LexemePosRecord, PosRecord> LEXEME_POS__LEXEME_POS_POS_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.POS_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_pos_code_fkey", LexemePos.LEXEME_POS.POS_CODE);
        public static final ForeignKey<LexemePosRecord, ProcessStateRecord> LEXEME_POS__LEXEME_POS_PROCESS_STATE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.PROCESS_STATE_PKEY, LexemePos.LEXEME_POS, "lexeme_pos__lexeme_pos_process_state_code_fkey", LexemePos.LEXEME_POS.PROCESS_STATE_CODE);
        public static final ForeignKey<LexemeRegisterRecord, LexemeRecord> LEXEME_REGISTER__LEXEME_REGISTER_LEXEME_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LEXEME_PKEY, LexemeRegister.LEXEME_REGISTER, "lexeme_register__lexeme_register_lexeme_id_fkey", LexemeRegister.LEXEME_REGISTER.LEXEME_ID);
        public static final ForeignKey<LexemeRegisterRecord, RegisterRecord> LEXEME_REGISTER__LEXEME_REGISTER_REGISTER_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.REGISTER_PKEY, LexemeRegister.LEXEME_REGISTER, "lexeme_register__lexeme_register_register_code_fkey", LexemeRegister.LEXEME_REGISTER.REGISTER_CODE);
        public static final ForeignKey<MeaningRecord, ProcessStateRecord> MEANING__MEANING_PROCESS_STATE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.PROCESS_STATE_PKEY, Meaning.MEANING, "meaning__meaning_process_state_code_fkey", Meaning.MEANING.PROCESS_STATE_CODE);
        public static final ForeignKey<MeaningRecord, MeaningTypeRecord> MEANING__MEANING_TYPE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_TYPE_PKEY, Meaning.MEANING, "meaning__meaning_type_code_fkey", Meaning.MEANING.TYPE_CODE);
        public static final ForeignKey<MeaningDomainRecord, MeaningRecord> MEANING_DOMAIN__MEANING_DOMAIN_MEANING_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_PKEY, MeaningDomain.MEANING_DOMAIN, "meaning_domain__meaning_domain_meaning_id_fkey", MeaningDomain.MEANING_DOMAIN.MEANING_ID);
        public static final ForeignKey<MeaningDomainRecord, DomainRecord> MEANING_DOMAIN__MEANING_DOMAIN_DOMAIN_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DOMAIN_PKEY, MeaningDomain.MEANING_DOMAIN, "meaning_domain__meaning_domain_domain_code_fkey", MeaningDomain.MEANING_DOMAIN.DOMAIN_CODE, MeaningDomain.MEANING_DOMAIN.DOMAIN_ORIGIN);
        public static final ForeignKey<MeaningFreeformRecord, MeaningRecord> MEANING_FREEFORM__MEANING_FREEFORM_MEANING_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_PKEY, MeaningFreeform.MEANING_FREEFORM, "meaning_freeform__meaning_freeform_meaning_id_fkey", MeaningFreeform.MEANING_FREEFORM.MEANING_ID);
        public static final ForeignKey<MeaningFreeformRecord, FreeformRecord> MEANING_FREEFORM__MEANING_FREEFORM_FREEFORM_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, MeaningFreeform.MEANING_FREEFORM, "meaning_freeform__meaning_freeform_freeform_id_fkey", MeaningFreeform.MEANING_FREEFORM.FREEFORM_ID);
        public static final ForeignKey<MeaningRelTypeLabelRecord, MeaningRelTypeRecord> MEANING_REL_TYPE_LABEL__MEANING_REL_TYPE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_REL_TYPE_PKEY, MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL, "meaning_rel_type_label__meaning_rel_type_label_code_fkey", MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<MeaningRelTypeLabelRecord, LangRecord> MEANING_REL_TYPE_LABEL__MEANING_REL_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL, "meaning_rel_type_label__meaning_rel_type_label_lang_fkey", MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<MeaningRelTypeLabelRecord, LabelTypeRecord> MEANING_REL_TYPE_LABEL__MEANING_REL_TYPE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL, "meaning_rel_type_label__meaning_rel_type_label_type_fkey", MeaningRelTypeLabel.MEANING_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<MeaningRelationRecord, MeaningRecord> MEANING_RELATION__MEANING_RELATION_MEANING1_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_PKEY, MeaningRelation.MEANING_RELATION, "meaning_relation__meaning_relation_meaning1_id_fkey", MeaningRelation.MEANING_RELATION.MEANING1_ID);
        public static final ForeignKey<MeaningRelationRecord, MeaningRecord> MEANING_RELATION__MEANING_RELATION_MEANING2_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_PKEY, MeaningRelation.MEANING_RELATION, "meaning_relation__meaning_relation_meaning2_id_fkey", MeaningRelation.MEANING_RELATION.MEANING2_ID);
        public static final ForeignKey<MeaningRelationRecord, MeaningRelTypeRecord> MEANING_RELATION__MEANING_RELATION_MEANING_REL_TYPE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MEANING_REL_TYPE_PKEY, MeaningRelation.MEANING_RELATION, "meaning_relation__meaning_relation_meaning_rel_type_code_fkey", MeaningRelation.MEANING_RELATION.MEANING_REL_TYPE_CODE);
        public static final ForeignKey<MorphLabelRecord, MorphRecord> MORPH_LABEL__MORPH_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MORPH_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_code_fkey", MorphLabel.MORPH_LABEL.CODE);
        public static final ForeignKey<MorphLabelRecord, LangRecord> MORPH_LABEL__MORPH_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_lang_fkey", MorphLabel.MORPH_LABEL.LANG);
        public static final ForeignKey<MorphLabelRecord, LabelTypeRecord> MORPH_LABEL__MORPH_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, MorphLabel.MORPH_LABEL, "morph_label__morph_label_type_fkey", MorphLabel.MORPH_LABEL.TYPE);
        public static final ForeignKey<ParadigmRecord, WordRecord> PARADIGM__PARADIGM_WORD_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_PKEY, Paradigm.PARADIGM, "paradigm__paradigm_word_id_fkey", Paradigm.PARADIGM.WORD_ID);
        public static final ForeignKey<PosLabelRecord, PosRecord> POS_LABEL__POS_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.POS_PKEY, PosLabel.POS_LABEL, "pos_label__pos_label_code_fkey", PosLabel.POS_LABEL.CODE);
        public static final ForeignKey<PosLabelRecord, LangRecord> POS_LABEL__POS_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, PosLabel.POS_LABEL, "pos_label__pos_label_lang_fkey", PosLabel.POS_LABEL.LANG);
        public static final ForeignKey<PosLabelRecord, LabelTypeRecord> POS_LABEL__POS_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, PosLabel.POS_LABEL, "pos_label__pos_label_type_fkey", PosLabel.POS_LABEL.TYPE);
        public static final ForeignKey<RegisterLabelRecord, RegisterRecord> REGISTER_LABEL__REGISTER_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.REGISTER_PKEY, RegisterLabel.REGISTER_LABEL, "register_label__register_label_code_fkey", RegisterLabel.REGISTER_LABEL.CODE);
        public static final ForeignKey<RegisterLabelRecord, LangRecord> REGISTER_LABEL__REGISTER_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, RegisterLabel.REGISTER_LABEL, "register_label__register_label_lang_fkey", RegisterLabel.REGISTER_LABEL.LANG);
        public static final ForeignKey<RegisterLabelRecord, LabelTypeRecord> REGISTER_LABEL__REGISTER_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, RegisterLabel.REGISTER_LABEL, "register_label__register_label_type_fkey", RegisterLabel.REGISTER_LABEL.TYPE);
        public static final ForeignKey<SourceRecord, ProcessStateRecord> SOURCE__SOURCE_PROCESS_STATE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.PROCESS_STATE_PKEY, Source.SOURCE, "source__source_process_state_code_fkey", Source.SOURCE.PROCESS_STATE_CODE);
        public static final ForeignKey<SourceFreeformRecord, SourceRecord> SOURCE_FREEFORM__SOURCE_FREEFORM_SOURCE_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.SOURCE_PKEY, SourceFreeform.SOURCE_FREEFORM, "source_freeform__source_freeform_source_id_fkey", SourceFreeform.SOURCE_FREEFORM.SOURCE_ID);
        public static final ForeignKey<SourceFreeformRecord, FreeformRecord> SOURCE_FREEFORM__SOURCE_FREEFORM_FREEFORM_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.FREEFORM_PKEY, SourceFreeform.SOURCE_FREEFORM, "source_freeform__source_freeform_freeform_id_fkey", SourceFreeform.SOURCE_FREEFORM.FREEFORM_ID);
        public static final ForeignKey<UsageTypeLabelRecord, UsageTypeRecord> USAGE_TYPE_LABEL__USAGE_TYPE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.USAGE_TYPE_PKEY, UsageTypeLabel.USAGE_TYPE_LABEL, "usage_type_label__usage_type_label_code_fkey", UsageTypeLabel.USAGE_TYPE_LABEL.CODE);
        public static final ForeignKey<UsageTypeLabelRecord, LangRecord> USAGE_TYPE_LABEL__USAGE_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, UsageTypeLabel.USAGE_TYPE_LABEL, "usage_type_label__usage_type_label_lang_fkey", UsageTypeLabel.USAGE_TYPE_LABEL.LANG);
        public static final ForeignKey<UsageTypeLabelRecord, LabelTypeRecord> USAGE_TYPE_LABEL__USAGE_TYPE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, UsageTypeLabel.USAGE_TYPE_LABEL, "usage_type_label__usage_type_label_type_fkey", UsageTypeLabel.USAGE_TYPE_LABEL.TYPE);
        public static final ForeignKey<ValueStateLabelRecord, ValueStateRecord> VALUE_STATE_LABEL__VALUE_STATE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.VALUE_STATE_PKEY, ValueStateLabel.VALUE_STATE_LABEL, "value_state_label__value_state_label_code_fkey", ValueStateLabel.VALUE_STATE_LABEL.CODE);
        public static final ForeignKey<ValueStateLabelRecord, LangRecord> VALUE_STATE_LABEL__VALUE_STATE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, ValueStateLabel.VALUE_STATE_LABEL, "value_state_label__value_state_label_lang_fkey", ValueStateLabel.VALUE_STATE_LABEL.LANG);
        public static final ForeignKey<ValueStateLabelRecord, LabelTypeRecord> VALUE_STATE_LABEL__VALUE_STATE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, ValueStateLabel.VALUE_STATE_LABEL, "value_state_label__value_state_label_type_fkey", ValueStateLabel.VALUE_STATE_LABEL.TYPE);
        public static final ForeignKey<WordRecord, LangRecord> WORD__WORD_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, Word.WORD, "word__word_lang_fkey", Word.WORD.LANG);
        public static final ForeignKey<WordRecord, MorphRecord> WORD__WORD_MORPH_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.MORPH_PKEY, Word.WORD, "word__word_morph_code_fkey", Word.WORD.MORPH_CODE);
        public static final ForeignKey<WordRecord, DisplayMorphRecord> WORD__WORD_DISPLAY_MORPH_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DISPLAY_MORPH_PKEY, Word.WORD, "word__word_display_morph_code_fkey", Word.WORD.DISPLAY_MORPH_CODE);
        public static final ForeignKey<WordRecord, GenderRecord> WORD__WORD_GENDER_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.GENDER_PKEY, Word.WORD, "word__word_gender_code_fkey", Word.WORD.GENDER_CODE);
        public static final ForeignKey<WordRecord, WordTypeRecord> WORD__WORD_TYPE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_TYPE_PKEY, Word.WORD, "word__word_type_code_fkey", Word.WORD.TYPE_CODE);
        public static final ForeignKey<WordGuidRecord, WordRecord> WORD_GUID__WORD_GUID_WORD_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_PKEY, WordGuid.WORD_GUID, "word_guid__word_guid_word_id_fkey", WordGuid.WORD_GUID.WORD_ID);
        public static final ForeignKey<WordGuidRecord, DatasetRecord> WORD_GUID__WORD_GUID_DATASET_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.DATASET_PKEY, WordGuid.WORD_GUID, "word_guid__word_guid_dataset_code_fkey", WordGuid.WORD_GUID.DATASET_CODE);
        public static final ForeignKey<WordRelTypeLabelRecord, WordRelTypeRecord> WORD_REL_TYPE_LABEL__WORD_REL_TYPE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_REL_TYPE_PKEY, WordRelTypeLabel.WORD_REL_TYPE_LABEL, "word_rel_type_label__word_rel_type_label_code_fkey", WordRelTypeLabel.WORD_REL_TYPE_LABEL.CODE);
        public static final ForeignKey<WordRelTypeLabelRecord, LangRecord> WORD_REL_TYPE_LABEL__WORD_REL_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, WordRelTypeLabel.WORD_REL_TYPE_LABEL, "word_rel_type_label__word_rel_type_label_lang_fkey", WordRelTypeLabel.WORD_REL_TYPE_LABEL.LANG);
        public static final ForeignKey<WordRelTypeLabelRecord, LabelTypeRecord> WORD_REL_TYPE_LABEL__WORD_REL_TYPE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, WordRelTypeLabel.WORD_REL_TYPE_LABEL, "word_rel_type_label__word_rel_type_label_type_fkey", WordRelTypeLabel.WORD_REL_TYPE_LABEL.TYPE);
        public static final ForeignKey<WordRelationRecord, WordRecord> WORD_RELATION__WORD_RELATION_WORD1_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_PKEY, WordRelation.WORD_RELATION, "word_relation__word_relation_word1_id_fkey", WordRelation.WORD_RELATION.WORD1_ID);
        public static final ForeignKey<WordRelationRecord, WordRecord> WORD_RELATION__WORD_RELATION_WORD2_ID_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_PKEY, WordRelation.WORD_RELATION, "word_relation__word_relation_word2_id_fkey", WordRelation.WORD_RELATION.WORD2_ID);
        public static final ForeignKey<WordRelationRecord, WordRelTypeRecord> WORD_RELATION__WORD_RELATION_WORD_REL_TYPE_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_REL_TYPE_PKEY, WordRelation.WORD_RELATION, "word_relation__word_relation_word_rel_type_code_fkey", WordRelation.WORD_RELATION.WORD_REL_TYPE_CODE);
        public static final ForeignKey<WordTypeLabelRecord, WordTypeRecord> WORD_TYPE_LABEL__WORD_TYPE_LABEL_CODE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.WORD_TYPE_PKEY, WordTypeLabel.WORD_TYPE_LABEL, "word_type_label__word_type_label_code_fkey", WordTypeLabel.WORD_TYPE_LABEL.CODE);
        public static final ForeignKey<WordTypeLabelRecord, LangRecord> WORD_TYPE_LABEL__WORD_TYPE_LABEL_LANG_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LANG_PKEY, WordTypeLabel.WORD_TYPE_LABEL, "word_type_label__word_type_label_lang_fkey", WordTypeLabel.WORD_TYPE_LABEL.LANG);
        public static final ForeignKey<WordTypeLabelRecord, LabelTypeRecord> WORD_TYPE_LABEL__WORD_TYPE_LABEL_TYPE_FKEY = Internal.createForeignKey(eki.eve.data.db.Keys.LABEL_TYPE_PKEY, WordTypeLabel.WORD_TYPE_LABEL, "word_type_label__word_type_label_type_fkey", WordTypeLabel.WORD_TYPE_LABEL.TYPE);
    }
}
