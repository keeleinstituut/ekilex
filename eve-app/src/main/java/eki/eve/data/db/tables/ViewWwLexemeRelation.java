...
import eki.eve.data.db.tables.records.ViewWwLexemeRelationRecord;
...
public class ViewWwLexemeRelation extends TableImpl<ViewWwLexemeRelationRecord> {
    ...
    private static final long serialVersionUID = 40186133;
     ...
     */
    public final TableField<ViewWwLexemeRelationRecord, TypeLexemeRelationRecord[]> RELATED_LEXEMES = createField("related_lexemes", eki.eve.data.db.udt.TypeLexemeRelation.TYPE_LEXEME_RELATION.getDataType().getArrayDataType(), this, "");
