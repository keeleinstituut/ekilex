...
public class LexemeRecord extends UpdatableRecordImpl<LexemeRecord> implements Record13<Long, Long, Long, String, Timestamp, String, Timestamp, String, String, String, Integer, Integer, Integer> {

    private static final long serialVersionUID = 2130651908;
     ...
     */
    @Override
    public Row13<Long, Long, Long, String, Timestamp, String, Timestamp, String, String, String, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row13<Long, Long, Long, String, Timestamp, String, Timestamp, String, String, String, Integer, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public LexemeRecord value13(Integer value) {
        setLevel3(value);
        return this;
    }
     ...
     */
    @Override
    public LexemeRecord values(Long value1, Long value2, Long value3, String value4, Timestamp value5, String value6, Timestamp value7, String value8, String value9, String value10, Integer value11, Integer value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LexemeRecord(Long id, Long wordId, Long meaningId, String datasetCode, Timestamp createdOn, String createdBy, Timestamp modifiedOn, String modifiedBy, String typeCode, String frequencyGroup, Integer level1, Integer level2, Integer level3) {
        super(Lexeme.LEXEME);
