...
import eki.eve.data.db.tables.records.ViewWwWordRecord;
import eki.eve.data.db.udt.records.TypeDefinitionRecord;
...
public class ViewWwWord extends TableImpl<ViewWwWordRecord> {
    ...
    private static final long serialVersionUID = 2030165709;
     ...
     */
    public final TableField<ViewWwWordRecord, TypeDefinitionRecord[]> DEFINITIONS = createField("definitions", eki.eve.data.db.udt.TypeDefinition.TYPE_DEFINITION.getDataType().getArrayDataType(), this, "");
