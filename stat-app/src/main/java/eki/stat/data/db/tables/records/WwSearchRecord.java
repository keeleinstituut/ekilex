...
public class WwSearchRecord extends UpdatableRecordImpl<WwSearchRecord> implements Record10<Long, String, Integer, String, String[], String[], String, Integer, Boolean, Boolean> {

    private static final long serialVersionUID = 1009154486;
    ...
    @Override
    public Row10<Long, String, Integer, String, String[], String[], String, Integer, Boolean, Boolean> valuesRow() {
    ...
    @Override
    public WwSearchRecord values(Long value1, String value2, Integer value3, String value4, String[] value5, String[] value6, String value7, Integer value8, Boolean value9, Boolean value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WwSearchRecord(Long id, String searchWord, Integer homonymNr, String searchMode, String[] destinLangs, String[] datasetCodes, String searchUri, Integer resultCount, Boolean resultsExist, Boolean singleResult) {
        super(WwSearch.WW_SEARCH);
