...
public class WwSearchRecord extends UpdatableRecordImpl<WwSearchRecord> implements Record12<Long, String, Integer, String, String[], String[], String, Integer, Boolean, Boolean, Timestamp, String> {

    private static final long serialVersionUID = 2047209874;
    ...
    @Override
    public Row12<Long, String, Integer, String, String[], String[], String, Integer, Boolean, Boolean, Timestamp, String> valuesRow() {
    ...
    @Override
    public WwSearchRecord values(Long value1, String value2, Integer value3, String value4, String[] value5, String[] value6, String value7, Integer value8, Boolean value9, Boolean value10, Timestamp value11, String value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WwSearchRecord(Long id, String searchWord, Integer homonymNr, String searchMode, String[] destinLangs, String[] datasetCodes, String searchUri, Integer resultCount, Boolean resultsExist, Boolean singleResult, Timestamp eventOn, String userAgent) {
        super(WwSearch.WW_SEARCH);
