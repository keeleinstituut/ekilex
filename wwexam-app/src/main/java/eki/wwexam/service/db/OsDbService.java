...
import static eki.wwexam.data.db.Tables.OS_LEXEME_MEANING;
import static eki.wwexam.data.db.Tables.OS_WORD;
import static eki.wwexam.data.db.Tables.OS_WORD_EKI_RECOMMENDATION;
import static eki.wwexam.data.db.Tables.OS_WORD_OS_MORPH;
import static eki.wwexam.data.db.Tables.OS_WORD_OS_USAGE;
import static eki.wwexam.data.db.Tables.OS_WORD_RELATION;
import static eki.wwexam.data.db.Tables.OS_WORD_RELATION_IDX;
import static eki.wwexam.data.db.Tables.OS_WORD_SEARCH;
...
import eki.wwexam.data.db.Routines;
...
public class OsDbService implements SystemConstant, GlobalConstant {
	...
	public List<eki.wwexam.data.os.OsWord> getWords(String searchValue, boolean fiCollationExists) {
		...
		return create
				...
				.fetchInto(eki.wwexam.data.os.OsWord.class);
	}

	public List<eki.wwexam.data.os.OsWord> getRelatedWords(String searchValue) {
