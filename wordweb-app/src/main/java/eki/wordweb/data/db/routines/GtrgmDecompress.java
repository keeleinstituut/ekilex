...
public class GtrgmDecompress extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1964232884;
    ...
    public GtrgmDecompress() {
        super("gtrgm_decompress", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
