...
public class LexicalDecisionDataRecord extends UpdatableRecordImpl<LexicalDecisionDataRecord> implements Record3<Long, String, Boolean> {

    private static final long serialVersionUID = 1463737363;
     ...
     */
    @Override
    public LexicalDecisionDataRecord value3(Boolean value) {
        setIsWord(value);
        return this;
    }
     ...
     */
    @Override
    public LexicalDecisionDataRecord values(Long value1, String value2, Boolean value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public LexicalDecisionDataRecord(Long id, String word, Boolean isWord) {
        super(LexicalDecisionData.LEXICAL_DECISION_DATA);
