...
public class MviewWwWordSearchRecord extends TableRecordImpl<MviewWwWordSearchRecord> implements Record4<String, String, String, String> {

    private static final long serialVersionUID = 218683246;
     ...
     */
    @Override
    public MviewWwWordSearchRecord values(String value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MviewWwWordSearchRecord(String sgroup, String word, String crit, String unacrit) {
        super(MviewWwWordSearch.MVIEW_WW_WORD_SEARCH);
