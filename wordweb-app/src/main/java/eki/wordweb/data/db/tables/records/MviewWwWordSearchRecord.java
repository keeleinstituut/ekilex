...
public class MviewWwWordSearchRecord extends TableRecordImpl<MviewWwWordSearchRecord> implements Record8<String, String, String, String, Long, TypeLangComplexityRecord[], Boolean, Boolean> {

    private static final long serialVersionUID = -615139598;
    ...
    /**
     * Setter for <code>public.mview_ww_word_search.detail_exists</code>.
     */
    ...
    /**
     * Getter for <code>public.mview_ww_word_search.detail_exists</code>.
     */
    ...
    public Field<Boolean> field7() {
        return MviewWwWordSearch.MVIEW_WW_WORD_SEARCH.DETAIL_EXISTS;
    }
    ...
    @Override
    public MviewWwWordSearchRecord value8(Boolean value) {
        setSimpleExists(value);
        return this;
    }

    @Override
    public MviewWwWordSearchRecord values(String value1, String value2, String value3, String value4, Long value5, TypeLangComplexityRecord[] value6, Boolean value7, Boolean value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MviewWwWordSearchRecord(String sgroup, String word, String crit, String unacrit, Long langOrderBy, TypeLangComplexityRecord[] langComplexities, Boolean detailExists, Boolean simpleExists) {
        super(MviewWwWordSearch.MVIEW_WW_WORD_SEARCH);
