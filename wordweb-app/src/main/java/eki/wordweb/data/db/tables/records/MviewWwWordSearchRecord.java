...
public class MviewWwWordSearchRecord extends TableRecordImpl<MviewWwWordSearchRecord> implements Record5<String, String, String, Long, JSON> {
     ...
     */
    public void setLangComplexities(JSON value) {
        set(4, value);
    }
     ...
     */
    public JSON getLangComplexities() {
        return (JSON) get(4);
    }
    ...
    @Override
    public Row5<String, String, String, Long, JSON> valuesRow() {
    ...
    @Override
    public MviewWwWordSearchRecord value5(JSON value) {
        setLangComplexities(value);
        return this;
    }

    @Override
    public MviewWwWordSearchRecord values(String value1, String value2, String value3, Long value4, JSON value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MviewWwWordSearchRecord(String sgroup, String word, String crit, Long langOrderBy, JSON langComplexities) {
        super(MviewWwWordSearch.MVIEW_WW_WORD_SEARCH);
