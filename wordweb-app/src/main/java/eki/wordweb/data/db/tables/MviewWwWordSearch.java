...
public class MviewWwWordSearch extends TableImpl<MviewWwWordSearchRecord> {
    ...
    private static final long serialVersionUID = 76445624;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MVIEW_WW_WORD_SEARCH_CRIT_PREFIX_IDX, Indexes.MVIEW_WW_WORD_SEARCH_SGROUP_IDX);
    }
