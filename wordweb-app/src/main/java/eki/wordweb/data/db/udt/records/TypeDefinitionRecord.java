...
public class TypeDefinitionRecord extends UDTRecordImpl<TypeDefinitionRecord> implements Record4<Long, Long, String, String> {

    private static final long serialVersionUID = 1435300456;
     ...
     */
    @Override
    public TypeDefinitionRecord values(Long value1, Long value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TypeDefinitionRecord(Long lexemeId, Long meaningId, String value, String lang) {
        super(TypeDefinition.TYPE_DEFINITION);
