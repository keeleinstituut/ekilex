...
public class TypeMeaningWord extends UDTImpl<TypeMeaningWordRecord> {
    ...
    private static final long serialVersionUID = -1122035741;
     ...
     */
    public static final UDTField<TypeMeaningWordRecord, TypeFreeformRecord[]> MW_LEX_GOVERNMENTS = createField(DSL.name("mw_lex_governments"), eki.wordweb.data.db.udt.TypeFreeform.TYPE_FREEFORM.getDataType().getArrayDataType(), TYPE_MEANING_WORD, "");
