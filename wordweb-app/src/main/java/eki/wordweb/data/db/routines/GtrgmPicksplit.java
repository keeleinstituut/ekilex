...
public class GtrgmPicksplit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -359963258;
    ...
    public GtrgmPicksplit() {
        super("gtrgm_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
