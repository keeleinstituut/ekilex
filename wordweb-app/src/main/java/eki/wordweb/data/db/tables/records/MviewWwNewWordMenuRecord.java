...
public class MviewWwNewWordMenuRecord extends TableRecordImpl<MviewWwNewWordMenuRecord> implements Record5<Long, String, String, Integer, Integer> {
    ...
    @Override
    public MviewWwNewWordMenuRecord values(Long value1, String value2, String value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MviewWwNewWordMenuRecord(Long wordId, String word, String wordPrese, Integer homonymNr, Integer regYear) {
        super(MviewWwNewWordMenu.MVIEW_WW_NEW_WORD_MENU);
