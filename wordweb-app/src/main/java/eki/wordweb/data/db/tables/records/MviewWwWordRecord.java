...
public class MviewWwWordRecord extends TableRecordImpl<MviewWwWordRecord> {
    ...
    /**
     * Setter for <code>public.mview_ww_word.word_os_recommendation</code>.
     */
    public void setWordOsRecommendation(JSON value) {
        set(19, value);
    }

    /**
     * Getter for <code>public.mview_ww_word.word_os_recommendation</code>.
     */
    public JSON getWordOsRecommendation() {
        return (JSON) get(19);
    }
     ...
     */
    public MviewWwWordRecord(Long wordId, String value, String valuePrese, String valueAsWord, String lang, String langFilt, Long langOrderBy, Integer homonymNr, String displayMorphCode, String genderCode, String aspectCode, String vocalForm, String morphComment, Integer regYear, LocalDateTime manualEventOn, LocalDateTime lastActivityEventOn, String[] wordTypeCodes, JSON meaningWords, JSON definitions, JSON wordOsRecommendation, BigDecimal freqValue, Long freqRank, Boolean formsExist, Long minDsOrderBy, Integer wordTypeOrderBy, TypeLangDatasetPublishingRecord[] langDsPubs) {
        super(MviewWwWord.MVIEW_WW_WORD);
        ...
        setWordOsRecommendation(wordOsRecommendation);
