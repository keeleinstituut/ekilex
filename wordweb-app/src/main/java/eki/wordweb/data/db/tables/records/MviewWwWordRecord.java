...
public class MviewWwWordRecord extends TableRecordImpl<MviewWwWordRecord> implements Record21<Long, String, String, String, String, Long, Integer, String, String[], String, String, String, TypeLangComplexityRecord[], TypeMeaningWordRecord[], TypeDefinitionRecord[], String[], BigDecimal, Long, Boolean, Long, Integer> {

    private static final long serialVersionUID = 2054944397;
    ...
    @Override
    public Row21<Long, String, String, String, String, Long, Integer, String, String[], String, String, String, TypeLangComplexityRecord[], TypeMeaningWordRecord[], TypeDefinitionRecord[], String[], BigDecimal, Long, Boolean, Long, Integer> valuesRow() {
