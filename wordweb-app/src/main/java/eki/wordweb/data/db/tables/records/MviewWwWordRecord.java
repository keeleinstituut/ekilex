...
public class MviewWwWordRecord extends TableRecordImpl<MviewWwWordRecord> implements Record18<Long, String, String, String, String, Long, Integer, String, String[], String, String, String, TypeLangComplexityRecord[], TypeMeaningWordRecord[], TypeDefinitionRecord[], String[], Boolean, Long> {

    private static final long serialVersionUID = 757647943;
