...
public class MviewWwLexicalDecisionData extends TableImpl<MviewWwLexicalDecisionDataRecord> {
    ...
    private static final long serialVersionUID = -1080765901;
    ...
    public <O extends Record> MviewWwLexicalDecisionData(Table<O> child, ForeignKey<O, MviewWwLexicalDecisionDataRecord> key) {
        super(child, key, MVIEW_WW_LEXICAL_DECISION_DATA);
    }
