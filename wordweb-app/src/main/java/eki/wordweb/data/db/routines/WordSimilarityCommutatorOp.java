...
public class WordSimilarityCommutatorOp extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 828576976;

    /**
     * The parameter <code>public.word_similarity_commutator_op.RETURN_VALUE</code>.
     */
    ...
    public WordSimilarityCommutatorOp() {
        super("word_similarity_commutator_op", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
