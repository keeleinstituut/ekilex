...
public class MviewWwFormRecord extends TableRecordImpl<MviewWwFormRecord> {
     ...
     */
    public MviewWwFormRecord(Long wordId, String wordClass, String word, String lang, Long paradigmId, String paradigmComment, String inflectionType, String inflectionTypeNr, Long formId, String value, String valuePrese, String morphCode, String morphGroup1, String morphGroup2, String morphGroup3, Integer displayLevel, String displayForm, String audioFile, Boolean morphExists, Boolean isQuestionable, Long orderBy, BigDecimal formFreqValue, Long formFreqRank, Long formFreqRankMax, BigDecimal morphFreqValue, Long morphFreqRank, Long morphFreqRankMax) {
        super(MviewWwForm.MVIEW_WW_FORM);
