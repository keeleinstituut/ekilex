...
public class StrictWordSimilarityDistOp extends AbstractRoutine<Float> {
    ...
    private static final long serialVersionUID = 67065310;

    /**
     * The parameter <code>public.strict_word_similarity_dist_op.RETURN_VALUE</code>.
     */
    ...
    public StrictWordSimilarityDistOp() {
        super("strict_word_similarity_dist_op", Public.PUBLIC, org.jooq.impl.SQLDataType.REAL);
