...
public class GinTrgmTriconsistent extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 933654453;

    /**
     * The parameter <code>public.gin_trgm_triconsistent.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.CHAR, false, false);
    ...
    public GinTrgmTriconsistent() {
        super("gin_trgm_triconsistent", Public.PUBLIC, org.jooq.impl.SQLDataType.CHAR);
