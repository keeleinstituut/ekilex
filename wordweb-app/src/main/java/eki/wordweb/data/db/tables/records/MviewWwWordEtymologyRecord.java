...
public class MviewWwWordEtymologyRecord extends TableRecordImpl<MviewWwWordEtymologyRecord> implements Record13<Long, Long, Long, String, String, String[], String, String, String, Boolean, Long, JSON, JSON> {
    ...
    @Override
    public Row13<Long, Long, Long, String, String, String[], String, String, String, Boolean, Long, JSON, JSON> valuesRow() {
    ...
    @Override
    public MviewWwWordEtymologyRecord values(Long value1, Long value2, Long value3, String value4, String value5, String[] value6, String value7, String value8, String value9, Boolean value10, Long value11, JSON value12, JSON value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MviewWwWordEtymologyRecord(Long wordId, Long wordEtymId, Long wordEtymWordId, String wordEtymWord, String wordEtymWordLang, String[] wordEtymWordMeaningWords, String etymologyTypeCode, String etymologyYear, String wordEtymComment, Boolean wordEtymIsQuestionable, Long wordEtymOrderBy, JSON wordEtymRelations, JSON sourceLinks) {
        super(MviewWwWordEtymology.MVIEW_WW_WORD_ETYMOLOGY);
