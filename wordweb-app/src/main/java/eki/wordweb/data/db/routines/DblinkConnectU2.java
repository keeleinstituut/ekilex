...
public class DblinkConnectU2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1658230822;

    /**
     * The parameter <code>public.dblink_connect_u.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.dblink_connect_u._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>public.dblink_connect_u._2</code>.
     */
     ...
     */
    public DblinkConnectU2() {
        super("dblink_connect_u", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
