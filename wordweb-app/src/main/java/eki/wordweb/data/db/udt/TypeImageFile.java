...
public class TypeImageFile extends UDTImpl<TypeImageFileRecord> {
    ...
    private static final long serialVersionUID = 1536770736;
     ...
     */
    public static final UDTField<TypeImageFileRecord, Long> FREEFORM_ID = createField("freeform_id", org.jooq.impl.SQLDataType.BIGINT, TYPE_IMAGE_FILE, "");

    /**
     * The attribute <code>public.type_image_file.image_file</code>.
     */
    public static final UDTField<TypeImageFileRecord, String> IMAGE_FILE = createField("image_file", org.jooq.impl.SQLDataType.CLOB, TYPE_IMAGE_FILE, "");

    /**
     * The attribute <code>public.type_image_file.image_title</code>.
     */
    public static final UDTField<TypeImageFileRecord, String> IMAGE_TITLE = createField("image_title", org.jooq.impl.SQLDataType.CLOB, TYPE_IMAGE_FILE, "");
