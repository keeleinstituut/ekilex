...
public class MviewWwMeaningRecord extends TableRecordImpl<MviewWwMeaningRecord> implements Record11<Long, Timestamp, Timestamp, JSON, JSON, JSON, String[], String[], String[], JSON, JSON> {
    ...
    @Override
    public MviewWwMeaningRecord values(Long value1, Timestamp value2, Timestamp value3, JSON value4, JSON value5, JSON value6, String[] value7, String[] value8, String[] value9, JSON value10, JSON value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
