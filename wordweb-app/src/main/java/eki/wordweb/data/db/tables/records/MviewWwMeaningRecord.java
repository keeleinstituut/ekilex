...
public class MviewWwMeaningRecord extends TableRecordImpl<MviewWwMeaningRecord> implements Record10<Long, LocalDateTime, LocalDateTime, JSON, JSON, JSON, JSON, String[], String[], JSON> {
    ...
    /**
     * Setter for <code>public.mview_ww_meaning.meaning_medias</code>.
     */
    ...
    /**
     * Getter for <code>public.mview_ww_meaning.meaning_medias</code>.
     */
    ...
    /**
     * Setter for <code>public.mview_ww_meaning.meaning_notes</code>.
     */
    ...
    /**
     * Getter for <code>public.mview_ww_meaning.meaning_notes</code>.
     */
    ...
    public Field<JSON> field7() {
        return MviewWwMeaning.MVIEW_WW_MEANING.MEANING_MEDIAS;
    }
    ...
    public Field<JSON> field10() {
        return MviewWwMeaning.MVIEW_WW_MEANING.MEANING_NOTES;
    }
    ...
    @Override
    public MviewWwMeaningRecord value7(JSON value) {
    ...
    @Override
    public MviewWwMeaningRecord values(Long value1, LocalDateTime value2, LocalDateTime value3, JSON value4, JSON value5, JSON value6, JSON value7, String[] value8, String[] value9, JSON value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MviewWwMeaningRecord(Long meaningId, LocalDateTime manualEventOn, LocalDateTime lastApproveOrEditEventOn, JSON domainCodes, JSON definitions, JSON meaningImages, JSON meaningMedias, String[] semanticTypes, String[] learnerComments, JSON meaningNotes) {
        super(MviewWwMeaning.MVIEW_WW_MEANING);
