...
public class MviewWwMeaningRecord extends TableRecordImpl<MviewWwMeaningRecord> implements Record11<Long, Timestamp, Timestamp, TypeDomainRecord[], TypeMediaFileRecord[], TypeMediaFileRecord[], String[], String[], String[], TypeFreeformRecord[], JSON> {
    ...
    @Override
    public Row11<Long, Timestamp, Timestamp, TypeDomainRecord[], TypeMediaFileRecord[], TypeMediaFileRecord[], String[], String[], String[], TypeFreeformRecord[], JSON> valuesRow() {
    ...
    @Override
    public MviewWwMeaningRecord values(Long value1, Timestamp value2, Timestamp value3, TypeDomainRecord[] value4, TypeMediaFileRecord[] value5, TypeMediaFileRecord[] value6, String[] value7, String[] value8, String[] value9, TypeFreeformRecord[] value10, JSON value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
