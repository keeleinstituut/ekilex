...
public class StrictWordSimilarityDistCommutatorOp extends AbstractRoutine<Float> {
    ...
    private static final long serialVersionUID = 544613478;

    /**
     * The parameter <code>public.strict_word_similarity_dist_commutator_op.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.strict_word_similarity_dist_commutator_op._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>public.strict_word_similarity_dist_commutator_op._2</code>.
     */
    ...
    public StrictWordSimilarityDistCommutatorOp() {
        super("strict_word_similarity_dist_commutator_op", Public.PUBLIC, org.jooq.impl.SQLDataType.REAL);
