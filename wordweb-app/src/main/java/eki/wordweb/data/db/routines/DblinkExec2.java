...
public class DblinkExec2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1231682969;
     ...
     */
    public DblinkExec2() {
        super("dblink_exec", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
