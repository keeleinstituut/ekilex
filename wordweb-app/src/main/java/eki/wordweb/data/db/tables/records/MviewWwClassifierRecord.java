...
public class MviewWwClassifierRecord extends TableRecordImpl<MviewWwClassifierRecord> implements Record5<String, String, String, String, String> {

    private static final long serialVersionUID = -1544815079;
     ...
     */
    @Override
    public MviewWwClassifierRecord values(String value1, String value2, String value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MviewWwClassifierRecord(String name, String origin, String code, String value, String lang) {
        super(MviewWwClassifier.MVIEW_WW_CLASSIFIER);
