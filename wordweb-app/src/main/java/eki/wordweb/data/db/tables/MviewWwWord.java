...
public class MviewWwWord extends TableImpl<MviewWwWordRecord> {
    ...
    /**
     * The column <code>public.mview_ww_word.word_eki_recommendations</code>.
     */
    public final TableField<MviewWwWordRecord, JSON> WORD_EKI_RECOMMENDATIONS = createField(DSL.name("word_eki_recommendations"), SQLDataType.JSON, this, "");
