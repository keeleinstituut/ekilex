...
public class MviewWwLexemeRecord extends TableRecordImpl<MviewWwLexemeRecord> implements Record16<Long, Long, Long, Integer, Integer, Integer, String, Long, String[], String[], String[], String[], TypePublicNoteRecord[], TypeGrammarRecord[], TypeGovernmentRecord[], TypeUsageRecord[]> {

    private static final long serialVersionUID = 1837969299;
     ...
     */
    @Override
    public MviewWwLexemeRecord values(Long value1, Long value2, Long value3, Integer value4, Integer value5, Integer value6, String value7, Long value8, String[] value9, String[] value10, String[] value11, String[] value12, TypePublicNoteRecord[] value13, TypeGrammarRecord[] value14, TypeGovernmentRecord[] value15, TypeUsageRecord[] value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
