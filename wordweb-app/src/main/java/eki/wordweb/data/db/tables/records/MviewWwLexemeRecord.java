...
public class MviewWwLexemeRecord extends TableRecordImpl<MviewWwLexemeRecord> implements Record17<Long, Long, Long, Integer, Integer, Integer, String, Long, String[], String[], String[], String[], TypePublicNoteRecord[], TypeGrammarRecord[], TypeGovernmentRecord[], TypeUsageRecord[], TypeLangComplexityRecord[]> {

    private static final long serialVersionUID = 1004476582;
     ...
     */
    @Override
    public Row17<Long, Long, Long, Integer, Integer, Integer, String, Long, String[], String[], String[], String[], TypePublicNoteRecord[], TypeGrammarRecord[], TypeGovernmentRecord[], TypeUsageRecord[], TypeLangComplexityRecord[]> fieldsRow() {
     ...
     */
    @Override
    public Row17<Long, Long, Long, Integer, Integer, Integer, String, Long, String[], String[], String[], String[], TypePublicNoteRecord[], TypeGrammarRecord[], TypeGovernmentRecord[], TypeUsageRecord[], TypeLangComplexityRecord[]> valuesRow() {
     ...
     */
    @Override
    public Field<TypeLangComplexityRecord[]> field17() {
     ...
     */
    @Override
    public TypeLangComplexityRecord[] component17() {
     ...
     */
    @Override
    public TypeLangComplexityRecord[] value17() {
        return getLangComplexities();
    }
     ...
     */
    @Override
    public MviewWwLexemeRecord value13(TypePublicNoteRecord... value) {
     ...
     */
    @Override
    public MviewWwLexemeRecord value14(TypeGrammarRecord... value) {
        setGrammars(value);
        return this;
    }
     ...
     */
    @Override
    public MviewWwLexemeRecord value15(TypeGovernmentRecord... value) {
     ...
     */
    @Override
    public MviewWwLexemeRecord value17(TypeLangComplexityRecord... value) {
     ...
     */
    @Override
    public MviewWwLexemeRecord values(Long value1, Long value2, Long value3, Integer value4, Integer value5, Integer value6, String value7, Long value8, String[] value9, String[] value10, String[] value11, String[] value12, TypePublicNoteRecord[] value13, TypeGrammarRecord[] value14, TypeGovernmentRecord[] value15, TypeUsageRecord[] value16, TypeLangComplexityRecord[] value17) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
