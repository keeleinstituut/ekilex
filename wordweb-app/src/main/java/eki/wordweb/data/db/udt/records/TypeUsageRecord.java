...
public class TypeUsageRecord extends UDTRecordImpl<TypeUsageRecord> implements Record6<String, String, String, String[], String[], TypeSourceLinkRecord[]> {

    private static final long serialVersionUID = 1642896533;
     ...
     */
    public void setUsageAuthors(TypeSourceLinkRecord... value) {
        set(5, value);
    }
     ...
     */
    public TypeSourceLinkRecord[] getUsageAuthors() {
        return (TypeSourceLinkRecord[]) get(5);
    }
     ...
     */
    @Override
    public Row6<String, String, String, String[], String[], TypeSourceLinkRecord[]> fieldsRow() {
     ...
     */
    @Override
    public Row6<String, String, String, String[], String[], TypeSourceLinkRecord[]> valuesRow() {
     ...
     */
    @Override
    public Field<TypeSourceLinkRecord[]> field6() {
     ...
     */
    @Override
    public TypeSourceLinkRecord[] component6() {
     ...
     */
    @Override
    public TypeSourceLinkRecord[] value6() {
        return getUsageAuthors();
    }
     ...
     */
    @Override
    public TypeUsageRecord value6(TypeSourceLinkRecord... value) {
     ...
     */
    @Override
    public TypeUsageRecord values(String value1, String value2, String value3, String[] value4, String[] value5, TypeSourceLinkRecord[] value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TypeUsageRecord(String usage, String usageLang, String usageTypeCode, String[] usageTranslations, String[] usageDefinitions, TypeSourceLinkRecord[] usageAuthors) {
        super(TypeUsage.TYPE_USAGE);
