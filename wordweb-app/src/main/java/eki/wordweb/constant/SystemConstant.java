...
public interface SystemConstant {
	...
	String[] SUPPORTED_DESTIN_LANGS = new String[] {DESTIN_LANG_EST, DESTIN_LANG_RUS, DESTIN_LANG_ENG, DESTIN_LANG_FRA};

	String[] SUPPORTED_DETAIL_DESTIN_LANG_FILTERS = new String[] {DESTIN_LANG_ALL, DESTIN_LANG_EST, DESTIN_LANG_RUS, DESTIN_LANG_ENG, DESTIN_LANG_FRA, DESTIN_LANG_OTHER};
