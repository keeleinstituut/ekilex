...
public class SimpleSearchService extends AbstractSearchService {
	...
	public WordData getWordData(Long wordId, SearchFilter searchFilter) {
		...
		wordConversionUtil.composeHomonymWrapups(word, searchContext);
		...
		return composeWordData(word, forms, paradigms, lexemeWords, Collections.emptyList(), searchContext);
	}
